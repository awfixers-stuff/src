 ...
 * **Uncategorized**
    ...
    - Merge pull request #2272 from GitoxideLabs/copilot/add-src-date-baseline-tests ([`3cf78c3`](https://github.com/GitoxideLabs/gitoxide/commit/3cf78c37fec010f22f8dea338d8d353de7312590))
 ...
 * **Uncategorized**
    ...
    - Refactor ([`ca7800c`](https://github.com/GitoxideLabs/gitoxide/commit/ca7800c7a6756fc42dc5ca64c5bf3759792568b9))
    - Add parse_raw() ([`9c28f33`](https://github.com/GitoxideLabs/gitoxide/commit/9c28f3363c648e0fed88f5d63b2fac3aa4a545cf))
...
### New Features (BREAKING)
 ...
 - <csr-id-d559fa7d96a06372855fdef3c7ab3a7083ba7172/> remove `Time::sign` field as it's not needed anymore to round-trip.
   Round-tripping is now handled in the `src-actor` crate using the `SignatureRef`
   type.
...
### Bug Fixes
 ...
 - <csr-id-c95135b0d0168393f4ccca9863ade7efac8b3379/> Parse relative months and years
   ...
   --- STDERR:              src-date::date time::parse::relative::various ---
   thread 'time::parse::relative::various' panicked at src-date\tests\time\parse.rs:252:9:
...
### Other
 ...
 - <csr-id-5a88413a2d3acb5c4ba5e49e47a42f0182d9e9fb/> make `time` a private dependency of `src-date`
   ...
   dependency of `src-date`. The only thing we really had to button up was
   ...
   formatting machinery external to `src-date`, I figured we might as well
 ...
 * **[#1485](https://github.com/GitoxideLabs/gitoxide/issues/1485)**
    ...
    - Reproduce fuzzer failure in `src-date` ([`3a8b9e2`](https://github.com/GitoxideLabs/gitoxide/commit/3a8b9e2a8456985b4b444be421e9f0f61b08b7f1))
 * **Uncategorized**
    ...
    - Make `time` a private dependency of `src-date` ([`5a88413`](https://github.com/GitoxideLabs/gitoxide/commit/5a88413a2d3acb5c4ba5e49e47a42f0182d9e9fb))
</details>
 ...
 * **Uncategorized**
    ...
    - Rename `git-date` to `src-date` ([`2b0a966`](https://github.com/GitoxideLabs/gitoxide/commit/2b0a9662acf7c74f594138963e2efd8f576799f3))
...
### New Features
 ...
 - <csr-id-cfb6a726ddb763f7c22688f8ef309e719c2dfce4/> Add `Time` type.
   It was originally from the `src-actor` crate.
