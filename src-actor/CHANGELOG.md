...
### New Features (BREAKING)
 ...
 - <csr-id-2aec23badd6e36d5b6eb34700b067dd1e16acf3f/> remove `thiserror` in favor of `src-error`
 ...
 * **Uncategorized**
    ...
    - Remove `thiserror` in favor of `src-error` ([`2aec23b`](https://github.com/GitoxideLabs/gitoxide/commit/2aec23badd6e36d5b6eb34700b067dd1e16acf3f))
...
### New Features (BREAKING)
 ...
 - <csr-id-5ab19a7a3344c58ad1185a23a789848ed5e02241/> Use `src-error` in `src-date`
 ...
 * **Uncategorized**
    ...
    - src-actor docs: document conversions between `Signature` and `SignatureRef` ([`8bebd2e`](https://github.com/GitoxideLabs/gitoxide/commit/8bebd2e84b4e9d9a31a6ff8dcd17da83534f3c95))
...
### Bug Fixes (BREAKING)
 ...
 - <csr-id-57366d3ebd622af8927bb0e199ab8a3c0eafee99/> turn `SignatureRef::time` field into `&str`.
   We also add a `src_date::Time::to_str()` method, along with related utilities,
 ...
 - <csr-id-9825354f85e8e3d2ccdb23ff88c0976dbf094828/> Make Signature roundtrip
   ...
   `src_date::Time` from the start, we are able to roundtrip between Git
   and src-actor even with creatively formatted Git data.
 ...
 * **Uncategorized**
    ...
    - Adapt to changes in `src-date` ([`8c00e6f`](https://github.com/GitoxideLabs/gitoxide/commit/8c00e6f1d199ed2993fbf8e0a925c67fee854ae5))
...
### Bug Fixes (BREAKING)
 ...
 - <csr-id-031cd6884c925741112277529153870f69594c81/> major-version bump to accomodate for the type-change in `src-date`.
 ...
 * **Uncategorized**
    ...
    - Major-version bump to accomodate for the type-change in `src-date`. ([`031cd68`](https://github.com/GitoxideLabs/gitoxide/commit/031cd6884c925741112277529153870f69594c81))
</details>
 ...
 * **Uncategorized**
    ...
    - Fix-up version of `src-date` depndend on in `src-actor` ([`5fb6a2d`](https://github.com/GitoxideLabs/gitoxide/commit/5fb6a2dec61b7fcd8e5f0f6ff9e5cc41975f2d52))
</details>
...
### Other
 ...
 - <csr-id-e82a13eeb10fb4525c39d88b91ce356ada9a57dd/> remove unused src-features
 ...
 * **Uncategorized**
    ...
    - Remove unused src-features ([`e82a13e`](https://github.com/GitoxideLabs/gitoxide/commit/e82a13eeb10fb4525c39d88b91ce356ada9a57dd))
...
### Chore (BREAKING)
 ...
 - <csr-id-35592c9aa9665e1d9f554b589614fe59308a5f25/> update to `winnow` 0.6
   ...
   leading to a now-yanked release that breaks `src` v0.58.
 ...
 * **Uncategorized**
    ...
    - Rename `git-actor` to `src-actor` ([`9a6aea1`](https://github.com/GitoxideLabs/gitoxide/commit/9a6aea1c68541859416f3fa5e48e741ca3872bf3))
