...
### Bug Fixes
 ...
 - <csr-id-042efa0f0b45744aeb70edb48c156b44380132ae/> on Windows, `Source::User` now produces a directory even if `HOME` is not set.
 ...
 * **Uncategorized**
    ...
    - Merge pull request #2124 from GitoxideLabs/improvements ([`10a20d6`](https://github.com/GitoxideLabs/gitoxide/commit/10a20d6b3027179791c04a95731e1697001fb5f8))
    - On Windows, `Source::User` now produces a directory even if `HOME` is not set. ([`042efa0`](https://github.com/GitoxideLabs/gitoxide/commit/042efa0f0b45744aeb70edb48c156b44380132ae))
 ...
 * **Uncategorized**
    ...
    - Adapt `src-config`/`src-object` benches to changes in `criterion` ([`91aef25`](https://github.com/GitoxideLabs/gitoxide/commit/91aef25a9febd440a8c14ce9d73716b5b1de6257))
    - Adapt `src-config` tests to changes in `tempfile` ([`eccd13a`](https://github.com/GitoxideLabs/gitoxide/commit/eccd13a4b5b39422e04a00cedc81c8991c9eba3e))
 ...
 * **Uncategorized**
    ...
    - Fix marking `src-packetline-blocking` copy auto-generated ([`325588e`](https://github.com/GitoxideLabs/gitoxide/commit/325588e700ec159e5139beb149127c947164fb98))
    ...
    - Remove `src` dev-dependency. It's not really required. ([`581ef67`](https://github.com/GitoxideLabs/gitoxide/commit/581ef672862b20b1d272d8a0ee4a9646478f3a49))
 ...
 * **Uncategorized**
    ...
    - Adapt to changes in `src-pack` ([`bad5b48`](https://github.com/GitoxideLabs/gitoxide/commit/bad5b48e4f0d865b0b0937f136d9a0041aa88046))
</details>
 ...
 * **Uncategorized**
    ...
    - [src-config] Run parse::tests::section::size_of_events only on 64 bit architectures ([`0ce06a6`](https://github.com/GitoxideLabs/gitoxide/commit/0ce06a696d738fdfc151a0ff1ad6e41130ebddd5))
 ...
 * **Uncategorized**
    ...
    - Fix docs for src-config _by() methods. ([`e09a4ec`](https://github.com/GitoxideLabs/gitoxide/commit/e09a4ecf4d6ae342abddd037d9beabad496ec326))
    - Fixup! cargo fmt ([`e5f815a`](https://github.com/GitoxideLabs/gitoxide/commit/e5f815a3ffc284f20a92edd3fca57b7ab60c6d30))
    - Fixup! src-config now uses a Key trait rather than Into<&BStr> ([`29e470b`](https://github.com/GitoxideLabs/gitoxide/commit/29e470b88356dbc11be4a5922269043d333f9089))
    - Use .as_refs() in src-config to avoid unnecessary monomorphization. ([`819d7eb`](https://github.com/GitoxideLabs/gitoxide/commit/819d7ebf043d5129ef27726297a78b918c42b771))
 ...
 * **Uncategorized**
    ...
    - Optimize src-config fuzzer performance ([`36f4d92`](https://github.com/GitoxideLabs/gitoxide/commit/36f4d925a1bbc39a64f4b964711698fa485ce980))
    - Merge branch 'fuzz-src-config' ([`34e4a16`](https://github.com/GitoxideLabs/gitoxide/commit/34e4a16949710aa10dd5ab6c253016d14109d541))
 ...
 * **Uncategorized**
    ...
    - Merge branch 'fuzz-src-config' ([`ce44fe3`](https://github.com/GitoxideLabs/gitoxide/commit/ce44fe3f04fdcd01ba1d98165194431c918a80b1))
    - Refactor src-config fuzzer ([`fee6bde`](https://github.com/GitoxideLabs/gitoxide/commit/fee6bde224ea6ee668fa5816642b767c80879985))
</details>
...
### New Features
 ...
 - <csr-id-8053710e2940ced8ab8a7805de3bb94408352a9e/> Fuzz more of the src-config api
 ...
 * **Uncategorized**
    ...
    - Merge branch 'fuzz-src-config' ([`0f71709`](https://github.com/GitoxideLabs/gitoxide/commit/0f717092313391ad663a41bf1a898d9970188db2))
    ...
    - Merge branch 'src-config-fix' ([`b6d4e99`](https://github.com/GitoxideLabs/gitoxide/commit/b6d4e993b90e3fed4a9e27b6ccaa2f56c4e12ed8))
    ...
    - Merge branch 'src-config' ([`7917c13`](https://github.com/GitoxideLabs/gitoxide/commit/7917c13258d7765e06cf30ab2cbe9fcb8c2f6619))
    ...
    - Merge pull request #1186 from silvergasp/fuzz-src-config ([`f5a0296`](https://github.com/GitoxideLabs/gitoxide/commit/f5a0296cec2eab00dc62922f3780966438cf2a2a))
    - Fuzz more of the src-config api ([`8053710`](https://github.com/GitoxideLabs/gitoxide/commit/8053710e2940ced8ab8a7805de3bb94408352a9e))
...
### New Features
 ...
 - <csr-id-6738955949d82a66c070dcb65e368652898bd1d2/> `GIT_CONFIG_NOSYSTEM` now also affects the installation directory.
   ...
   isolation of `src` operations, for example in tests.
 ...
 * **Uncategorized**
    ...
    - Optimize internal `src` usage for faster compile time ([`9d33e2f`](https://github.com/GitoxideLabs/gitoxide/commit/9d33e2f5c6a1c370654ef0db90b29c0a023dcf3d))
...
- <csr-id-ef54aab9e5521add4154ee8d902d62612a9d8d4a/> switch `nom` to `winnow` in remaining uses in `src-object`, `src-ref`, and `src-actor` for ~20% more performance.
...
### Bug Fixes
 ...
 - <csr-id-c51c8daee1ab54130ae3ed83ce67d08f01c4881a/> fix incorrect s/git-config/src-config/
   ...
   occurence of "git-config" or "git_config" with "src-config"/"gix_config".
 ...
 * **Uncategorized**
    ...
    - Switch src to winnow 0.3 ([`ee75de1`](https://github.com/GitoxideLabs/gitoxide/commit/ee75de1e6035305fc23bdef2522ae5081272ac82))
 ...
 * **Uncategorized**
    ...
    - Switch src-config to winnow 0.3 ([`3d9ae21`](https://github.com/GitoxideLabs/gitoxide/commit/3d9ae21f97e50129576473a2682a10b793b356de))
</details>
 ...
 * **Uncategorized**
    ...
    - Fix src-config dependency versions ([`dbeb68d`](https://github.com/GitoxideLabs/gitoxide/commit/dbeb68da2348bf555cc959fc60d255da9f50eda5))
</details>
 ...
 * **Uncategorized**
    ...
    - Align usage of `src-path` across all crates ([`73c1292`](https://github.com/GitoxideLabs/gitoxide/commit/73c1292be393986c4a1adde1400abf551e850da0))
</details>
...
### Bug Fixes
 ...
 - <csr-id-da9009f807acfe50000724589853a112fc5ab9a4/> Use `src-path` for obtaining some shared directories as base for path generation.
 ...
 * **Uncategorized**
    ...
    - Use `src-path` for obtaining some shared directories as base for path generation. ([`da9009f`](https://github.com/GitoxideLabs/gitoxide/commit/da9009f807acfe50000724589853a112fc5ab9a4))
...
### Bug Fixes
 ...
 - <csr-id-e14dc7d475373d2c266e84ff8f1826c68a34ab92/> note that crates have been renamed from `git-*` to `src-*`.
 ...
 * **Uncategorized**
    ...
    - Rename `git-config` to `src-config` ([`dd6d63e`](https://github.com/GitoxideLabs/gitoxide/commit/dd6d63e1decb91836b489c94c19b0283b50a05de))
...
### Changed
 ...
 - <csr-id-5ad296577d837b0699b4718fa2be3d0978c4e342/> `src-config` now uses `src-config-value`.
...
### Bug Fixes
 ...
 - <csr-id-f911707b455ba6f3800b85f667f91e4d56027b91/> value normalization (via `value::normalize()` handles escape sequences.
   The latter ones are `\n`, `\t` and `\b` which are the only supported
   ones in values of src-config files.
 - <csr-id-44dfec07480cc2ac6fd01674b748cc03af51fed1/> stable sort order for `File::sections_by_name_with_header()`
 - <csr-id-1ea919d5ff81ab7b01b8201386ef63c7e081b537/> count newlines (for error display) in multi-line values as well
 - <csr-id-1e71e71c984289f0d7e0a39379ee6728918b7dc5/> auto-normalize string values to support quote removal in case of strings.
   Related to https://github.com/starship/starship/pull/3883 .
...
### Bug Fixes (BREAKING)
 ...
 - <csr-id-4a01d983f54a7713dea523f6032cbf5bb2b9dde8/> improve normalization; assure no extra copies are made on query.
   ...
   `values?_as()` was removed as well as it's somewhat duplicate
   to higher-level APIs and it wasn't tested at all.
 - <csr-id-c9933c0b0f51d21dc8244b2acc33d7dc8a33f6ce/> Remove `src-config` test utilities from `src-path`.
...
A maintenance release triggered by changes to src-pack and changelog rewrites.
...
lenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopen<csr-unknown>
lenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopen<csr-unknown>
...
lenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopenlenfrom_envopen<csr-unknown>
