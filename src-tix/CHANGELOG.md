 ...
 * **Uncategorized**
    ...
    - Adjust to renaming of `git-tix` to `src-tix` ([`531003b`](https://github.com/Byron/gitoxide/commit/531003bb03dd83e8870643bbf114008a367c6599))
    - Rename `git-tix` to `src-tix` ([`5cd02dc`](https://github.com/Byron/gitoxide/commit/5cd02dcc56eda79888f1d1344031744457fc04fa))
