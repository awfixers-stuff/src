 ...
 * **Uncategorized**
    ...
    - Merge branch 'src-lock-improvements' ([`b009db0`](https://github.com/GitoxideLabs/gitoxide/commit/b009db018df435a8c57848dc4cdc52d4278a6d9d))
</details>
...
### Bug Fixes
 ...
 - <csr-id-60b53f4aac4c8cf7cf1299e0847ca66fc8e9a18b/> allow re-release of `src-tempfile` with latest dependencies
 ...
 * **Uncategorized**
    - Release src-tempfile v7.0.1 ([`95c30b2`](https://github.com/GitoxideLabs/gitoxide/commit/95c30b249d7a1d4767cc0a96316da2734a3dd9f6))
    - Allow re-release of `src-tempfile` with latest dependencies ([`60b53f4`](https://github.com/GitoxideLabs/gitoxide/commit/60b53f4aac4c8cf7cf1299e0847ca66fc8e9a18b))
...
### Bug Fixes (BREAKING)
 ...
 - <csr-id-304b0c1ffdfc90bbfaad1bf30162070a5ce4b8c0/> Upgrade `tempfile` to 3.4, fixing a security issue.
   ...
   This means this `src` up until v0.40 can be used to pull in `tempfile` 3.3, and
...
### Bug Fixes
 ...
 - <csr-id-6778c5f6874ec2a44859de25428e6603dd4e9e8a/> switch `tempfile` to `~3.3.0` to help with `cargo` build.
   `src-tempfile` is now used in `cargo`, and `tempfile` seems to cause trouble
 ...
 * **Uncategorized**
    - Release src-tempfile v4.1.1 ([`2574b75`](https://github.com/GitoxideLabs/gitoxide/commit/2574b7592b5e0e7a709608ce674568d15b8fc3e8))
 ...
 * **Uncategorized**
    - Release src-tempfile v4.0.0 ([`ad23f1d`](https://github.com/GitoxideLabs/gitoxide/commit/ad23f1dd58b3eabf5a12d02c4a1de8b1835051d5))
 ...
 * **Uncategorized**
    ...
    - Rename `git-tempfile` to `src-tempfile` ([`192ed5d`](https://github.com/GitoxideLabs/gitoxide/commit/192ed5d15c04fdfb330b3ab553eeaaf09f7fccd4))
