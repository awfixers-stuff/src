...
<csr-id-0becc913c57afd8a0bf95e97c14ba1130f662f1a/>
 ...
 - <csr-id-51724d15a4ae5a41b4a97412b2a847366c61f98d/> Get and set mode using std, still on open file descriptor
   ...
   The change here is confined to `src-worktree-state` and, more
...
- No longer require `src-worktree-state` to depend directly on
     `rustix`. (This is minor because it still depends transitively on
     it through `src-fs`, though some uses of `rustix::fs` in `src-fs`
 ...
 * **Uncategorized**
    ...
    - Set +x in index in src-worktree-state make_mixed* fixtures ([`22e7f33`](https://github.com/GitoxideLabs/gitoxide/commit/22e7f33483bb67e53ec47b8767998f5ca002846b))
    - Have src-worktree-state checkout tests fail without symlinks ([`d715e4a`](https://github.com/GitoxideLabs/gitoxide/commit/d715e4a96d0977042e24c3dc6c864146f4be0b78))
...
### New Features
 ...
 - <csr-id-a81514f612b83bec6ab38832c1e39ef8f7bcd583/> use `src-object::Find` trait
 ...
 * **Uncategorized**
    ...
    - Use `src-object::Find` trait ([`a81514f`](https://github.com/GitoxideLabs/gitoxide/commit/a81514f612b83bec6ab38832c1e39ef8f7bcd583))
 ...
 * **Uncategorized**
    ...
    - Use latest utilities from `src-worktree` ([`34318fa`](https://github.com/GitoxideLabs/gitoxide/commit/34318fade6555af8ac6945b2366e5bb69fc823fa))
</details>
