...
///
/// Furthermore, despite this trait being in `src-pack`, it leaks knowledge about objects potentially not being packed.
/// This is a necessary trade-off to allow this trait to live in `src-pack` where it is used in functions to create a pack.
///
