...
### New Features (BREAKING)
 ...
 - <csr-id-0c68131e8663390199c0b9665ffbb1727743940b/> use `src-error` instead of `thiserror`
 ...
 * **Uncategorized**
    ...
    - Merge pull request #2373 from GitoxideLabs/src-error ([`4c6a7a7`](https://github.com/GitoxideLabs/gitoxide/commit/4c6a7a76c214c94910f141542d677dc2a7500ddd))
    - Adapt to changes in `src-chunk` ([`e6e90ff`](https://github.com/GitoxideLabs/gitoxide/commit/e6e90ff82b1f839a6d78170685f2a69566766675))
    - Use `src-error` instead of `thiserror` ([`0c68131`](https://github.com/GitoxideLabs/gitoxide/commit/0c68131e8663390199c0b9665ffbb1727743940b))
 ...
 * **Uncategorized**
    ...
    - Mark src-pack vendored `izip!` doctest `ignore` ([`0783e9c`](https://github.com/GitoxideLabs/gitoxide/commit/0783e9c1648261ad4a9af1904d65abedf24821d9))
 ...
 * **Uncategorized**
    ...
    - Adapt to changes in `src-features` ([`ee80b2b`](https://github.com/GitoxideLabs/gitoxide/commit/ee80b2bd8c3be6f80f85987f8df32fa4a796247f))
...
### Changed (BREAKING)
 ...
 - <csr-id-d6e720146c633bdc5400425b6097a3f5de93a51b/> Use `src-object::Find` trait
 ...
 * **Uncategorized**
    ...
    - Use `src-object::Find` trait ([`d6e7201`](https://github.com/GitoxideLabs/gitoxide/commit/d6e720146c633bdc5400425b6097a3f5de93a51b))
...
### New Features
 ...
 - <csr-id-0357b6cdb11b098fd54cd0c3df6c617d0b44a1c2/> Add `generate` and `streaming-input` feature toggles.
   That way, it's possible to not compile a bunch of code in `src` if
 ...
 * **Uncategorized**
    ...
    - Switch the last crate (src-package-tests) to edition 2021 ([`04494c6`](https://github.com/GitoxideLabs/gitoxide/commit/04494c65df05eef6b24acb68faae939a3d85f510))
 ...
 * **Uncategorized**
    ...
    - Prepare changelogs prior to release of `src-pack` ([`6db30ef`](https://github.com/GitoxideLabs/gitoxide/commit/6db30ef6b5e931bbf12135507a3d922051de4d4b))
 ...
 * **Uncategorized**
    ...
    - Adapt to changes in `src-features` ([`a0ed614`](https://github.com/GitoxideLabs/gitoxide/commit/a0ed6142c9a7ce7ed9fb6576117bb46e5497839c))
    - Adjust to changes in `src-features`, use `process::count_with_decimals()` ([`3968133`](https://github.com/GitoxideLabs/gitoxide/commit/3968133f60609d75806783234253fb8b3972f10e))
 ...
 * **Uncategorized**
    ...
    - Rename `git-pack` to `src-pack` ([`134d70d`](https://github.com/GitoxideLabs/gitoxide/commit/134d70dbb7fe9c7fcd4201a7bb028b22bca39a30))
    ...
    - Merge branch 'main' into src-clone ([`3b48317`](https://github.com/GitoxideLabs/gitoxide/commit/3b48317d6a9f41765d4f2a9f0a49c31afcdb68b6))
...
### New Features
 ...
 - <csr-id-503b1a1f8d4f39b44c166209d7a8ba8d74137859/> `index::File::lookup_prefix(…)`
 - <csr-id-cb83beedd1aa389f6774e2296f79273e8c8f14f4/> src-hash::Prefix::from_id()
   A way to obtain a prefix of an object id, with all non-prefix
   bytes set to zero.
 - <csr-id-16208306ab49ade30d8ffd6b067ebd8eefd84cd4/> in-manifest and in-lib documentation of feature toggles
...
This release contains bugfixes and features, but is considered breaking as `src-traverse`
