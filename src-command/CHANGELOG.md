 ...
 * **Uncategorized**
    ...
    - Fix src-command expectations which changed with Rust 1.93 ([`cc3310b`](https://github.com/GitoxideLabs/gitoxide/commit/cc3310b8de5c882dd2edfb0b99ee36f049512db9))
 ...
 * **Uncategorized**
    ...
    - Fix tests of `src-command` external commands on Windows ([`548e658`](https://github.com/GitoxideLabs/gitoxide/commit/548e65829bee4d6b6926026b2628059ea2cd3c97))
...
### New Features
 ...
 - <csr-id-c7d06a6f4343d4362f4d82e6583b85cc2829fb2b/> Use `gix_path::env::shell()` in `src-command` for sh
 ...
 * **Uncategorized**
    ...
    - Use `gix_path::env::shell()` in `src-command` for sh ([`c7d06a6`](https://github.com/GitoxideLabs/gitoxide/commit/c7d06a6f4343d4362f4d82e6583b85cc2829fb2b))
...
### Bug Fixes
 ...
 - <csr-id-74631d4171cdfd4f97d61203c2b65ef02da7b2c4/> Add test to assure `echo "$@" >&2` works as expected
   ...
   credential helpers, but it's something that is done by `src-command`
...
### New Features
 ...
 - <csr-id-9d7e28d542b5dbacce28920232b99c454f1eab4e/> Add `Context` to provide much more context just like `git` sets it.
   `git` sets a bunch of context-carrying environment variables which `src`
 ...
 - <csr-id-05972f11f34795da5c70c927c958a0088367dbe7/> add `Prepare::with_shell_allow_argument_splitting()` flag.
   ...
   It also allows certain areas of `src` to indicate that they are safe to
 ...
 * **Uncategorized**
    ...
    - Fix src-command tests on windows ([`67a0220`](https://github.com/GitoxideLabs/gitoxide/commit/67a0220dc4c4ff6f79a24771fb175baec22bc6b0))
 ...
 * **Uncategorized**
    ...
    - Rename `git-command` to `src-command` ([`4d32925`](https://github.com/GitoxideLabs/gitoxide/commit/4d32925012d88838ef7edbd3882eed1cf76d4600))
