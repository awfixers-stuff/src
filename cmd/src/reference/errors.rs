...
pub mod edit {
    ...
    pub enum Error {
        #[error(transparent)]
        FileTransactionPrepare(#[from] src_ref::file::transaction::prepare::Error),
        #[error(transparent)]
        FileTransactionCommit(#[from] src_ref::file::transaction::commit::Error),
        #[error(transparent)]
        NameValidation(#[from] src_validate::reference::name::Error),
...
pub mod peel {
    ...
    pub enum Error {
        #[error(transparent)]
        ToId(#[from] src_ref::peel::to_id::Error),
        #[error(transparent)]
        PackedRefsOpen(#[from] src_ref::packed::buffer::open::Error),
    }
    ...
    pub mod to_kind {
        ...
        pub enum Error {
            #[error(transparent)]
            FollowToObject(#[from] src_ref::peel::to_object::Error),
            #[error(transparent)]
            PackedRefsOpen(#[from] src_ref::packed::buffer::open::Error),
            #[error(transparent)]
...
pub mod find {
    ...
    pub enum Error {
        #[error(transparent)]
        Find(#[from] src_ref::file::find::Error),
    }
}
