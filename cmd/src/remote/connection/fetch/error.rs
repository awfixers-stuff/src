...
pub enum Error {
    #[error(transparent)]
    Fetch(#[from] src_protocol::fetch::Error),
    ...
    IncompatibleObjectHash {
        local: src_hash::Kind,
        remote: src_hash::Kind,
    },
    #[error(transparent)]
    LoadAlternates(#[from] src_odb::store::load_index::Error),
    #[error(transparent)]
    Client(#[from] src_protocol::transport::client::Error),
    #[error(transparent)]
    ...
    NoMapping {
        refspecs: Vec<src_refspec::RefSpec>,
