...
pub enum Status {
    ...
    Change {
        ...
        write_pack_bundle: src_pack::bundle::write::Outcome,
...
pub struct Outcome {
    ...
    pub handshake: src_protocol::Handshake,
...
pub mod outcome {
    ...
    pub struct Negotiate {
        ...
        pub graph: src_negotiate::IdMap,
        /// Additional information for each round of negotiation.
        pub rounds: Vec<src_protocol::fetch::negotiate::Round>,
    }
}

pub use src_protocol::fetch::ProgressId;
