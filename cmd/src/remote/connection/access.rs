    ...
    T: Transport,
{
    ...
    pub fn with_credentials(
        mut self,
        helper: impl FnMut(src_credentials::helper::Action) -> src_credentials::protocol::Result + 'a,
    ) -> Self {
    ...
    T: Transport,
{
    ...
    /// Note that the caller _should not_ call [`configure()`](src_protocol::transport::client::TransportWithoutIO::configure())
