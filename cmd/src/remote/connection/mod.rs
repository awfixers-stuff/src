...
pub type AuthenticateFn<'a> = Box<dyn FnMut(src_credentials::helper::Action) -> src_credentials::protocol::Result + 'a>;
    ...
    T: Transport,
{
    ...
    pub(crate) transport: src_protocol::SendFlushOnDrop<T>,
    pub(crate) handshake: Option<src_protocol::Handshake>,
