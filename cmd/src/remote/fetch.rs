...
pub mod negotiate {
    ...
    pub use src_negotiate::Algorithm;
    #[cfg(any(feature = "blocking-network-client", feature = "async-network-client"))]
    pub use src_protocol::fetch::negotiate::Error;
}
...
#[cfg(any(feature = "blocking-network-client", feature = "async-network-client"))]
pub use src_protocol::fetch::{refmap, RefMap};
pub use src_protocol::fetch::{Shallow, Tags};
