pub use src_merge as plumbing;
pub use src_merge::blob;
...
pub mod commit {
    ...
    pub struct Outcome<'a> {
        ...
        pub virtual_merge_bases: Vec<src_hash::ObjectId>,
    }
    ...
    impl From<src_merge::tree::Options> for Options {
        fn from(value: src_merge::tree::Options) -> Self {
            Options {
    ...
    impl From<Options> for src_merge::commit::Options {
        fn from(
            Options {
...
///
pub mod tree {
    use src_merge::blob::builtin_driver;
    pub use src_merge::tree::{
    ...
    #[derive(Default, Debug, Clone)]
    pub struct Options {
        inner: src_merge::tree::Options,
        file_favor: Option<FileFavor>,
        tree_favor: Option<TreeFavor>,
    }

    impl From<src_merge::tree::Options> for Options {
        fn from(opts: src_merge::tree::Options) -> Self {
            Options {
                inner: opts,
                file_favor: None,
                tree_favor: None,
    ...
    impl From<Options> for src_merge::tree::Options {
    ...
    impl From<TreeFavor> for src_merge::tree::ResolveWith {
        fn from(value: TreeFavor) -> Self {
            match value {
                TreeFavor::Ours => src_merge::tree::ResolveWith::Ours,
                TreeFavor::Ancestor => src_merge::tree::ResolveWith::Ancestor,
            }
        }
    }
    ...
    impl Options {
        ...
        pub fn with_rewrites(mut self, rewrites: Option<src_diff::Rewrites>) -> Self {
