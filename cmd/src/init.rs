...
impl ThreadSafeRepository {
    ...
    pub fn init(
        ...
        let open_options = crate::open::Options::default_for_level(src_sec::Trust::Full);
    ...
    pub fn init_opts(
        ...
        open_options.git_dir_trust = Some(src_sec::Trust::Full);
        // The repo will use `core.precomposeUnicode` to adjust the value as needed.
        open_options.current_dir = src_fs::current_dir(false)?.into();
