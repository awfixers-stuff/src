...
impl Repository {
    ...
    pub fn open_modules_file(&self) -> Result<Option<src_submodule::File>, submodule::open_modules_file::Error> {
        ...
        Ok(Some(src_submodule::File::from_bytes(
            &buf,
            path,
    ...
    pub fn modules(&self) -> Result<Option<submodule::ModulesSnapshot>, submodule::modules::Error> {
        match self.modules.recent_snapshot(
            ...
            None => {
                ...
                Ok(Some(src_features::threading::OwnShared::new(
                    src_submodule::File::from_bytes(&self.find_object(id)?.data, None, &self.config.resolved)
