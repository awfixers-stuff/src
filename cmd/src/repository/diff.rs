...
impl Repository {
    ...
    pub fn diff_resource_cache(
        ...
        worktree_roots: src_diff::blob::pipeline::WorktreeRoots,
    ) -> Result<src_diff::blob::Platform, diff_resource_cache::Error> {
    ...
    pub fn diff_tree_to_tree<'a, 'old_repo: 'a, 'new_repo: 'a>(
        ...
        let mut cache = self.diff_resource_cache(src_diff::blob::pipeline::Mode::ToGit, Default::default())?;
        let opts = options
            .into()
    ...
    pub fn diff_resource_cache_for_tree_diff(&self) -> Result<src_diff::blob::Platform, diff_resource_cache::Error> {
        self.diff_resource_cache(
            src_diff::blob::pipeline::Mode::ToGit,
            src_diff::blob::pipeline::WorktreeRoots::default(),
        )
    }
}
