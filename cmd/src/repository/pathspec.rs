use src_pathspec::MagicSignature;
...
impl Repository {
    ...
    /// Return default settings that are required when [parsing pathspecs](src_pathspec::parse()) by hand.
    ///
    ...
    pub fn pathspec_defaults(&self) -> Result<src_pathspec::Defaults, src_pathspec::defaults::from_environment::Error> {
    ...
    pub fn pathspec_defaults_inherit_ignore_case(
        &self,
        inherit_ignore_case: bool,
    ) -> Result<src_pathspec::Defaults, crate::repository::pathspec_defaults_ignore_case::Error> {
