...
impl crate::Repository {
    ...
    ///
    /// Note that these values have not been [probed](src_fs::Capabilities::probe()).
    pub fn filesystem_options(&self) -> Result<src_fs::Capabilities, config::boolean::Error> {
    ...
    /// Note that these values have not been [probed](src_fs::Capabilities::probe()).
    #[cfg(feature = "index")]
    pub fn stat_options(&self) -> Result<src_index::entry::stat::Options, config::stat_options::Error> {
    ...
    pub fn ignore_pattern_parser(&self) -> Result<src_ignore::search::Ignore, config::boolean::Error> {
    ...
    pub fn ssh_connect_options(
        &self,
    ) -> Result<src_protocol::transport::client::blocking_io::ssh::connect::Options, config::ssh_connect_options::Error>
    {
        use crate::config::{
        ...
        let ssh_command = config
            ...
            .map(|cmd| src_path::from_bstr(cmd).into_owned().into());
        let opts = src_protocol::transport::client::blocking_io::ssh::connect::Options {
    ...
    pub fn command_context(&self) -> Result<src_command::Context, config::command_context::Error> {
    ...
    pub fn object_hash(&self) -> src_hash::Kind {
    ...
    pub fn diff_algorithm(&self) -> Result<src_diff::blob::Algorithm, config::diff::algorithm::Error> {
...
impl crate::Repository {
    pub(crate) fn filter_config_section(&self) -> fn(&src_config::file::Metadata) -> bool {
        self.options
