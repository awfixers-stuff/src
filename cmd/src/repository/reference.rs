...
impl crate::Repository {
    ...
    pub fn set_namespace<'a, Name, E>(
        &mut self,
        namespace: Name,
    ) -> Result<Option<src_ref::Namespace>, src_validate::reference::name::Error>
    where
        Name: TryInto<&'a PartialNameRef, Error = E>,
        src_validate::reference::name::Error: From<E>,
    {
        let namespace = src_ref::namespace::expand(namespace)?;
        ...
        src_validate::reference::name::Error: From<E>,
    {
        self.reference_inner(
            name.try_into().map_err(src_validate::reference::name::Error::from)?,
            target.into(),
            constraint,
            log_message.into(),
        )
    ...
    pub fn edit_references_as(
        &self,
        edits: impl IntoIterator<Item = RefEdit>,
        committer: Option<src_actor::SignatureRef<'_>>,
    ) -> Result<Vec<RefEdit>, reference::edit::Error> {
    ...
    where
        ...
        src_ref::file::find::Error: From<E>,
    {
        ...
        let partial_name = name
            .clone()
            .try_into()
            .map_err(|err| reference::find::Error::Find(src_ref::file::find::Error::from(err)))?;
