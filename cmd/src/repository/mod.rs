...
pub mod blame_file {
    ...
    pub struct Options {
        ...
        pub diff_algorithm: Option<src_diff::blob::Algorithm>,
        /// The ranges to blame in the file.
        pub ranges: src_blame::BlameRanges,
        /// Don't consider commits before the given date.
        pub since: Option<src_date::Time>,
...
pub mod diff_tree_to_tree {
    ...
    pub enum Error {
        ...
        #[error(transparent)]
        TreeDiff(#[from] src_diff::tree_with_rewrites::Error),
    }
}
...
pub mod merge_trees {
    ...
    pub enum Error {
        ...
        DiffResourceCache(#[from] super::diff_resource_cache::Error),
        #[error(transparent)]
        TreeMerge(#[from] src_merge::tree::Error),
        #[error(transparent)]
...
pub mod merge_commits {
    ...
    pub enum Error {
        ...
        DiffResourceCache(#[from] super::diff_resource_cache::Error),
        #[error(transparent)]
        CommitMerge(#[from] src_merge::commit::Error),
        #[error(transparent)]
        ValidationOptions(#[from] crate::config::boolean::Error),
    }
}
...
pub mod virtual_merge_base_with_graph {
    ...
    pub enum Error {
        ...
        #[error(transparent)]
        DecodeCommit(#[from] src_object::decode::Error),
    }
}
...
pub mod merge_base_octopus_with_graph {
    ...
    pub enum Error {
        ...
        NoMergeBase,
        #[error(transparent)]
        MergeBase(#[from] src_revision::merge_base::Error),
    }
}
...
pub mod merge_base {
    ...
    pub enum Error {
        ...
        OpenCache(#[from] crate::repository::commit_graph_if_enabled::Error),
        #[error(transparent)]
        FindMergeBase(#[from] src_revision::merge_base::Error),
        #[error("Could not find a merge-base between commits {first} and {second}")]
        NotFound {
            first: src_hash::ObjectId,
            second: src_hash::ObjectId,
        },
    }
}
...
pub mod index_from_tree {
    ...
    pub enum Error {
        ...
        IndexFromTree {
            id: src_hash::ObjectId,
            source: src_index::init::from_tree::Error,
        },
...
pub mod branch_remote_ref_name {
    ...
    pub enum Error {
        ...
        ValidateFetchRemoteRefName(#[from] src_validate::reference::name::Error),
        #[error(transparent)]
...
pub mod branch_remote_tracking_ref_name {
    ...
    pub enum Error {
        ...
        ValidateTrackingRef(#[from] src_validate::reference::name::Error),
...
pub mod upstream_branch_and_remote_name_for_tracking_branch {
    ...
    pub enum Error {
        ...
        BranchCategory { full_name: src_ref::FullName },
        #[error(transparent)]
        FindRemote(#[from] crate::remote::find::existing::Error),
        ...
        #[error(transparent)]
        ValidateUpstreamBranch(#[from] src_ref::name::Error),
    }
}
...
pub mod pathspec_defaults_ignore_case {
    ...
    pub enum Error {
        ...
        #[error(transparent)]
        Defaults(#[from] src_pathspec::defaults::from_environment::Error),
    }
}
...
pub mod index_or_load_from_head {
    ...
    pub enum Error {
        ...
        #[error(transparent)]
        TreeId(#[from] src_object::decode::Error),
        #[error(transparent)]
...
pub mod worktree_archive {
    ...
    pub type Error = src_error::Error;
}
