...
pub struct Environment {
    ...
    ///
    /// Note that [`src_sec::Permission::Forbid`] will cause the operation to abort if a resource is set via the XDG config environment.
    pub xdg_config_home: src_sec::Permission,
    /// Control the way resources pointed to by the home directory (similar to `xdg_config_home`) may be used.
    pub home: src_sec::Permission,
    ...
    pub http_transport: src_sec::Permission,
...
impl Environment {
    ...
    pub fn isolated() -> Self {
        let deny = src_sec::Permission::Deny;
        Environment {
...
impl src_sec::trust::DefaultForLevel for Permissions {
