...
) -> src_config::path::interpolate::Context<'a> {
    src_config::path::interpolate::Context {
        git_install_dir,
        home_dir,
        home_for_user: Some(src_config::path::interpolate::home_for_user), // TODO: figure out how to configure this
    }
}

pub(crate) fn base_options(lossy: bool, lenient: bool) -> src_config::file::init::Options<'static> {
...
pub(crate) fn query_refupdates(
    ...
    lenient_config: bool,
) -> Result<Option<src_ref::store::WriteReflog>, Error> {
...
pub(crate) fn query_refs_namespace(
    config: &src_config::File<'static>,
    lenient_config: bool,
) -> Result<Option<src_ref::Namespace>, config::refs_namespace::Error> {
...
pub(crate) fn reflog_or_default(
    config_reflog: Option<src_ref::store::WriteReflog>,
    has_worktree: bool,
) -> src_ref::store::WriteReflog {
...
/// Return `(pack_cache_bytes, object_cache_bytes)` as parsed from src-config
