...
mod key_impls {
    ...
    impl crate::config::tree::http::FollowRedirects {
        ...
        pub fn try_into_follow_redirects(
            ...
            boolean: impl FnOnce() -> Result<Option<bool>, src_config::value::Error>,
        ) -> Result<
    ...
    impl super::Version {
        pub fn try_into_http_version(
            ...
            src_protocol::transport::client::blocking_io::http::options::HttpVersion,
            crate::config::key::GenericErrorWithValue,
        > {
            use src_protocol::transport::client::blocking_io::http::options::HttpVersion;
    ...
    impl ProxyAuthMethod {
        pub fn try_into_proxy_auth_method(
            ...
            src_protocol::transport::client::blocking_io::http::options::ProxyAuthMethod,
            crate::config::key::GenericErrorWithValue,
        > {
            use src_protocol::transport::client::blocking_io::http::options::ProxyAuthMethod;
    ...
    impl SslVersion {
        pub fn try_into_ssl_version(
            ...
            src_protocol::transport::client::blocking_io::http::options::SslVersion,
            crate::config::ssl_version::Error,
        > {
            use src_protocol::transport::client::blocking_io::http::options::SslVersion::*;
    ...
    impl Validate for FollowRedirects {
        fn validate(&self, _value: &BStr) -> Result<(), Box<dyn Error + Send + Sync + 'static>> {
            ...
            super::Http::FOLLOW_REDIRECTS.try_into_follow_redirects(std::borrow::Cow::Borrowed(_value), || {
                src_config::Boolean::try_from(_value).map(|b| Some(b.0))
            })?;
            Ok(())
        }
    }
