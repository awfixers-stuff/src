...
mod key_impls {
    impl super::Version {
        ...
        pub fn try_into_protocol_version(
            &'static self,
            value: Option<Result<i64, src_config::value::Error>>,
        ) -> Result<src_protocol::transport::Protocol, crate::config::key::GenericErrorWithValue> {
            let value = match value {
                None => return Ok(src_protocol::transport::Protocol::V2),
                Some(v) => v,
            };
            Ok(match value {
                Ok(0) => src_protocol::transport::Protocol::V0,
                Ok(1) => src_protocol::transport::Protocol::V1,
                Ok(2) => src_protocol::transport::Protocol::V2,
                Ok(other) => {
