...
//!
//! Note that it's possible to let `src` act like `git` or `git2` by setting the [open::Options::bail_if_untrusted()] option.
//!
...
//!
//! When reading the documentation of the canonical src-worktree program one gets the impression work tree and working tree are used
...
pub use src_actor as actor;
#[cfg(feature = "attributes")]
pub use src_attributes as attrs;
#[cfg(feature = "blame")]
pub use src_blame as blame;
#[cfg(feature = "command")]
pub use src_command as command;
pub use src_commitgraph as commitgraph;
#[cfg(feature = "credentials")]
pub use src_credentials as credentials;
pub use src_date as date;
#[cfg(feature = "dirwalk")]
pub use src_dir as dir;
pub use src_error as error;
pub use src_features as features;
use src_features::threading::OwnShared;
pub use src_features::{
    parallel,
    progress::{Count, DynNestedProgress, NestedProgress, Progress},
    threading,
};
pub use src_fs as fs;
pub use src_glob as glob;
pub use src_hash as hash;
pub use src_hashtable as hashtable;
#[cfg(feature = "excludes")]
pub use src_ignore as ignore;
#[doc(inline)]
#[cfg(feature = "index")]
pub use src_index as index;
pub use src_lock as lock;
#[cfg(feature = "credentials")]
pub use src_negotiate as negotiate;
pub use src_object as objs;
pub use src_object::bstr;
pub use src_odb as odb;
#[cfg(feature = "credentials")]
pub use src_prompt as prompt;
pub use src_protocol as protocol;
pub use src_ref as refs;
pub use src_refspec as refspec;
pub use src_revwalk as revwalk;
pub use src_sec as sec;
pub use src_tempfile as tempfile;
pub use src_trace as trace;
pub use src_traverse as traverse;
pub use src_url as url;
#[doc(inline)]
pub use src_url::Url;
pub use src_utils as utils;
pub use src_validate as validate;
pub use hash::{oid, ObjectId};

pub use src_error::{Error, Exn};
...
where
    Url: std::convert::TryInto<src_url::Url, Error = E>,
    src_url::parse::Error: From<E>,
{
...
fn open_opts_with_git_binary_config() -> open::Options {
    use src_sec::trust::DefaultForLevel;
    let mut opts = open::Options::default_for_level(src_sec::Trust::Full);
...
#[cfg(feature = "attributes")]
fn is_dir_to_mode(is_dir: bool) -> src_index::entry::Mode {
    if is_dir {
        src_index::entry::Mode::DIR
    } else {
        src_index::entry::Mode::FILE
    }
}
