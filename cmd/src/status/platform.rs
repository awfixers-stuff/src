    ...
    Progress: src_features::progress::Progress,
{
    ...
    pub fn untracked_files(mut self, untracked_files: UntrackedFiles) -> Self {
        let mode = match untracked_files {
            ...
            UntrackedFiles::Collapsed => src_dir::walk::EmissionMode::CollapseDirectory,
            UntrackedFiles::Files => src_dir::walk::EmissionMode::Matching,
        };
    ...
    pub fn index_worktree_rewrites(mut self, rewrites: impl Into<Option<src_diff::Rewrites>>) -> Self {
        ...
        if rewrites.is_some() && self.index_worktree_options.sorting.is_none() {
            self.index_worktree_options.sorting =
                Some(src_status::index_as_worktree_with_renames::Sorting::ByPathCaseSensitive);
        }
        self
    }
    ...
    pub fn head_tree(mut self, tree: impl Into<src_hash::ObjectId>) -> Self {
