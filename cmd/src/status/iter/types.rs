...
impl Outcome {
    ...
    pub fn write_changes(&mut self) -> Option<Result<(), src_index::file::write::Error>> {
        let _span = src_features::trace::coarse!("src::status::index_worktree::Outcome::write_changes()");
...
impl From<src_diff::index::Change> for Item {
    fn from(value: src_diff::index::Change) -> Self {
