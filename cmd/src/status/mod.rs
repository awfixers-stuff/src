pub use src_status as plumbing;
...
where
    Progress: src_features::progress::Progress + 'static,
{
    repo: &'repo Repository,
    progress: Progress,
    index: Option<crate::worktree::IndexPersistedOrInMemory>,
    head_tree: Option<Option<src_hash::ObjectId>>,
...
impl Repository {
    ...
    where
        P: src_features::progress::Progress + 'static,
    {
...
pub mod is_dirty {
    ...
    impl Repository {
        ...
        pub fn is_dirty(&self) -> Result<bool, Error> {
            ...
            let is_dirty = self
                .status(src_features::progress::Discard)?
