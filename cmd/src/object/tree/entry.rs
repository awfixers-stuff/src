...
impl<'repo> Entry<'repo> {
    ...
    pub fn mode(&self) -> src_object::tree::EntryMode {
        self.inner.mode
    }
    ...
    pub fn oid(&self) -> &src_hash::oid {
        &self.inner.oid
    }

    /// Return the plain object id of this entry, without access to the repository.
    pub fn object_id(&self) -> src_hash::ObjectId {
        self.inner.oid
    }
}
...
impl Entry<'_> {
    ...
    pub fn detach(self) -> src_object::tree::Entry {
        self.inner
    }
}
...
impl<'repo, 'a> EntryRef<'repo, 'a> {
    ...
    pub fn kind(&self) -> src_object::tree::EntryKind {
        self.inner.mode.kind()
    }

    /// The name of the file in the parent tree.
    pub fn filename(&self) -> &src_object::bstr::BStr {
        self.inner.filename
    }
    ...
    pub fn detach(&self) -> src_object::tree::EntryRef<'a> {
        self.inner
    }
