...
pub use src_diff::tree_with_rewrites::Change as ChangeDetached;
...
pub enum Change<'a, 'old, 'new> {
    ...
    Addition {
        ...
        entry_mode: src_object::tree::EntryMode,
    ...
    Modification {
        ...
        previous_entry_mode: src_object::tree::EntryMode,
    ...
    Rewrite {
        ...
        source_entry_mode: src_object::tree::EntryMode,
        /// The object id of the entry before the rename.
        ///
        /// Note that this is the same as `id` if we require the [similarity to be 100%](src_diff::Rewrites::percentage), but may
