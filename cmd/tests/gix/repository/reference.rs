mod set_namespace {
    use src::refs::transaction::PreviousValue;
    use src_testtools::tempfile;

    fn easy_repo_rw() -> crate::Result<(src::Repository, tempfile::TempDir)> {
    ...
    fn affects_edits_and_iteration() -> crate::Result {
        ...
        repo.tag_reference(
            "new-tag",
            src::ObjectId::empty_tree(src::hash::Kind::Sha1),
...
mod head {
    ...
    use src_ref::transaction::PreviousValue;
