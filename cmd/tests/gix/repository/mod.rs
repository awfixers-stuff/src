...
mod index {
    ...
    fn basics() -> crate::Result {
        ...
        assert_eq!(
            ...
            Some(true),
            "This is a quirk of default values in src and the way we override the initial branch for test fixtures"
        );
        Ok(())
    }
}
...
mod dirwalk {
    ...
    use src_dir::{entry::Kind::*, walk::EmissionMode};
    ...
    fn basics() -> crate::Result {
        ...
        let mut collect = src::dir::walk::delegate::Collect::default();
