...
use src_filter::driver::apply::Delay;
...
fn pipeline_worktree_file_to_object() -> crate::Result {
    ...
    assert_eq!(
        ...
        Some((submodule_id, src::object::tree::EntryKind::Commit))
    );
    assert_eq!(
    ...
    assert_eq!(
        ...
        Some((
            ...
            src::object::tree::EntryKind::Link
        ))
    );
    assert_eq!(
        ...
        Some((
            ...
            src::object::tree::EntryKind::BlobExecutable
        ))
    );
    assert_eq!(
