...
fn apply_mailbox() -> Result {
    ...
    assert_eq!(repo.state(), Some(src::state::InProgress::ApplyMailbox));
    Ok(())
}
...
fn bisect() -> Result {
    ...
    assert_eq!(repo.head_name()?.unwrap().shorten(), "main");
    assert_eq!(repo.state(), Some(src::state::InProgress::Bisect));
...
fn cherry_pick() -> Result {
    ...
    assert_eq!(repo.head_name()?.unwrap().shorten(), "main");
    assert_eq!(repo.state(), Some(src::state::InProgress::CherryPick));
    Ok(())
}
...
fn cherry_pick_sequence() -> Result {
    ...
    assert_eq!(repo.head_name()?.unwrap().shorten(), "main");
    assert_eq!(repo.state(), Some(src::state::InProgress::CherryPickSequence));
...
fn merge() -> Result {
    ...
    assert_eq!(repo.head_name()?.unwrap().shorten(), "main");
    assert_eq!(repo.state(), Some(src::state::InProgress::Merge));
...
fn rebase_interactive() -> Result {
    ...
    assert_eq!(repo.state(), Some(src::state::InProgress::RebaseInteractive));
...
fn revert() -> Result {
    ...
    assert_eq!(repo.head_name()?.unwrap().shorten(), "main");
    assert_eq!(repo.state(), Some(src::state::InProgress::Revert));
...
fn revert_sequence() -> Result {
    ...
    assert_eq!(repo.head_name()?.unwrap().shorten(), "main");
    assert_eq!(repo.state(), Some(src::state::InProgress::RevertSequence));
