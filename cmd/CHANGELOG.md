 ...
 * **Uncategorized**
    ...
    - Merge pull request #2312 from GitoxideLabs/copilot/adapt-script-for-src-test-suite ([`0b29bd3`](https://github.com/GitoxideLabs/gitoxide/commit/0b29bd3d68f8b3a4ae0dbe16866e31d2fb66dfce))
...
### Bug Fixes
 ...
 - <csr-id-f7700e452c79ff5582626bb3377d0429a921d869/> refspec for shallow clones uses a single-branch
   ...
   This addresses issue #2227 where `src clone --depth 1` was creating
 ...
 * **Uncategorized**
    ...
    - Adapt to changes in `src-protocol`: Outcome -> Handshake ([`a61b2ab`](https://github.com/GitoxideLabs/gitoxide/commit/a61b2abd74e112450788bfa6355dfa8239f360b6))
    ...
    - Merge pull request #2240 from cruessler/add-src-repository-blame-options ([`385ab16`](https://github.com/GitoxideLabs/gitoxide/commit/385ab16b591b847b144c1a94de6b46a8ec8fa08a))
...
### New Features
 ...
 - <csr-id-fa1287f2e218a0959700cb858b41465f315db9d9/> Add `src::discover_with_environment_overrides()`
...
### Bug Fixes
 ...
 - <csr-id-ba563b0e39ebc3ce635f399accd8a4be5210f816/> extend lifetime of iterators
   ...
   were shorter than the actual lifetimes of the `src::Reference`
 ...
 * **Uncategorized**
    ...
    - Adapt to change in `src-blame` ([`268dac4`](https://github.com/GitoxideLabs/gitoxide/commit/268dac4a18c8be8bacd89e1890d870253b0e1400))
    ...
    - Implement WriteTo trait for src::Blob with comprehensive tests ([`ca99882`](https://github.com/GitoxideLabs/gitoxide/commit/ca9988284c48e96210ebdc6417b75cc6e8e3b396))
    ...
    - In `src-features`, use `libz-rs-sys` directly, skipping `flate2` ([`5a2361b`](https://github.com/GitoxideLabs/gitoxide/commit/5a2361b42b01d77a98c7f16c23783f69a59740f7))
    - Merge pull request #2154 from folkertdev/fix-src-blame-performance-regression ([`768164a`](https://github.com/GitoxideLabs/gitoxide/commit/768164a877bf1f73cfa72eae9d73ff1949178900))
    - Add `Repository::blame_file` ([`cdb1100`](https://github.com/GitoxideLabs/gitoxide/commit/cdb1100d7ec85868298c5ebe30d2bc5711c4b7eb))
    - Fix `src-blame` performance regresion ([`8dc5e98`](https://github.com/GitoxideLabs/gitoxide/commit/8dc5e98d9dfe1fdbbd9db15ea149f253c9aaad0e))
    ...
    - Add `src::discover_with_environment_overrides()` ([`fa1287f`](https://github.com/GitoxideLabs/gitoxide/commit/fa1287f2e218a0959700cb858b41465f315db9d9))
 ...
 * **Uncategorized**
    ...
    - Adapt to changes in `src-diff` ([`a0cef8b`](https://github.com/GitoxideLabs/gitoxide/commit/a0cef8bd5351acd334459b115c139a9c75e41f55))
    ...
    - Use `src` manifest `rust-version` in all MSRV checks ([`654a8fa`](https://github.com/GitoxideLabs/gitoxide/commit/654a8fa1a84ac0b9b872aa09b4cbd3cf94157d6f))
...
### Bug Fixes
 ...
 - <csr-id-b07f907ba2e01849744c72df35dac57b624f2f85/> Adapt to changes in src-actor
   ...
   interpret these bytes into a `src_date::Time` on demand.
 ...
 - <csr-id-38b63c2fc9d407b3c634d8b0c72d4d0c104aa5ad/> make `fs::walkdir_sorted_new()` sort entries by paths literally
   ...
   The comparison function is copied from src::diff::object::tree::EntryRef.
 ...
 * **Uncategorized**
    ...
    - Adapt `Cargo.toml` files in workspace to `src-features` bump ([`6315536`](https://github.com/GitoxideLabs/gitoxide/commit/63155368cc5074328314f1b3f565e5813df725cf))
    ...
    - Merge pull request #1933 from GitoxideLabs/release-src-features ([`1612c73`](https://github.com/GitoxideLabs/gitoxide/commit/1612c73a16c8d900e1b6ef35b25bd6b3e3f6652a))
    - Release src-features v0.41.1 ([`fc5faf2`](https://github.com/GitoxideLabs/gitoxide/commit/fc5faf24dfc6d6e1580308ec5e7c12e96e0ccb41))
...
### Changed (BREAKING)
 ...
 - <csr-id-fd12ef89af29bf0684fc1df3e7b76ff367dee994/> drop obsolete SHA‐1 features
   The hashing API has moved to `src_hash::hasher`, and we now use
 ...
 * **Uncategorized**
    ...
    - Migrate `src_object::{try_ =>}compute_hash` users ([`3d7e379`](https://github.com/GitoxideLabs/gitoxide/commit/3d7e379f26cbe53ddb430427b8e88ce0966be456))
    ...
    - Adapt to changes in `src-features` ([`5f8bff8`](https://github.com/GitoxideLabs/gitoxide/commit/5f8bff844420a2ea1fb1f949650451d235251185))
    ...
    - Use `src_fs::stack::ToNormalPathComponents` everywhere. ([`1f98edb`](https://github.com/GitoxideLabs/gitoxide/commit/1f98edbaa51caaf152eda289b769388676259a06))
...
### New Features
 ...
 - <csr-id-25efbfb72e5a043ce8f7d196c1f7104ef93394df/> Add `blame` plumbing crate to the top-level.
   For now, it doesn't come with a simplified `src` API though.
 ...
 * **Uncategorized**
    ...
    - Adapt to changes in `src-refspec` ([`6d7dd9b`](https://github.com/GitoxideLabs/gitoxide/commit/6d7dd9bced4a1a0e8175e047be838746a95aa596))
...
### Changed
 ...
 - <csr-id-c0f4da5ef4791370c98f34f0eb3bb5773edbba32/> Adjust src::dirwalk::Options::{X,set_X} parameter names
   This adjusts the names of parameters to `X` and `set_X` methods of
   `src::dirwalk::Options` (where `X` is an option name) to use a
...
### New Features (BREAKING)
 ...
 - <csr-id-6367c7d0a796aff8ee8778916c1a1ddae68b654d/> Add `src-shallow` crate and use it from `src` and `src-protocol`
   That way it's easier to reuse shallow-handling code from plumbing crates.
   
   Note that this is a breaking change as `src-protocol` now uses the `src-shallow::Update`
...
<csr-id-bd905a6f151ac7f3153f5208ef7c2d686f372c30/>
 ...
 - <csr-id-ea8b95f4df8a6b06aa393acd907f6400785661ff/> symlinks_to_directories_are_ignored_like_directories by value
   The methods of `src::dirwalk::Options` are paired, where for each
 ...
 * **Uncategorized**
    ...
    - Add `src-shallow` crate and use it from `src` and `src-protocol` ([`6367c7d`](https://github.com/GitoxideLabs/gitoxide/commit/6367c7d0a796aff8ee8778916c1a1ddae68b654d))
    ...
    - Adjust src::dirwalk::Options::{X,set_X} parameter names ([`c0f4da5`](https://github.com/GitoxideLabs/gitoxide/commit/c0f4da5ef4791370c98f34f0eb3bb5773edbba32))
    ...
    - Adapt to changes in `src-merge` ([`aaeb427`](https://github.com/GitoxideLabs/gitoxide/commit/aaeb4273de936e293030a895e9bb147ce614c58a))
    ...
    - Improve merge related API in `src` ([`b2b8181`](https://github.com/GitoxideLabs/gitoxide/commit/b2b8181748ae1a3727fbbd01bfb85758f7ba3805))
...
### New Features
 ...
 - <csr-id-07746f3ccf3e5c71f12319cfd2fb069b5f380624/> `src::Repository` implements all traits for object reading and writing.
 ...
 * **Uncategorized**
    ...
    - Add test to assure `hasconfig` is working on `src` level as well. ([`d51aec9`](https://github.com/GitoxideLabs/gitoxide/commit/d51aec95588fee219dee62438d26e4574d38a497))
    ...
    - Regenerate src make_rev_spec_parse_repos fixture archive ([`72cd7f3`](https://github.com/GitoxideLabs/gitoxide/commit/72cd7f337355c04782f3b804280005234416b8a1))
    ...
    - `src::Repository` implements all traits for object reading and writing. ([`07746f3`](https://github.com/GitoxideLabs/gitoxide/commit/07746f3ccf3e5c71f12319cfd2fb069b5f380624))
...
### New Features (BREAKING)
 ...
 - <csr-id-d63ec06500386450f6f7b9e3b9d23ad759371832/> Do not let `revision::walk::Platform` rely on plumbing crate types.
   ...
   Notably, this replaces `src_traverse::commit::simple::Sorting` with
   `src::revision::walk::Sorting`.
 ...
 * **Uncategorized**
    ...
    - Adapt to changes in `src-diff` ([`3fd9fab`](https://github.com/GitoxideLabs/gitoxide/commit/3fd9fabe0c0e74d54b5153c4f572eff76293f334))
    - Thanks clippy ([`af03832`](https://github.com/GitoxideLabs/gitoxide/commit/af0383254422b70d53f27572c415eea2e4154447))
    - Adapt to changes in `src-diff` ([`2bf1e5f`](https://github.com/GitoxideLabs/gitoxide/commit/2bf1e5f15a60ef57c7c15279124d3eb227e585e0))
    ...
    - Adapt to chagnes in `src-diff` ([`5c1f010`](https://github.com/GitoxideLabs/gitoxide/commit/5c1f010851e40bf5b284ec82e6cd27cd41ab70bf))
    ...
    - Use new `WorktreeRoot` API provided by `src-diff` ([`25c6806`](https://github.com/GitoxideLabs/gitoxide/commit/25c68067d87ddcb476f973af6d7e29f9533166a8))
    ...
    - Adapt to changes in `src-protocol` ([`0d3b480`](https://github.com/GitoxideLabs/gitoxide/commit/0d3b480e5e7d27c308fb5f76f36831dfc7af3e8f))
 ...
 * **Uncategorized**
    ...
    - Adapt to changes in `src-ref` ([`d296ee8`](https://github.com/GitoxideLabs/gitoxide/commit/d296ee87e1b46e603b98a5f5ebf9e6f0695f8a52))
    - Adapt to changes in `src-ref` ([`5464bfb`](https://github.com/GitoxideLabs/gitoxide/commit/5464bfb2df3fa8b5c582718349997170c3f2745e))
    ...
    - Release src-credentials v0.24.4 ([`f6a4eb9`](https://github.com/GitoxideLabs/gitoxide/commit/f6a4eb98740fe4151e293d53a578233119307a58))
    - Merge branch 'fix-clean' ([`33eacfb`](https://github.com/GitoxideLabs/gitoxide/commit/33eacfbaace2021043e2b5d72dcb9293af6c4020))
    - Adapt to changes in `src-dir` ([`37c2852`](https://github.com/GitoxideLabs/gitoxide/commit/37c2852a1fdbc13ff9e76db6f60224b4cb5f75ab))
</details>
...
### New Features
 ...
 - <csr-id-afc6e258ce0445c804707f7cee2daccde1df937d/> export `src_validate` as `validate`.
   The crate appears in the public API of `src_index::State::from_tree`
...
### Bug Fixes
 ...
 - <csr-id-c8c56aebaac95f0f73220055dc33e6e0ebdb5ced/> re-export `src_validate` as it's now part of the public API.
...
### New Features (BREAKING)
 ...
 - <csr-id-0ec2389e4e3c457f87cff2cbdd394a94f7d0d54a/> `src-config` convenience initiative
   A new `src_config::AsKey` trait allows all `src_config::File` methods
   ...
   This change also affects the public API of `src`, which provides
   ways to set values on configuration snapshots which now by default
   will only take a `AsKey` implementation.
   
   Note that `src::config::tree::*` keys now also implement `AsKey`,
 ...
 * **Uncategorized**
    ...
    - Adapt to changes in `src-testtools` ([`f5a9884`](https://github.com/GitoxideLabs/gitoxide/commit/f5a9884006b0ea8d22cc51a119ae87ce10cd3484))
    ...
    - Release src-actor v0.31.3, src-mailmap v0.23.4 ([`1e79c5c`](https://github.com/GitoxideLabs/gitoxide/commit/1e79c5cdf20fc0440e9a497c9d01b0c0ca3ce424))
    ...
    - Release src-mailmap v0.23.3 ([`0c5d1ff`](https://github.com/GitoxideLabs/gitoxide/commit/0c5d1ff3f48aab43119f86501b14974f92c2017d))
    ...
    - Re-export `src_validate` as it's now part of the public API. ([`c8c56ae`](https://github.com/GitoxideLabs/gitoxide/commit/c8c56aebaac95f0f73220055dc33e6e0ebdb5ced))
    - Export `src_validate` as `validate`. ([`afc6e25`](https://github.com/GitoxideLabs/gitoxide/commit/afc6e258ce0445c804707f7cee2daccde1df937d))
    ...
    - `src-config` convenience initiative ([`0ec2389`](https://github.com/GitoxideLabs/gitoxide/commit/0ec2389e4e3c457f87cff2cbdd394a94f7d0d54a))
    ...
    - Release src-fs v0.11.1, src-glob v0.16.3 ([`2cefe77`](https://github.com/GitoxideLabs/gitoxide/commit/2cefe77203131878d0d8f5346f20f0e25b76cbea))
    - Merge pull request #1385 from Byron/fix-src-ref ([`8da55a3`](https://github.com/GitoxideLabs/gitoxide/commit/8da55a3488a3389ec02c56cb79d0f93d600905e7))
    - Release src-ref v0.44.1 ([`2d0a352`](https://github.com/GitoxideLabs/gitoxide/commit/2d0a3520e1df80f8f6edece0884a672cbc18839d))
...
### Bug Fixes
 ...
 - <csr-id-3c7b7b3a7b981040cd51417202d7022597179114/> empty paths as configured will not be an error with lenient configuration enabled.
   When using `src::open_opts(path, options.strict_config(false))`, empty `core.excludesFile` values
 ...
 * **Uncategorized**
    ...
    - Adapt to changes in `src-index` ([`5f86e6b`](https://github.com/GitoxideLabs/gitoxide/commit/5f86e6b11bb73921b458ffee9091bc028a7d6204))
    ...
    - Release src-index v0.32.1, src-pathspec v0.7.4, src-worktree v0.33.1, src-dir v0.4.1 ([`54ac559`](https://github.com/GitoxideLabs/gitoxide/commit/54ac55946bb04635cd74582a1ce2e4bee70f2e60))
...
Please note that this release contains a security fix originally implemented in `src-transport` via [this PR](https://github.com/Byron/gitoxide/pull/1342)
...
### Bug Fixes
 ...
 - <csr-id-719ced8a7949ba1f30fef13801e3466a7d1da590/> show submodules in status independently of their active state.
   ...
   so `src` should do the same.
   
   First observed in https://github.com/helix-editor/helix/pull/5645#issuecomment-2016798212
 - <csr-id-98cfbec51276bbd6caa48fd6d8942247df091c94/> forward `curl` rustls feature from `src-transport` to avoid `curl` in `src`.
 ...
 * **[#1328](https://github.com/GitoxideLabs/gitoxide/issues/1328)**
    - Forward `curl` rustls feature from `src-transport` to avoid `curl` in `src`. ([`98cfbec`](https://github.com/GitoxideLabs/gitoxide/commit/98cfbec51276bbd6caa48fd6d8942247df091c94))
 * **Uncategorized**
    ...
    - Remove dep reqwest from src ([`e3eedd8`](https://github.com/GitoxideLabs/gitoxide/commit/e3eedd8b5326b8de2e6fe8941e1851bdbad673ab))
</details>
...
### Bug Fixes
 ...
 - <csr-id-e1fec3c3a46a358036255a2487c2a48cc7176b4e/> missing closing backtick in src lib documentation
 ...
 * **Uncategorized**
    ...
    - Missing closing backtick in src lib documentation ([`e1fec3c`](https://github.com/GitoxideLabs/gitoxide/commit/e1fec3c3a46a358036255a2487c2a48cc7176b4e))
</details>
 ...
 * **Uncategorized**
    ...
    - Adapt to changes in `src-dir` ([`b90ab3d`](https://github.com/GitoxideLabs/gitoxide/commit/b90ab3dd5e8986e28624f3e1cf54f8a9171ce9f0))
 ...
 * **Uncategorized**
    ...
    - src-config now uses a Key trait rather than Into<&BStr> ([`6281e1a`](https://github.com/GitoxideLabs/gitoxide/commit/6281e1ac140c939b046ac88d536f16e076a3206c))
</details>
 ...
 * **Uncategorized**
    ...
    - Fix a typo in `src::clone::PrepareFetch::new`, crate_opts -> create_opts ([`adbf8e8`](https://github.com/GitoxideLabs/gitoxide/commit/adbf8e8dd8a112ece7fe6c1167892297f73ea325))
    ...
    - Adapt to changes in `src-dir` ([`e91accc`](https://github.com/GitoxideLabs/gitoxide/commit/e91accc8a1e03b04f0ae50c161201e53273f6e03))
    ...
    - Release src-command v0.3.4 ([`8a62fb5`](https://github.com/GitoxideLabs/gitoxide/commit/8a62fb57f7751d3d57273d9430517487e555f999))
 ...
 * **Uncategorized**
    ...
    - Use `src_fs::current_dir(precompose_unicode)`. ([`7d8d167`](https://github.com/GitoxideLabs/gitoxide/commit/7d8d1678c9dd185a369e996551a6ed89fbb391f5))
...
### Bug Fixes (BREAKING)
 ...
 - <csr-id-59b8104a5320d946abc9f5736fa76696cef1459d/> mark `src::interrupt::init_handler()` as unsafe
 ...
 * **Uncategorized**
    ...
    - Release src-ref v0.39.1 ([`c1cfe6e`](https://github.com/GitoxideLabs/gitoxide/commit/c1cfe6e4ab0d97ca98e93e1c01d9afa3b2c9a351))
    ...
    - Mark `src::interrupt::init_handler()` as unsafe ([`59b8104`](https://github.com/GitoxideLabs/gitoxide/commit/59b8104a5320d946abc9f5736fa76696cef1459d))
    ...
    - Release src-config v0.32.1 ([`cd26fd8`](https://github.com/GitoxideLabs/gitoxide/commit/cd26fd8babb023286ed9f6a6c71a06575de8d246))
...
### New Features
 ...
 - <csr-id-dd575cd0e3749ff7f59c1582cec0524ff231667d/> Add config value gitoxide.http.sslNoVerify
   ...
   transport Options.
 - <csr-id-c6e83cf69f1a17e9ba3010bcce3a4ddd3305424c/> In src read http.sslVerify config value and pass it to src-transport.
 ...
 - <csr-id-0ed0a8936eaf73407721fe0e06da5d345a54956b/> make `verbose-object-parsing-errors` available in `src`.
...
### Bug Fixes (BREAKING)
 ...
 - <csr-id-2189cee47f99350b368390eaa2a01961bb77c250/> rename `GITOXIDE_*` environment variables to `src_#`
 ...
 * **Uncategorized**
    - Release src v0.56.0 ([`476d5ef`](https://github.com/GitoxideLabs/gitoxide/commit/476d5ef2309ed0de20f3a46f0aad803579ab9ed4))
    ...
    - In src read http.sslVerify config value and pass it to src-transport. ([`c6e83cf`](https://github.com/GitoxideLabs/gitoxide/commit/c6e83cf69f1a17e9ba3010bcce3a4ddd3305424c))
    ...
    - Adapt to changes in `src-filter` ([`1763862`](https://github.com/GitoxideLabs/gitoxide/commit/17638628586900d43d730e6ed2a0862d8e408f29))
    ...
    - Adapt to changes in `src-credentials` ([`c712850`](https://github.com/GitoxideLabs/gitoxide/commit/c7128502d2f8a97b5f730920c056bbda7f4509a5))
    ...
    - Make `verbose-object-parsing-errors` available in `src`. ([`0ed0a89`](https://github.com/GitoxideLabs/gitoxide/commit/0ed0a8936eaf73407721fe0e06da5d345a54956b))
    ...
    - Adapt to changes in `src_object` and `src_odb`. ([`24e319e`](https://github.com/GitoxideLabs/gitoxide/commit/24e319e996b4822782521430a2d0e8ce3710f123))
 ...
 * **Uncategorized**
    ...
    - Merge branch 'src-url-parse-rewrite' ([`a12e4a8`](https://github.com/GitoxideLabs/gitoxide/commit/a12e4a88d5f5636cd694c72ce45a8b75aa754d28))
...
### New Features
 ...
 - <csr-id-f066f9889b57a4ffaebc0ed1442d77999498db42/> `PathSpec` implements `src_status::PathSpec` to allow it to be used there.
 ...
 - <csr-id-2734e84b74b761bff27fc1eb27f57d9d839c9240/> add `parallel` feature toggle
   ...
   If unset, most of `src` can only be used in a single thread
...
### Other
 ...
 - <csr-id-e022096aa495f55a05f83860243f49552be501f7/> add note about the trust-model.
   It should explain why `src` is happy to open repositories that won't
 ...
 * **Uncategorized**
    ...
    - `PathSpec` implements `src_status::PathSpec` to allow it to be used there. ([`f066f98`](https://github.com/GitoxideLabs/gitoxide/commit/f066f9889b57a4ffaebc0ed1442d77999498db42))
    ...
    - Apply `src_macros::momo` to `Repository::write_blob` ([`bae928d`](https://github.com/GitoxideLabs/gitoxide/commit/bae928d9668bbb4ba0dadb4605d77fc773362e3f))
    ...
    - Optimize `src`: de-momo `impl TryInto` by hand ([`b19c140`](https://github.com/GitoxideLabs/gitoxide/commit/b19c140ce3a6e5d9ddf65684361223a2f9fa7e73))
</details>
...
This release adds feature toggles which help to reduce compile time. Please [see the library](https://docs.rs/src/0.53.0/src/) documentation for all the details.

### New Features

 - <csr-id-2b8d09f785f471aa12fc6793f0ea40c1f8d9ea4a/> remove `log` dependency in favor of `src-trace`
 ...
 - <csr-id-147528ff647dc74473ef8dd4ceac6fedebc0b15c/> `src` without connection support includes less code
...
### Bug Fixes
 ...
 - <csr-id-a957478e0f623803bc6358d08b9ffaa2305e24d4/> put `src-credentials` and `src-prompt` behind the 'credentials' feature toggle.
...
### New Features (BREAKING)
 ...
 - <csr-id-54291fdfc62c7d8a31bc5564713c23eab3865dc5/> Provide a wrapper for `src_worktree::Stack` for simpler attribute queries.
 ...
 * **Uncategorized**
    ...
    - Remove `log` dependency in favor of `src-trace` ([`2b8d09f`](https://github.com/GitoxideLabs/gitoxide/commit/2b8d09f785f471aa12fc6793f0ea40c1f8d9ea4a))
    ...
    - Put `src-credentials` and `src-prompt` behind the 'credentials' feature toggle. ([`a957478`](https://github.com/GitoxideLabs/gitoxide/commit/a957478e0f623803bc6358d08b9ffaa2305e24d4))
    ...
    - `src` without connection support includes less code ([`147528f`](https://github.com/GitoxideLabs/gitoxide/commit/147528ff647dc74473ef8dd4ceac6fedebc0b15c))
    ...
    - Merge branch 'feat/src-momo' ([`a1ed6a1`](https://github.com/GitoxideLabs/gitoxide/commit/a1ed6a1aacae02a167b7ec44e1a47411a2194ff7))
    ...
    - Provide a wrapper for `src_worktree::Stack` for simpler attribute queries. ([`54291fd`](https://github.com/GitoxideLabs/gitoxide/commit/54291fdfc62c7d8a31bc5564713c23eab3865dc5))
    ...
    - Adapt to changes in `src-submodule` ([`f8471b1`](https://github.com/GitoxideLabs/gitoxide/commit/f8471b11e0d65fdb2617b927a8a207659a161439))
    - Release src-index v0.23.1 ([`11b9c71`](https://github.com/GitoxideLabs/gitoxide/commit/11b9c71311df978ebb20cca0d765cf249c8eedcf))
    ...
    - Apply `momo` to fn `src::Remote::save_as_to` ([`875c287`](https://github.com/GitoxideLabs/gitoxide/commit/875c28757e4a91cf314ec59dd1a0dde779698e53))
    - Apply `momo` to fn `src::revision::Spec::from_bstr` ([`1d90301`](https://github.com/GitoxideLabs/gitoxide/commit/1d9030112b54699db9bd8d1125116e46c4a6f71e))
    ...
    - Apply `momo` to mod `src::create::into` ([`cd3c289`](https://github.com/GitoxideLabs/gitoxide/commit/cd3c2893b095d38d36f0c969549f0aaadfcef2ee))
    ...
    - Dramatically simplify `src_macros::momo` ([`c72eaa0`](https://github.com/GitoxideLabs/gitoxide/commit/c72eaa05697a3e34adaa3ee90584dce4b5c00120))
    ...
    - Fix clippy lints in `src/src/repository/remote.rs` ([`ff210d8`](https://github.com/GitoxideLabs/gitoxide/commit/ff210d82573cebfdf4edbfb39beaef08979c058f))
    - Apply `momo` to mod `src::repository` ([`5a50537`](https://github.com/GitoxideLabs/gitoxide/commit/5a505377199730354c2a6b6b7b060184558bb9c4))
    ...
    - Apply `momo` to `src::reference` ([`3c205ab`](https://github.com/GitoxideLabs/gitoxide/commit/3c205abbdc0a80090b9f0f5681ce0949497e770f))
    - Apply `momo` to `src::pathspec` ([`767ec2d`](https://github.com/GitoxideLabs/gitoxide/commit/767ec2dcfd1fadaca93390770604494d03f88ab3))
    - Apply `momo` to mod `src::open::repository` ([`3ce0144`](https://github.com/GitoxideLabs/gitoxide/commit/3ce014499a86e4e8bb57ffe7caa540792c1c0a47))
    - Apply `momo` to `src::object::tree` ([`d835526`](https://github.com/GitoxideLabs/gitoxide/commit/d8355267fd64dbcf22a01a11cb29d93e75f0fb4c))
    - Apply `momo` to mod `src::init` ([`46a9dfe`](https://github.com/GitoxideLabs/gitoxide/commit/46a9dfe12dedc1cbf997ea408d1f1d2c5d673ba5))
    - Apply `momo` to mod `src::discover` ([`58fbb08`](https://github.com/GitoxideLabs/gitoxide/commit/58fbb08461064d96dd9816e2fb6911cf76b6badc))
...
### New Features
 ...
 - <csr-id-77da01456118227a59b654f32c15eeb1e5e19cd9/> make `src-pathspec` crate available
 - <csr-id-5c13459721eabb9d0746899a2498a104ddbdae59/> add `Commit::signature()` to yield the PGP sigature of a commit, if present.

### Bug Fixes

 - <csr-id-c51c8daee1ab54130ae3ed83ce67d08f01c4881a/> fix incorrect s/git-config/src-config/
   3a861c8f049f6502d3bcbdac752659aa1aeda46a just blindly replaced any
   occurence of "git-config" or "git_config" with "src-config"/"src_config".
   
   There is no such thing as a src-config file.
   src-config is a git-config file parser.
 ...
 * **Uncategorized**
    ...
    - Merge pull request #988 from not-my-profile/fix-src-config-sub ([`7735047`](https://github.com/GitoxideLabs/gitoxide/commit/7735047198bd7cc5059ca338f5c2147dd273f711))
    - Fix incorrect s/git-config/src-config/ ([`c51c8da`](https://github.com/GitoxideLabs/gitoxide/commit/c51c8daee1ab54130ae3ed83ce67d08f01c4881a))
    ...
    - Adapt to changes in `src-url` ([`f8fc662`](https://github.com/GitoxideLabs/gitoxide/commit/f8fc6625d8c22f43e7ab5f1cdf1e8eb9a6ea34de))
    ...
    - Make `src-pathspec` crate available ([`77da014`](https://github.com/GitoxideLabs/gitoxide/commit/77da01456118227a59b654f32c15eeb1e5e19cd9))
    ...
    - Adjust to changes in `src-validate` ([`a8bc0de`](https://github.com/GitoxideLabs/gitoxide/commit/a8bc0de6d071be82364434b6e27afecc02f3be51))
...
### New Features
 ...
 - <csr-id-4ee285741e6e1cde3a967980fbf48bab20ddbf68/> optionally make `src-workspace-stream` available via `Repository::worktree_stream()`
 ...
 * **Uncategorized**
    - Release src-config v0.26.1, src v0.50.0 ([`d34a4ea`](https://github.com/GitoxideLabs/gitoxide/commit/d34a4ea27cd83b916c84cf15e1c05da35576db5e))
    ...
    - Optionally make `src-workspace-stream` available via `Repository::worktree_stream()` ([`4ee2857`](https://github.com/GitoxideLabs/gitoxide/commit/4ee285741e6e1cde3a967980fbf48bab20ddbf68))
...
### New Features
 ...
 - <csr-id-980c2ba591dce7fc787c418aed85078c19e2d6d4/> Make `EntryMode` available from `src::object::tree`.
   Previously one had to go through `src::objs::tree` which wasn't symmetric
   with `src::object::Kind`.
 ...
 * **Uncategorized**
    ...
    - Make `EntryMode` available from `src::object::tree`. ([`980c2ba`](https://github.com/GitoxideLabs/gitoxide/commit/980c2ba591dce7fc787c418aed85078c19e2d6d4))
...
### Other
 ...
 - <csr-id-fb63f3f07f0f9545be5942bcb66b06040fbc7fe9/> Add incomplete mapping of typical `git2` functions and their counterpart in `src`.
   That way the ground-work is laid for making the usage of `src` easier for those who used
   `git2` before.
 ...
 * **Uncategorized**
    ...
    - Release src-lock v7.0.1, src v0.48.0 ([`5ce81ef`](https://github.com/GitoxideLabs/gitoxide/commit/5ce81ef16210f0b0b72dfd5710a064ccda96ac1c))
    ...
    - Add incomplete mapping of typical `git2` functions and their counterpart in `src`. ([`fb63f3f`](https://github.com/GitoxideLabs/gitoxide/commit/fb63f3f07f0f9545be5942bcb66b06040fbc7fe9))
    - Adapt to changes in `src-date` ([`fba45c6`](https://github.com/GitoxideLabs/gitoxide/commit/fba45c68d57d5f73070a6949556a04187d42e427))
 ...
 * **Uncategorized**
    ...
    - Adapt to changes in `src-protocol` ([`b785e81`](https://github.com/GitoxideLabs/gitoxide/commit/b785e811232d645ad72bfb87459efbd80cb0a399))
    - Adapt to changes in `src-traverse` ([`b447f47`](https://github.com/GitoxideLabs/gitoxide/commit/b447f478b8a5a28c659cef178b2a06b666f89ec3))
    - Adapt to changes in `src-actor` ([`4a80e86`](https://github.com/GitoxideLabs/gitoxide/commit/4a80e868f9530896616e649838e9be64b6d10036))
...
### Changed (BREAKING)
 ...
 - <csr-id-068603a4b7a52eaa397d61212e7aec5a0195ac29/> rename `Repository::commit_graph()` to `::revision_graph()`.
   THat's a better fix given its locaion in `src-revision`, while differentiating
...
### Other
 ...
 - <csr-id-f0ddc3b9c5a34b7930b965dfb1438f95279a8bde/> `src::revision::walk::Platform` now informas about the commitgraph.
...
### New Features
 ...
 - <csr-id-b2b88dc11d1b745e787596e9b94122238ccaf34c/> use the `commitgraph` if possible and allow its usage to be controlled via `revision::walk::Platform::use_commit_graph(toggle)`.
   ...
   without the extras provided by `src_revision::Graph`.
 ...
 * **Uncategorized**
    ...
    - `src::revision::walk::Platform` now informas about the commitgraph. ([`f0ddc3b`](https://github.com/GitoxideLabs/gitoxide/commit/f0ddc3b9c5a34b7930b965dfb1438f95279a8bde))
    - Update changelog with information for the `src` CLI. ([`4e081f2`](https://github.com/GitoxideLabs/gitoxide/commit/4e081f2141dcb9919597c53dfd5706cc9439d541))
    ...
    - Release src-protocol v0.33.1 ([`9c99ed3`](https://github.com/GitoxideLabs/gitoxide/commit/9c99ed30162081a7f26d72e0ed26966ff62d2b1c))
</details>
...
### Bug Fixes
 ...
 - <csr-id-9010f586ac46fcea5b8abba8f30a5639ed6b9225/> `src::env::fetch::collate::Error` now considers negotiation errors a sign of corrupt git repos.
 ...
 * **Uncategorized**
    ...
    - `src::env::fetch::collate::Error` now considers negotiation errors a sign of corrupt git repos. ([`9010f58`](https://github.com/GitoxideLabs/gitoxide/commit/9010f586ac46fcea5b8abba8f30a5639ed6b9225))
</details>
...
### New Features
 ...
 - <csr-id-af0ef2f36736e3805f769d8cd59c9fa7eb6a22a0/> use `src-negotiate` in fetch machinery.
...
### Refactor (BREAKING)
 ...
 - <csr-id-9689a08d00e9d54f6bb581660ee99077bd214cb4/> Move `Kind` into `repository::Kind`.
   This type was from old times where `src` was called `src-repository`.
 ...
 * **Uncategorized**
    ...
    - Use `src-negotiate` in fetch machinery. ([`af0ef2f`](https://github.com/GitoxideLabs/gitoxide/commit/af0ef2f36736e3805f769d8cd59c9fa7eb6a22a0))
    ...
    - Release src-discover v0.18.1, src-worktree v0.17.1, src-testtools v0.12.0 ([`f7b6c6f`](https://github.com/GitoxideLabs/gitoxide/commit/f7b6c6f27c090cbc584fbd3f5403da5ac1a9ff02))
    - Release src-index v0.16.1 ([`08c6f9d`](https://github.com/GitoxideLabs/gitoxide/commit/08c6f9de95c65ff05db4ce6a5593127c4280b2ef))
    - Release src-ref v0.29.1 ([`13e01f5`](https://github.com/GitoxideLabs/gitoxide/commit/13e01f5742ed2121f00f4b16c1df0cce5e7708ef))
    - Improve docs for `Shallow` ([`3d95bb7`](https://github.com/GitoxideLabs/gitoxide/commit/3d95bb76746a56b6e9060245f6c190c3836a0102))
</details>

## 0.44.1 (2023-04-27)

A maintenance release without user-facing changes. It's meant to fix breakage that occurred when publishing a breaking change in `src-path` by accident.
...
### New Features
 ...
 - <csr-id-40a1b7444ba9d9b61a1c22a7f25662eec3c25a1b/> add `index.threads` configuration to `src::config::tree`
...
### Bug Fixes
 ...
 - <csr-id-43f695a9607f1f85f859f2ef944b785b5b6dd238/> `src::open()` can handle bare repositories with index.
...
### New Features (BREAKING)
 ...
 - <csr-id-26e6a661ed5827151708b9fcc3d7468aa60cf4e3/> add `Repository::excludes()` and simplify signature of `Worktree::excludes()`.
   ...
   This corrects an artifact of this crate previously being name `src-repository` and brings
 ...
 - <csr-id-b645d28f9641c6b4022e1e37ad9fe528922ec747/> remove types that are now available in `src-os`
 ...
 * **Uncategorized**
    - Release src-worktree v0.16.0, src v0.44.0 ([`4527fb8`](https://github.com/GitoxideLabs/gitoxide/commit/4527fb8e0fe0786a70ccfd8c3f5c5e79e8867944))
    ...
    - Add `index.threads` configuration to `src::config::tree` ([`40a1b74`](https://github.com/GitoxideLabs/gitoxide/commit/40a1b7444ba9d9b61a1c22a7f25662eec3c25a1b))
    - Adjust to changes in `src-worktree` ([`f722d6b`](https://github.com/GitoxideLabs/gitoxide/commit/f722d6bebcd215b6e270261a3ed032a5f7e7b72f))
    ...
    - Adjust to changes in `src-worktree` ([`13a070f`](https://github.com/GitoxideLabs/gitoxide/commit/13a070f405230d52e4377e18f6bdc5c673b718a0))
    - Merge branch 'fix-823' ([`6ebd61e`](https://github.com/GitoxideLabs/gitoxide/commit/6ebd61e548a36a04e413ac725a03e607a3588334))
    - `src::open()` can handle bare repositories with index. ([`43f695a`](https://github.com/GitoxideLabs/gitoxide/commit/43f695a9607f1f85f859f2ef944b785b5b6dd238))
    ...
    - Remove types that are now available in `src-os` ([`b645d28`](https://github.com/GitoxideLabs/gitoxide/commit/b645d28f9641c6b4022e1e37ad9fe528922ec747))
...
### New Features
 ...
 - <csr-id-7c2e5c8d08e4dd1ec115ae06f20f9c8f93d6d616/> add `Tree::decode()` and `TryFrom<Tree> for src::objs::Tree`.
 ...
 * **Uncategorized**
    ...
    - Add `Tree::decode()` and `TryFrom<Tree> for src::objs::Tree`. ([`7c2e5c8`](https://github.com/GitoxideLabs/gitoxide/commit/7c2e5c8d08e4dd1ec115ae06f20f9c8f93d6d616))
    - Release src-ref v0.27.2 ([`e965b18`](https://github.com/GitoxideLabs/gitoxide/commit/e965b18aedcf13ec4538bc7bc700269a56ca615e))
...
### Other
 ...
 - <csr-id-87f5621d941b5af40abd59a26164a09d0dde2649/> make clear that `src::discover()` isn't suited for authentication remote operations.
 ...
 * **[#787](https://github.com/GitoxideLabs/gitoxide/issues/787)**
    - Make clear that `src::discover()` isn't suited for authentication remote operations. ([`87f5621`](https://github.com/GitoxideLabs/gitoxide/commit/87f5621d941b5af40abd59a26164a09d0dde2649))
 ...
 * **Uncategorized**
    ...
    - Adjust to changes in `src-packetline` ([`4f45814`](https://github.com/GitoxideLabs/gitoxide/commit/4f45814eea9c20b449effd9b29d31623943ff853))
...
- `src-credentials` allows credential helpers to ignore `stdin`, making it robust when facing helpers that don't read from `stdin`.
- `src-tempfile` refers to the most recent version of `tempfile` without pinning it, which removes a security vulnerability.
 ...
 * **Uncategorized**
    ...
    - Adjust to changes in `src-url` ([`66602bb`](https://github.com/GitoxideLabs/gitoxide/commit/66602bbb7fe62f7425c8289902a1d2fce121e87c))
</details>
...
### New Features
 ...
 - <csr-id-fd7eebcd922f98c1aed9e3177b9a48ff1415ffd8/> make `src-pack` feature toggles related to pack caches available.
   Previously they would have to be configured by pulling in `src-pack`, which
   isn't desirable as the only crate we want to expose like that is `src-features`.
...
### Bug Fixes
 ...
 - <csr-id-b2375e3dbe1f87ee3ac6e814fc8f4898143c438d/> `src-tempfile` is now configured to not use the high-performance hashmap anymore.
 ...
 * **Uncategorized**
    ...
    - `src-tempfile` is now configured to not use the high-performance hashmap anymore. ([`b2375e3`](https://github.com/GitoxideLabs/gitoxide/commit/b2375e3dbe1f87ee3ac6e814fc8f4898143c438d))
    ...
    - Make `src-pack` feature toggles related to pack caches available. ([`fd7eebc`](https://github.com/GitoxideLabs/gitoxide/commit/fd7eebcd922f98c1aed9e3177b9a48ff1415ffd8))
    ...
    - Adjust to changes in `src-tempfile` ([`c6785fc`](https://github.com/GitoxideLabs/gitoxide/commit/c6785fc7082b90c8a27cef6a0f5cc5acd8cb8951))
 ...
 * **Uncategorized**
    - Release src v0.36.1 ([`fac6bce`](https://github.com/GitoxideLabs/gitoxide/commit/fac6bce2f9942d7f333f66a92374d5400a00b0a5))
    ...
    - Release src-glob v0.5.4 ([`c56d336`](https://github.com/GitoxideLabs/gitoxide/commit/c56d3365fde21120cf6101cf34f8b5669804977c))
 ...
 * **Uncategorized**
    ...
    - Fix `src` changelog (find-replace issue) to indicate renaming from `git-repository` ([`f86b780`](https://github.com/GitoxideLabs/gitoxide/commit/f86b7803e85839450ed2eeef57fe738da1e3ec87))
...
This is the last release under this name and merely a notice to inform that `git-repository` from now on is `src`.

Furthermore, all `git-*` crates belonging to the `gitoxide` project will be renamed to `src-*`.

### Changed (BREAKING)

 - <csr-id-1408482fd21be7487b46753bb54a018c7a164f34/> a note of the pending rename of `git-repository` to `src`
 ...
 * **Uncategorized**
    - Release src v0.0.0 ([`8bce6d5`](https://github.com/GitoxideLabs/gitoxide/commit/8bce6d5cba12630bf4d12ed92f572a379d945329))
    - Add `src` crate to reserve name ([`5104a78`](https://github.com/GitoxideLabs/gitoxide/commit/5104a787127bf0b1f9b65f371b7c5b79f491e396))
</details>
...
### Bug Fixes
 ...
 - <csr-id-ec7bf71b60f8c1e7529d610557c0305d624c1253/> signature name and email resolution
   ...
   The solution is to use src_config::File::string() to lookup the name and
...
### New Features
 ...
 - <csr-id-1683a848459cae2b9182b365e3e22b0e8ba73534/> expose `src-features` crate at root under `features`.
...
### Bug Fixes
 ...
 - <csr-id-c6a690219915b2b401d2d11f61db35b2931e5b3a/> `src::Commit::describe()` chooses tag names (more) correctly.
...
### Changed (BREAKING)
 ...
 - <csr-id-4ee32713093c2e41a12d148c6030add1df6aa966/> new `DiffPlatform::counts()`, open `DiffPlatform` for use of `src-diff::blob::*`.
...
### New Features
 ...
 - <csr-id-d51e7c901fe5ed60d5dd56006c5faedb71cad537/> Add `permissions::Config::git_binary` field
   ...
   Note that we rely on the underlying `src-config` crate to not load
   duplicate files.
...
### Bug Fixes
 ...
 - Transitively through a kindly contributed fix in the `src-discover` crate, `Repository` can now be opened on `exFat` volumes.
...
### New Features
 ...
 - <csr-id-c28bcec19b5526acf888f928e6ddc4671873368e/> support avoiding usage of `fast-sha1` in src-features separately.
...
### Changed
 ...
 - <csr-id-0235111a4fcc40c7b57d973bfce27a66eddea901/> Invert behaviour to `open::Options::strict_config()`, with lenient being the default.
   This means API users will get libgit2 behaviour but commands like `src` can
...
### New Features
 ...
 - <csr-id-906c95845fa4aa2d4390c522bb566a188b8c0e78/> add `rev_spec::parse::ObjectKindHint` to support `core.disambiguate`.
   The latter is seemingly undocumented in the typical place, src-config.
...
### Changed (BREAKING)
 ...
 - <csr-id-4fd096840ba27da6ce86678a85ede33e3be974ff/> `src_revision` is now available in `revision::plumbing`.
...
### New Features
 ...
 - <csr-id-657080829867d9dcb0c9b9cb6c1c8126c4df3783/> `src-config` is now accessible in `git-repository::config`.
...
### New Features (BREAKING)
 ...
 - <csr-id-32dc1829a5661f66396d109c8d0a8eaae6b1f532/> use `src-credentials` in `src-protocol`
...
### Changed (BREAKING)
 ...
 - <csr-id-f9c0493460ab7c664aaa231ffcf7dfd56076c920/> use `src_odb::Find*` traits in prelude, instead of `src_pack::Find*`
   These are higher-level and generally more desirable.
   The Find traits in `src-pack` are more useful internally when packs
 ...
 - move src_pack::data::Object to src_object::Data, massively alter src_odb::Find trait
...
With changes to `src-ref`, what follows is all the adjustments made to simplify the `src` implementation.
...
### Changed (BREAKING)
 ...
 - <csr-id-95247322a8191edfa7fac9c5aa72b40239f3aa88/> move `src_ref::file::WriteRefLog` to `src_ref::store::WriteRefLog`
...
### Changed (BREAKING)
 ...
 - <csr-id-e8b091943f0c9a26317da0003f7fcdf5a56ef21a/> Rename src->ein and srcp->src
...
### New Features
 ...
 - <csr-id-11b64fce4630371633b6415f227eecdc6b42b20b/> Make `src_url::Url` available under `src::Url`
 ...
 - <csr-id-0ebfeb614264ca06ab763189e55e6c016c9997af/> Make `src_url::Url` available under `src::Url`
...
### Refactor
 ...
 - <csr-id-b209da29f361512ba757febf56bc1aca039f2a41/> use new src_pack::cache::Object trait
 - <csr-id-741558dd8194590c5cc8566aa22f96e73df38edf/> remove object cache impl which now lives in src-pack
