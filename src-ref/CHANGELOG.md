 ...
 * **Uncategorized**
    ...
    - Adapt to changes in `src-testtools` ([`fb60c8a`](https://github.com/GitoxideLabs/gitoxide/commit/fb60c8a69036b09cfa2ee9efdf36cd8705d0cbb5))
 ...
 * **Uncategorized**
    ...
    - Merge pull request #2390 from GitoxideLabs/src-error ([`fa85ed3`](https://github.com/GitoxideLabs/gitoxide/commit/fa85ed3b4af978b30276345d0bb8b6237adbb2d2))
    ...
    - Merge pull request #2389 from GitoxideLabs/src-error ([`dfeefe2`](https://github.com/GitoxideLabs/gitoxide/commit/dfeefe279c913e97ad6da677f7528db3c7eb57e2))
    - Adapt to changes in `src-ref` ([`931c69b`](https://github.com/GitoxideLabs/gitoxide/commit/931c69bf0fe53bbfe67a79f38ae5c54a4c02feb7))
 ...
 * **Uncategorized**
    ...
    - Update changelogs prior to `src-ref` release ([`5315180`](https://github.com/GitoxideLabs/gitoxide/commit/53151807ec82ce3fbe1838c0885a4f9b71b82f23))
    ...
    - Bump src-ref rust version to 1.74 for `std::io::Error::other` support. ([`88dc1c2`](https://github.com/GitoxideLabs/gitoxide/commit/88dc1c238c6b858f2ed32dae1dfab4f34a364f6d))
...
### Other
 ...
 - <csr-id-65f69f72a8a08b3b2462362ec10d1748be48019b/> Fix some broken links to commit/blob URLs
   ...
   current `src-*` names, URLs were updated, but some of these were
 ...
 * **Uncategorized**
    ...
    - Adapt to changes in `src-validate` ([`b9cf0f4`](https://github.com/GitoxideLabs/gitoxide/commit/b9cf0f4c3e8f2c2785f22693df82b7331cdddd66))
...
### Other
 ...
 - <csr-id-ec1d6b44d7f65ded8ea34914350e723275121776/> src-date is test only dep
 ...
 * **Uncategorized**
    ...
    - Fuzz more of src-ref log ([`d83b4e0`](https://github.com/GitoxideLabs/gitoxide/commit/d83b4e0b16ba7cf28145184d76cef5f89143f641))
    ...
    - Add log fuzzer to src-ref ([`3be3b15`](https://github.com/GitoxideLabs/gitoxide/commit/3be3b15c6487b4fca3f0609ff04aad9cac226eba))
    - Add named fuzz-harness to src-ref ([`3e37a22`](https://github.com/GitoxideLabs/gitoxide/commit/3e37a221cf1d50404874f448cbe5ab264108f7db))
...
### Changed (BREAKING)
 ...
 - <csr-id-dbb68867f882b905fc6584d78cabfa0342039565/> use `src-object::Find` trait
 ...
 * **Uncategorized**
    ...
    - Use `src-object::Find` trait ([`dbb6886`](https://github.com/GitoxideLabs/gitoxide/commit/dbb68867f882b905fc6584d78cabfa0342039565))
 ...
 * **Uncategorized**
    ...
    - Cleanup src-ref-tests ([`e0c64fd`](https://github.com/GitoxideLabs/gitoxide/commit/e0c64fd7db3562aa810b83105afb32168ab479c1))
 ...
 * **Uncategorized**
    ...
    - Adapt to changes in `src-tempfile` ([`bfcd1e3`](https://github.com/GitoxideLabs/gitoxide/commit/bfcd1e3a8f2d05d0d6d1f5cf06d369ac9e6e4cdf))
 ...
 * **Uncategorized**
    ...
    - Rename `git-ref` to `src-ref` ([`a56e628`](https://github.com/GitoxideLabs/gitoxide/commit/a56e6281d8a3e26a36dc63bb84ede7f6ecf9fddc))
...
### Changed (BREAKING)
 ...
 - <csr-id-3d6299f47f41397c1c72035a86b94d1c263b5b98/> `Transaction::commit(…)` takes `src-actor::SignatureRef` instead of `…::Signature`.
   This makes the API more versatile and corrects a shortcoming that was
   caused by `SignatureRef` previously being unable to serialize itself.
 - <csr-id-f1dbb6bd4534527b6f1f2aba2a562dd4e64cf55d/> remove `FullName::to_ref()` in favor of `•::as_ref()`.
   This became possible now that `FullNameRef` is a proper ref, not just
...
### Changed (BREAKING)
 ...
 - <csr-id-80f3d504eeb669f16c5621fac06f6c763ce84e47/> file::Store::from(PathBuf) removed
   At this low level, it's important to be clear about RefLogs and rather
   force the caller to specify the ref-log mode. Technically it depends
   on a few factors, `src` deals with them, but certainly
   shouldn't default to anything without being clear.
 - <csr-id-bfb32aee4e64fd6b1f18c830623cc3fddd059874/> Reference log line access
...
as `src-traverse` is signalling a breaking change.
