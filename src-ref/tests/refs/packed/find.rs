...
c4cebba92af964f2d126be90b8a6298c4cf84d45 refs/tags/src-actor-v0.1.0
^13da90b54699a6b500ec5cd7d175f2cd5a1bed06
0b92c8a256ae06c189e3b9c30b646d62ac8f7d10 refs/tags/src-actor-v0.1.1\n";
    ...
    let name = "refs/tags/src-actor-v0.1.0";
    assert_eq!(
        buf.try_find(name)?.expect("reference exists"),
        packed::Reference {
            name: name.try_into()?,
    ...
    let name = "refs/tags/src-actor-v0.1.1";
    assert_eq!(
        buf.try_find(name)?.expect("reference exists"),
        packed::Reference {
            name: name.try_into()?,
...
916840c0e2f67d370291042cb5274a597f4fa9bc refs/tags/TEST-0.0.1
bogus refs/tags/src-actor-v0.1.0
^13da90b54699a6b500ec5cd7d175f2cd5a1bed06
0b92c8a256ae06c189e3b9c30b646d62ac8f7d10 refs/tags/src-actor-v0.1.1\n";
    ...
    for failing_name in &["refs/tags/TEST-0.0.1", "refs/tags/src-actor-v0.1.0"] {
        assert_eq!(
