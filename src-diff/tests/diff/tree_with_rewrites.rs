...
fn realistic_renames_disabled_2() -> crate::Result {
    ...
    [
        ...
        Addition {
            location: "src-sec/src/identity.rs",
            relation: Some(
                ChildOfParent(
                    2,
                ),
        ...
        Addition {
            location: "src-sec/src/permission.rs",
            relation: Some(
                ChildOfParent(
                    2,
                ),
        ...
        Addition {
            location: "src-sec/tests/identity/mod.rs",
            relation: Some(
                ChildOfParent(
                    2,
                ),
...
deleted file mode 100644
index e69de29..0000000
diff --git a/src-sec/CHANGELOG.md b/src-sec/CHANGELOG.md
new file mode 100644
index 0000000..e69de29
diff --git a/src-sec/Cargo.toml b/src-sec/Cargo.toml
new file mode 100644
index 0000000..e69de29
diff --git a/src-sec/src/identity.rs b/src-sec/src/identity.rs
new file mode 100644
index 0000000..e69de29
diff --git a/src-sec/src/lib.rs b/src-sec/src/lib.rs
new file mode 100644
index 0000000..e69de29
diff --git a/src-sec/src/permission.rs b/src-sec/src/permission.rs
new file mode 100644
index 0000000..e69de29
diff --git a/src-sec/src/trust.rs b/src-sec/src/trust.rs
new file mode 100644
index 0000000..e69de29
diff --git a/src-sec/tests/identity/mod.rs b/src-sec/tests/identity/mod.rs
new file mode 100644
index 0000000..e69de29
diff --git a/src-sec/tests/sec.rs b/src-sec/tests/sec.rs
new file mode 100644
index 0000000..e69de29
"#;
        assert_eq!(
...
new file mode 100644
index 0000000..e69de29
diff --git a/src/src.rs b/src/src.rs
new file mode 100644
index 0000000..e69de29
...
diff --git a/src/porcelain-cli.rs b/src/src.rs
similarity index 100%
rename from src/porcelain-cli.rs
rename to src/src.rs
"#;
        assert_eq!(
...
diff --git a/git-sec/CHANGELOG.md b/src-sec/CHANGELOG.md
similarity index 100%
rename from git-sec/CHANGELOG.md
rename to src-sec/CHANGELOG.md
diff --git a/git-sec/Cargo.toml b/src-sec/Cargo.toml
similarity index 100%
rename from git-sec/Cargo.toml
rename to src-sec/Cargo.toml
diff --git a/git-sec/src/identity.rs b/src-sec/src/identity.rs
similarity index 100%
rename from git-sec/src/identity.rs
rename to src-sec/src/identity.rs
diff --git a/git-sec/src/lib.rs b/src-sec/src/lib.rs
similarity index 100%
rename from git-sec/src/lib.rs
rename to src-sec/src/lib.rs
diff --git a/git-sec/src/permission.rs b/src-sec/src/permission.rs
similarity index 100%
rename from git-sec/src/permission.rs
rename to src-sec/src/permission.rs
diff --git a/git-sec/src/trust.rs b/src-sec/src/trust.rs
similarity index 100%
rename from git-sec/src/trust.rs
rename to src-sec/src/trust.rs
diff --git a/git-sec/tests/identity/mod.rs b/src-sec/tests/identity/mod.rs
similarity index 100%
rename from git-sec/tests/identity/mod.rs
rename to src-sec/tests/identity/mod.rs
diff --git a/git-sec/tests/sec.rs b/src-sec/tests/sec.rs
similarity index 100%
rename from git-sec/tests/sec.rs
rename to src-sec/tests/sec.rs
"#;
        assert_eq!(
