 ...
 * **Uncategorized**
    ...
    - Add script to generate test-cases for `src-diff` to validate that diff-algorithms match (diff-slider problem) ([`94dac4b`](https://github.com/GitoxideLabs/gitoxide/commit/94dac4bfe89c2e4e53fe3f0963ab1a345e71ed37))
...
### New Features
 ...
 - <csr-id-f2e813d8712f245f7f93ecae2a3da768dd6dc2db/> provide facilities to perform rewrite-tracking for tree-diffs in plumbing.
   This effectively pulls down a higher-level implementation in `src` to the plumbing
 ...
 * **Uncategorized**
    ...
    - Fix dependency declaration of `src-tempfile` in `src-diff` ([`0afe927`](https://github.com/GitoxideLabs/gitoxide/commit/0afe927be49d3f44503534c2a0bdffcf133dd5aa))
...
### Changed (BREAKING)
 ...
 - <csr-id-2637f8f7b169b3e0d925eee0c52c5cdb974f7411/> use `src-object::Find` trait
 ...
 * **Uncategorized**
    ...
    - Use `src-object::Find` trait ([`2637f8f`](https://github.com/GitoxideLabs/gitoxide/commit/2637f8f7b169b3e0d925eee0c52c5cdb974f7411))
 ...
 * **Uncategorized**
    ...
    - Rename `git-diff` to `src-diff` ([`95cce04`](https://github.com/GitoxideLabs/gitoxide/commit/95cce049a31e2f3cf57fa24ca7d17074eed294ec))
