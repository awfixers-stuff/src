...
//!
//! The application is supposed to explicitly turn on tracing via `src-features`.
//! Crates that use `src-features` should use `gix_features::trace`, and those who don't can use `gix_trace` directly.
//! ## Feature Flags
#![cfg_attr(
