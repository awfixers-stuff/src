 ...
 * **Uncategorized**
    ...
    - Switch to imara-diff 0.2 in src-blame ([`90b4769`](https://github.com/GitoxideLabs/gitoxide/commit/90b4769f0716f37f9c8351d4f3f7209e223976f2))
 ...
 * **Uncategorized**
    ...
    - Merge pull request #2287 from cruessler/update-to-imara-diff-0-2-in-src-blame ([`691a205`](https://github.com/GitoxideLabs/gitoxide/commit/691a2057966621a27062f05934dfe4b0dee11791))
    ...
    - Add feature flag `blob-experimental` to `src-blame` ([`ed9c437`](https://github.com/GitoxideLabs/gitoxide/commit/ed9c43753dfbff421c6b267264ae7f4cc3439b46))
    - Update `src-blame` to `imara-diff` 0.2 ([`2c88262`](https://github.com/GitoxideLabs/gitoxide/commit/2c88262a255d3afa14a49bfe73363aae2f4be60d))
</details>
 ...
 * **Uncategorized**
    ...
    - Reduce noise in `src-blame` tests ([`58cb884`](https://github.com/GitoxideLabs/gitoxide/commit/58cb884605c5e2b59fd8c83df0238bff719c7d00))
    ...
    - Reduce noise in `src-blame` tests ([`4ad2be8`](https://github.com/GitoxideLabs/gitoxide/commit/4ad2be804366ff62716ab57bd4a644131f3dc8db))
 ...
 * **Uncategorized**
    ...
    - Remove most .unwrap()'s in src-blame tests ([`4bf61f5`](https://github.com/GitoxideLabs/gitoxide/commit/4bf61f5671b097b82605009ad0dfc48de428ff18))
 ...
 * **Uncategorized**
    ...
    - Modularlize `src-blame/lib.rs` ([`26bfd2d`](https://github.com/GitoxideLabs/gitoxide/commit/26bfd2d73374e134aff24410fac44857b8128244))
    ...
    - Add initial implementation and tests for `src-blame`. ([`d27adf7`](https://github.com/GitoxideLabs/gitoxide/commit/d27adf70b4e2f57d8431a0a553119322d7158f4b))
    ...
    - Merge branch 'src-blame' ([`e6fbea9`](https://github.com/GitoxideLabs/gitoxide/commit/e6fbea9be2ef7ab4064dc57c8233dfe81fac3bb4))
    - Add sample fixture ([`6d71e0d`](https://github.com/GitoxideLabs/gitoxide/commit/6d71e0d291f2a3b11c635949712ec86cf57d7449))
    - Add new `src-blame` crate ([`f5f616d`](https://github.com/GitoxideLabs/gitoxide/commit/f5f616d8345898effc79d587c139e249f1c85ab6))
</details>
