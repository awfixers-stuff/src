 ...
 * **[#2328](https://github.com/GitoxideLabs/gitoxide/issues/2328)**
    - Update changelogs prior to `src-transport` release ([`ae8c9d3`](https://github.com/GitoxideLabs/gitoxide/commit/ae8c9d3ff56a38f2cd92c6f5afa9e93434939fe0))
 * **Uncategorized**
...
### Bug Fixes
 ...
 - <csr-id-9de190ee76a8f0af2bd7a40d09719c2b09a37a24/> forward serde feature to bstr in src-transport
...
### Bug Fixes (BREAKING)
 ...
 - <csr-id-f2c6a19f676f1de9e0b4e0ff77f4e26d817fac7e/> make `src-packeline` features additive.
 ...
 * **Uncategorized**
    ...
    - Forward serde feature to bstr in src-transport ([`9de190e`](https://github.com/GitoxideLabs/gitoxide/commit/9de190ee76a8f0af2bd7a40d09719c2b09a37a24))
    ...
    - Make `src-packeline` features additive. ([`f2c6a19`](https://github.com/GitoxideLabs/gitoxide/commit/f2c6a19f676f1de9e0b4e0ff77f4e26d817fac7e))
 ...
 * **Uncategorized**
    ...
    - Adapt to changes in `src-sec` ([`6880175`](https://github.com/GitoxideLabs/gitoxide/commit/6880175ab1bb70af39d18919cb8bfdc1df32b46f))
...
### Bug Fixes
 ...
 - <csr-id-a445b72fcdbb52e2f2ef0b240e41152fa92292f9/> Honor `disallow_shell` in SSH client feature check
   ...
   prevailing style for achieving this elsewhere in `src-transport`.
 ...
 * **Uncategorized**
    ...
    - Adapt to changes in `src-command` ([`28f712e`](https://github.com/GitoxideLabs/gitoxide/commit/28f712e97ebd805cbcffe184203c9089248b0ca8))
 ...
 * **Uncategorized**
    ...
    - Refactor `src-transport` with minor edits to comments ([`996310b`](https://github.com/GitoxideLabs/gitoxide/commit/996310ba1408fe746c6de43cb24dc1e809fd4d57))
...
YANKED: This version requires that the used `src` crate is also uses the most recently published `src v0.61.1`, or else
...
Further, it will definitely not be working correctly when compiled with `src v0.60.0`, which would also pull this release
 ...
 * **Uncategorized**
    ...
    - Adapt to changes in features of `src-pack` ([`6b27ffa`](https://github.com/GitoxideLabs/gitoxide/commit/6b27ffa18f0049321e7c1837acc5467f0966fbb5))
 ...
 * **Uncategorized**
    ...
    - Align `src-sec` version across all crates ([`7f80ab6`](https://github.com/GitoxideLabs/gitoxide/commit/7f80ab66fb779b7858975b471cae8c592a3c0c67))
</details>
 ...
 * **Uncategorized**
    ...
    - Release src-packetline v0.16.1 ([`d70ce9f`](https://github.com/GitoxideLabs/gitoxide/commit/d70ce9f822541fdaebb2eb1815929676e6af8648))
...
<csr-id-5220f9a59fb699e111342b076145a6899d36d433/>
 ...
 - <csr-id-85c33825678bddde5a3fe409bbb1ff5cecd3a0fc/> Place port for PuTTY and derivates in separate argument
   ...
   argument
 - <csr-id-6ba799c9d6b17ed665d3c352c3c4bb35c9f771bb/> `src clone ssh://...` won't deadlock anymore.
 ...
 * **Uncategorized**
    ...
    - Rename `git-transport` to `src-transport` ([`8c353ea`](https://github.com/GitoxideLabs/gitoxide/commit/8c353ea00c805604113a567d2f5157be94cc9f28))
    ...
    - Adjust to renamining of `git-tui` to `src-tui` ([`8782262`](https://github.com/GitoxideLabs/gitoxide/commit/878226282500993e755cdf99bf0076f91130e0cd))
    ...
    - `src clone ssh://...` won't deadlock anymore. ([`6ba799c`](https://github.com/GitoxideLabs/gitoxide/commit/6ba799c9d6b17ed665d3c352c3c4bb35c9f771bb))
    ...
    - Merge branch 'main' into src-clone ([`64f81d7`](https://github.com/GitoxideLabs/gitoxide/commit/64f81d78ae75a0e5914f431bbdc385a6d40f8835))
...
* `src-traverse` saw a breaking change moving to v0.9, which triggered this crate to signal a breaking change, too.

### Improvements

* `src-packetline` is now publicly re-exported as `packetline`.
