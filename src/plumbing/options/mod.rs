...
#[clap(name = "src", about = "The git underworld", version = option_env!("src_VERSION"))]
...
pub struct Args {
    ...
    #[clap(long, default_value_t = src::hash::Kind::default(), value_parser = crate::shared::AsHashKind)]
    pub object_hash: src::hash::Kind,
...
pub mod status {
    ...
    pub enum Ignored {
        ...
        //       to be fully expanded. This should probably be implemented in `src_dir` which then simply works by not
...
pub mod merge {
    ...
    impl From<ResolveWith> for src::merge::blob::builtin_driver::text::Conflict {
        fn from(value: ResolveWith) -> Self {
            match value {
                ResolveWith::Union => src::merge::blob::builtin_driver::text::Conflict::ResolveWithUnion,
                ResolveWith::Ours => src::merge::blob::builtin_driver::text::Conflict::ResolveWithOurs,
                ResolveWith::Theirs => src::merge::blob::builtin_driver::text::Conflict::ResolveWithTheirs,
            }
        }
    }
    ...
    impl From<FileFavor> for src::merge::tree::FileFavor {
        fn from(value: FileFavor) -> Self {
            match value {
                FileFavor::Ours => src::merge::tree::FileFavor::Ours,
                FileFavor::Theirs => src::merge::tree::FileFavor::Theirs,
            }
        }
    }

    impl From<TreeFavor> for src::merge::tree::TreeFavor {
        fn from(value: TreeFavor) -> Self {
            match value {
                TreeFavor::Ancestor => src::merge::tree::TreeFavor::Ancestor,
                TreeFavor::Ours => src::merge::tree::TreeFavor::Ours,
            }
        }
    }
...
pub mod fetch {
    ...
    pub struct Platform {
        ...
        #[clap(value_parser = crate::shared::AsBString)]
        pub ref_spec: Vec<src::bstr::BString>,
    }
    ...
    pub struct ShallowOptions {
        ...
        pub shallow_since: Option<src::date::Time>,
        ...
        pub shallow_exclude: Vec<src::refs::PartialName>,
...
pub mod clone {
    ...
    pub struct Platform {
        ...
        pub ref_name: Option<src::refs::PartialName>,
