//! This is the documentation of the binaries that come with `gitoxide`. These are called `src` and `ein`.
//!
//! #### `src`
//!
...
//! the `src` crate is unstable and is explicitly not to be understood as `git` replacement.
//!
//! #### `ein`
//!
...
pub mod plumbing;
pub mod porcelain;
/// everything in common between the `src` and `ein` binaries.
pub mod shared;
