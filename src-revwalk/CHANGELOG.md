...
### Changed (BREAKING)
 ...
 - <csr-id-36f70dcb378bff488dc65f0b354c74341b142e7e/> use `src-object::Find` trait
...
### Changed (BREAKING)
 ...
 - <csr-id-f4b0195375db31cc2736fcab9665a0dc2637e74b/> Remove custom `graph::CommitterTimestamp` in favor of `src-date::SecondsSinceUnixEpoch`.
 ...
 * **Uncategorized**
    ...
    - Remove custom `graph::CommitterTimestamp` in favor of `src-date::SecondsSinceUnixEpoch`. ([`f4b0195`](https://github.com/GitoxideLabs/gitoxide/commit/f4b0195375db31cc2736fcab9665a0dc2637e74b))
