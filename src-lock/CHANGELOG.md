 ...
 * **Uncategorized**
    ...
    - Adapt to changes in `src-utils` ([`bf4fa1b`](https://github.com/GitoxideLabs/gitoxide/commit/bf4fa1b5e4a59399284dce4da51943f034e8023c))
 ...
 * **Uncategorized**
    ...
    - Unify `src-utils` version... ([`6b6eaf9`](https://github.com/GitoxideLabs/gitoxide/commit/6b6eaf9401d78684350a8eb0ec337fda7a5ae19b))
</details>
 ...
 * **Uncategorized**
    ...
    - Rename `git-lock` to `src-lock` ([`0422433`](https://github.com/GitoxideLabs/gitoxide/commit/04224336b910fbcb8c32ef61edb345c53e945425))
...
### New Features
 ...
 - <csr-id-a789490fbbba1f44d79d57c8ba74bf40c600faf2/> export src-tempfile in the root
   This allows access to signal handler setup for example, which can be
   useful in some situations.
...
A maintenance release due to mildly breaking changes in `src-tempfile`.
