 ...
 * **Uncategorized**
    ...
    - Merge pull request #2420 from cruessler/remove-imara-diff-0-1-in-src-blame ([`28fbeb8`](https://github.com/GitoxideLabs/gitoxide/commit/28fbeb86a9b82b3eb69b6e3618e286b2507204eb))
    ...
    - Adapt to changes in `src` ([`e6f62be`](https://github.com/GitoxideLabs/gitoxide/commit/e6f62be69d95104ab5d277874eda6b32c409bb8b))
...
### New Features
 ...
 - <csr-id-461c87667c75a9db0a74c43ef68d71b88a7dd754/> Add an `auto-chain-error` feature to let `src-error::Error` produce error chains suitable for `anyhow`.
 - <csr-id-053c3ee2217480eead3aa7c71fa4b65455444921/> anyhow support for `src-error::Exn`
 ...
 * **Uncategorized**
    ...
    - Merge pull request #2383 from GitoxideLabs/src-error ([`9d39656`](https://github.com/GitoxideLabs/gitoxide/commit/9d39656710c297f9a22e4a7e6facc3a1f35f89e0))
    - Adapt to changes in `src-error` ([`00c053c`](https://github.com/GitoxideLabs/gitoxide/commit/00c053cbc50b61d5168bc56e7808e5229ee5fe8d))
    - Add an `auto-chain-error` feature to let `src-error::Error` produce error chains suitable for `anyhow`. ([`461c876`](https://github.com/GitoxideLabs/gitoxide/commit/461c87667c75a9db0a74c43ef68d71b88a7dd754))
    - Anyhow support for `src-error::Exn` ([`053c3ee`](https://github.com/GitoxideLabs/gitoxide/commit/053c3ee2217480eead3aa7c71fa4b65455444921))
    ...
    - Adapt to changes in `src-commitgraph` ([`1f58905`](https://github.com/GitoxideLabs/gitoxide/commit/1f589054aad9b75f2c167a336acec9d297411564))
    ...
    - Release src-command v0.6.4, src-credentials v0.34.1, src-transport v0.52.1 ([`3bc0c47`](https://github.com/GitoxideLabs/gitoxide/commit/3bc0c472a8395e9634dd602839e208501f841c11))
 ...
 * **Uncategorized**
    ...
    - Add feature flag `blame-experimental` to `src` ([`826effb`](https://github.com/GitoxideLabs/gitoxide/commit/826effb563e369f57b22a8418be2e9ea58fc4844))
 ...
 * **Uncategorized**
    ...
    - Merge pull request #2277 from GitoxideLabs/dependabot/cargo/cargo-83105039d9 ([`f8435ea`](https://github.com/GitoxideLabs/gitoxide/commit/f8435ea4d12ea453ec750ce003ee70a040836feb))
    - Bump the cargo group with 7 updates ([`6bf895c`](https://github.com/GitoxideLabs/gitoxide/commit/6bf895c586bb557763c2335a48e56521b163a513))
...
### New Features
 ...
 - <csr-id-924cd62f7ef74f479114c80cee0db0ba5f522579/> allow credential fill with `src credential fill` to run without a repo
...
### Bug Fixes (BREAKING)
 ...
 - <csr-id-c2050d0ec74e2c2d1d70b68e57bbb79e196796b9/> make src-transport I/O mode features additive

### Refactor (BREAKING)

 - <csr-id-36c2be80e61a7a0ef637a5385e1960de13261984/> simplify src-protocol handshake API by avoiding duplicates that remove the `server` parameter.
 ...
 * **[#2198](https://github.com/GitoxideLabs/gitoxide/issues/2198)**
    - Allow credential fill with `src credential fill` to run without a repo ([`924cd62`](https://github.com/GitoxideLabs/gitoxide/commit/924cd62f7ef74f479114c80cee0db0ba5f522579))
 * **Uncategorized**
    ...
    - Fix dead code warnings in src and gitoxide-core ([`b170451`](https://github.com/GitoxideLabs/gitoxide/commit/b170451e6404d4837ab214605375b067479a1542))
    ...
    - Refactor ([`41b4a8f`](https://github.com/GitoxideLabs/gitoxide/commit/41b4a8f74a2310d5c8c02918dc6e842e33eac0e5))
    ...
    - Simplify src-protocol handshake API by avoiding duplicates that remove the `server` parameter. ([`36c2be8`](https://github.com/GitoxideLabs/gitoxide/commit/36c2be80e61a7a0ef637a5385e1960de13261984))
    ...
    - Adapt to changes in `src-date` ([`2bcac0c`](https://github.com/GitoxideLabs/gitoxide/commit/2bcac0c1115e77c5e20692e7cf0dcb1bbb87149c))
    ...
    - Adapt to changes in `src-date` ([`d5e194d`](https://github.com/GitoxideLabs/gitoxide/commit/d5e194d0ab0e58b02d159b4f48c4e2edd946f355))
    ...
    - Make src-transport I/O mode features additive ([`c2050d0`](https://github.com/GitoxideLabs/gitoxide/commit/c2050d0ec74e2c2d1d70b68e57bbb79e196796b9))
...
### New Features
 ...
 - <csr-id-aacc326a198e4c78dd546018eebaff192ff5223d/> add a `src commit sign` prototype
 - <csr-id-58b5060958e0090773bb15ffb3679d99704b70a0/> add first debug version of `src branch list`
 ...
 * **Uncategorized**
    ...
    - Add a `src commit sign` prototype ([`aacc326`](https://github.com/GitoxideLabs/gitoxide/commit/aacc326a198e4c78dd546018eebaff192ff5223d))
    ...
    - Thanks clippy ([`0b2ffed`](https://github.com/GitoxideLabs/gitoxide/commit/0b2ffede177c6c826d3bca294d1edc937bb9b593))
    ...
    - Keep showing debug representation of paths in gitoxide-core ([`6f19267`](https://github.com/GitoxideLabs/gitoxide/commit/6f19267a030d4484818dcd0ebe032aeae973e08e))
    - Thanks clippy ([`f4c37c0`](https://github.com/GitoxideLabs/gitoxide/commit/f4c37c00036b0a14d7d2aba633206e208ca0a32f))
    ...
    - Adapt to changes in `src` ([`1536fd8`](https://github.com/GitoxideLabs/gitoxide/commit/1536fd8651fa9477a17da62e442191ac100e396e))
    ...
    - Merge pull request #2144 from GitoxideLabs/dependabot/cargo/cargo-2dc5bac7e8 ([`cd148cf`](https://github.com/GitoxideLabs/gitoxide/commit/cd148cf8e6551d7127c4b15bba894c9e0a36fe43))
    - Bump tracing-subscriber from 0.3.19 to 0.3.20 in the cargo group ([`2e25488`](https://github.com/GitoxideLabs/gitoxide/commit/2e254889ff0a79ff82b8cf6f7ae2063092820692))
    ...
    - Add first debug version of `src branch list` ([`58b5060`](https://github.com/GitoxideLabs/gitoxide/commit/58b5060958e0090773bb15ffb3679d99704b70a0))
    ...
    - Adapt to changes in `src-status` ([`5da38e5`](https://github.com/GitoxideLabs/gitoxide/commit/5da38e5a473979965b622869c4676f0f21bed58b))
    ...
    - Remove unused struct. ([`191067e`](https://github.com/GitoxideLabs/gitoxide/commit/191067ea5781f1f92b4ef3bc710832cb9391be4f))
    ...
    - Merge pull request #2086 from cruessler/add-default-sorting-to-tag-list ([`1bccbfe`](https://github.com/GitoxideLabs/gitoxide/commit/1bccbfe8464fdbc1ea6cb4bb87096ea18686e8c1))
    - Refactor ([`2961f60`](https://github.com/GitoxideLabs/gitoxide/commit/2961f602d1bf7de00634fb6915e81d7e0a922e5d))
    - Sort tags as versions by default ([`7d619bb`](https://github.com/GitoxideLabs/gitoxide/commit/7d619bb616443c366129b9c1076b04ca8a5db35a))
...
### New Features
 ...
 - <csr-id-37d3bf24ac1a79302f3e97b97372e4ad381c45e2/> add first debug version of `src tag list`
 - <csr-id-ab52a49a555ab25e6cf632cb0b080eab72958a7d/> `src revision list --long-hashes` for faster iteration.
...
### Bug Fixes
 ...
 - <csr-id-a8b5751369234b29199f035b98d4fb36183fced7/> `src submodule list` now prints the submodule path in debug mode
 ...
 * **Uncategorized**
    ...
    - `src submodule list` now prints the submodule path in debug mode ([`a8b5751`](https://github.com/GitoxideLabs/gitoxide/commit/a8b5751369234b29199f035b98d4fb36183fced7))
    ...
    - Add first debug version of `src tag list` ([`37d3bf2`](https://github.com/GitoxideLabs/gitoxide/commit/37d3bf24ac1a79302f3e97b97372e4ad381c45e2))
    ...
    - `src revision list --long-hashes` for faster iteration. ([`ab52a49`](https://github.com/GitoxideLabs/gitoxide/commit/ab52a49a555ab25e6cf632cb0b080eab72958a7d))
    ...
    - Adapt to changes in `src-blame` ([`f899d6d`](https://github.com/GitoxideLabs/gitoxide/commit/f899d6d533b6fb0d1ce5d08d0ec6c38df294398a))
    ...
    - Adapt to changes in `src-ignore` and `src-glob`, and more. ([`4ef7806`](https://github.com/GitoxideLabs/gitoxide/commit/4ef7806e62954d069861bddb06cb8c0baf47bb69))
    ...
    - Release src-glob v0.20.1, src-attributes v0.26.1, src-command v0.6.1, src-filter v0.19.2, src-worktree-stream v0.21.2, src-archive v0.21.2 ([`f0ed2cc`](https://github.com/GitoxideLabs/gitoxide/commit/f0ed2cc0046f866e67944bff9aef0579c12d5852))
...
### Bug Fixes
 ...
 - <csr-id-b07f907ba2e01849744c72df35dac57b624f2f85/> Adapt to changes in src-actor
 ...
 - <csr-id-77a3a1b85521ec87495a73151dd422e2cde49f99/> Use less ambiguous "kB" for SI kilobyte
   `src free pack verify --statistics` formerly used "KB" for
 ...
 * **Uncategorized**
    ...
    - Adapt to changes in `src-date` and `src-actor` ([`afdf1a5`](https://github.com/GitoxideLabs/gitoxide/commit/afdf1a5d5c9fb2645f481c17f580ad59d14d6095))
    ...
    - Adapt to changes in src-actor ([`b07f907`](https://github.com/GitoxideLabs/gitoxide/commit/b07f907ba2e01849744c72df35dac57b624f2f85))
    ...
    - Adapt to changes in src-object ([`8969245`](https://github.com/GitoxideLabs/gitoxide/commit/8969245a6b5874d8524f508569ae1266e48d100e))
...
### New Features
 ...
 - <csr-id-448fa5864909f79cb6815cb57db8e07c6cadcb68/> support bare paths in `src diff file`
 - <csr-id-76b7ec6951ba1b3829903ecbba2ddde836afbc20/> use ToGitUnlessBinaryToTextIsPresent
 - <csr-id-dbb15328d7b26aaa51ceadcd5a8cb021155023b3/> add first 'debug' version of `src diff file`
 ...
 * **Uncategorized**
    ...
    - Merge pull request #1902 from cruessler/make-src-diff-file-accept-bare-path ([`40d8033`](https://github.com/GitoxideLabs/gitoxide/commit/40d8033ed90427fc868933c3eff2a63ad5224f85))
    - Fix windows build ([`46f2e14`](https://github.com/GitoxideLabs/gitoxide/commit/46f2e14fe719dbacc97dc5d4d59a725694679089))
    - Support bare paths in `src diff file` ([`448fa58`](https://github.com/GitoxideLabs/gitoxide/commit/448fa5864909f79cb6815cb57db8e07c6cadcb68))
    - Merge pull request #1880 from cruessler/add-src-diff-file ([`b10cc6f`](https://github.com/GitoxideLabs/gitoxide/commit/b10cc6f0f2c3757677d9fdb3c01196d371ac6631))
    ...
    - Add first 'debug' version of `src diff file` ([`dbb1532`](https://github.com/GitoxideLabs/gitoxide/commit/dbb15328d7b26aaa51ceadcd5a8cb021155023b3))
    ...
    - Adapt to changes in `src-blame` ([`e7084d8`](https://github.com/GitoxideLabs/gitoxide/commit/e7084d8db829bbc33aea958a997deb1db4b5a453))
    - Adapt to changes in `src` ([`abb53fb`](https://github.com/GitoxideLabs/gitoxide/commit/abb53fb236d0aa92905a9d54d4193cc7c89f341c))
    ...
    - Adapt to changes in `src-blame` ([`fd63dd6`](https://github.com/GitoxideLabs/gitoxide/commit/fd63dd6bd0574a5207c23c0303cd3e86da7cb9d6))
...
### New Features
 ...
 - <csr-id-4a783959c4862985cbffc4fe5cd2c1bed38383b1/> add `src blame -L start,end`
 - <csr-id-75d689f6a195f301e4a3000e79f58e5ec1c20557/> add `src env` to print paths relevant to the Git installation.
 - <csr-id-d6ed2e20631227cbb1f1811ecdaf7fbbf6ea7ace/> `src status` now performs HEAD^{tree}-index comparisons as well.
 - <csr-id-4ffe6eb8f7921c6a03db0aa6d796cc2e3cc328e0/> Add support for statistics and additional performance information.
 - <csr-id-80e5804dea9c1090efdcddbfc97ed1d573c28091/> add `src blame` to the CLI
   That way it's possible to see the `blame` result of any file in the
   repository.

### Bug Fixes

 - <csr-id-433b409ef6cc30569446c0ba98dafc76fe194860/> `src tree entries` now uses a depth-first traversal.
   This makes the result similar to `git ls-tree` in terms of ordering.
 - <csr-id-e3c445ea0969418d2b11204281704f5759c17672/> `src tree entries` usees `find_header()` to show the object size.
 ...
 * **Uncategorized**
    ...
    - Merge pull request #1766 from cruessler/add-range-to-src-blame ([`90fef01`](https://github.com/GitoxideLabs/gitoxide/commit/90fef0148376167763a3ebeff91a1cf9c236cf8a))
    ...
    - Adapt to changes in `src-status` ([`25d480c`](https://github.com/GitoxideLabs/gitoxide/commit/25d480c1e48ffc89431cbdddb1e028c8d399e6d9))
    ...
    - Add `src env` to print paths relevant to the Git installation. ([`75d689f`](https://github.com/GitoxideLabs/gitoxide/commit/75d689f6a195f301e4a3000e79f58e5ec1c20557))
    ...
    - Adapt to changes in `src-diff` ([`83b949e`](https://github.com/GitoxideLabs/gitoxide/commit/83b949e738b0acbff96e59d8f9b0e4229918a6e9))
    ...
    - `src status` now performs HEAD^{tree}-index comparisons as well. ([`d6ed2e2`](https://github.com/GitoxideLabs/gitoxide/commit/d6ed2e20631227cbb1f1811ecdaf7fbbf6ea7ace))
    ...
    - `src tree entries` now uses a depth-first traversal. ([`433b409`](https://github.com/GitoxideLabs/gitoxide/commit/433b409ef6cc30569446c0ba98dafc76fe194860))
    - Adapt to changes in `src-traverse` ([`1de4e70`](https://github.com/GitoxideLabs/gitoxide/commit/1de4e70569cd7c3bfcc9094b7591699b5b419608))
    - `src tree entries` usees `find_header()` to show the object size. ([`e3c445e`](https://github.com/GitoxideLabs/gitoxide/commit/e3c445ea0969418d2b11204281704f5759c17672))
    - Merge pull request #1453 from cruessler/src-blame ([`6ed9976`](https://github.com/GitoxideLabs/gitoxide/commit/6ed9976abaa3915b50efa46c46b195f3a1fc4ff7))
    ...
    - Release src v0.69.1 ([`7659a65`](https://github.com/GitoxideLabs/gitoxide/commit/7659a651205c08ea4ec0cbf0b441a3bd17ec49dd))
...
### New Features
 ...
 - <csr-id-c7e04e976989435ba752628522d53ac39348b49b/> add first 'debug' version of `src log`
   It's primarily meant to better understand `src blame`.
 - <csr-id-471e046a6002a68209e215db7ee904a4149f9d51/> add `--tree-favor` to `src merge tree|commit`.
...
### New Features (BREAKING)
 ...
 - <csr-id-e59fc09f12a1c6b27d878525ff6074ac846aa87e/> move all possible code from `src` to `src-protocol`.
   For now, just move the code down and immediately re-integrate in `src`
 ...
 * **Uncategorized**
    ...
    - Adapt to changes in `src-dir` ([`329a734`](https://github.com/GitoxideLabs/gitoxide/commit/329a734e0f5d23de2bd9af87f6da85cb6154a97c))
    - Merge pull request #1643 from cruessler/add-src-log ([`29cb775`](https://github.com/GitoxideLabs/gitoxide/commit/29cb775e6b85265a4907e882a45621aeb0432564))
    - Trim `src log` to be mergeable. ([`162887e`](https://github.com/GitoxideLabs/gitoxide/commit/162887e2d3968639548f7d3581cb1f47bfe38341))
    - Add first 'debug' version of `src log` ([`c7e04e9`](https://github.com/GitoxideLabs/gitoxide/commit/c7e04e976989435ba752628522d53ac39348b49b))
    ...
    - Adapt to changes in `src-protocol` ([`41b6571`](https://github.com/GitoxideLabs/gitoxide/commit/41b6571b9f331c018672fcd0bb7d5ce0f8885178))
    ...
    - Adapt to changes in `src-dir` ([`a7c4100`](https://github.com/GitoxideLabs/gitoxide/commit/a7c41008705b3c2777b467c60e5b5881021c5abf))
    ...
    - Adapt to changes in `src-dir` ([`a49c960`](https://github.com/GitoxideLabs/gitoxide/commit/a49c960bf7e9ec41b3d0548a3aa6ccc90a59cc2b))
    ...
    - Adapt to changes in `src-protocol` ([`25b8480`](https://github.com/GitoxideLabs/gitoxide/commit/25b848080c7df2da0fa662c580451aec0deb29c4))
    ...
    - Adapt to changes in `src` and `src-protocol` ([`fcb21a4`](https://github.com/GitoxideLabs/gitoxide/commit/fcb21a4b4ad25eb3bb1a2116fa6e709e62e77c84))
    - Move all possible code from `src` to `src-protocol`. ([`e59fc09`](https://github.com/GitoxideLabs/gitoxide/commit/e59fc09f12a1c6b27d878525ff6074ac846aa87e))
    ...
    - Adapt to changes in `src-diff` ([`960773e`](https://github.com/GitoxideLabs/gitoxide/commit/960773e5526d02e1f2294224859c821ed86a3463))
    - Adapt to changes in `src` ([`9896d5d`](https://github.com/GitoxideLabs/gitoxide/commit/9896d5d3ccf629a811e518f0a3b7cbfc195b0b2a))
    - Add `--tree-favor` to `src merge tree|commit`. ([`471e046`](https://github.com/GitoxideLabs/gitoxide/commit/471e046a6002a68209e215db7ee904a4149f9d51))
    - Adapt to changes in `src-merge` ([`3228de6`](https://github.com/GitoxideLabs/gitoxide/commit/3228de627fd059db8abbad7f465023fa559b9b0e))
...
### New Features
 ...
 - <csr-id-0a5993f4ed6e3815949b3cd398d38d69417d21c8/> add `src merge commit --debug`
   This yields additional debugging information with details about detected conflicts.
 - <csr-id-4a5afc7524fc96213385454079ebf9baf302ad4b/> add `src merge commits`
 - <csr-id-84707c2b7540f9a73cc3f0cde74dabd9822cd809/> add `src merge tree` to merge trees similarly to `git merge-tree`.

### Bug Fixes

 - <csr-id-32d6bfbe6548fc699deee41895bcafff1423f117/> assure that `src tree diff` doesn't slow down too much when shortening IDs
 ...
 * **Uncategorized**
    ...
    - Add `src merge commit --debug` ([`0a5993f`](https://github.com/GitoxideLabs/gitoxide/commit/0a5993f4ed6e3815949b3cd398d38d69417d21c8))
    - Adapt to changes in `src-merge`. ([`47110d6`](https://github.com/GitoxideLabs/gitoxide/commit/47110d600c5b02f82b4aad69ec838865e1887c0a))
    ...
    - Add `src merge commits` ([`4a5afc7`](https://github.com/GitoxideLabs/gitoxide/commit/4a5afc7524fc96213385454079ebf9baf302ad4b))
    ...
    - Adapt to changes in `src` ([`8d590f3`](https://github.com/GitoxideLabs/gitoxide/commit/8d590f33f49b556de1748818e0bbec610566842f))
    - Adapt to changes in `src` ([`589ee8e`](https://github.com/GitoxideLabs/gitoxide/commit/589ee8e3338ab66fe405d85a9b0c2fd8a797212a))
    ...
    - Add `src merge tree` to merge trees similarly to `git merge-tree`. ([`84707c2`](https://github.com/GitoxideLabs/gitoxide/commit/84707c2b7540f9a73cc3f0cde74dabd9822cd809))
    - Adapt to changes in `src-object` and `src-odb` ([`96488f7`](https://github.com/GitoxideLabs/gitoxide/commit/96488f745506698e4183e8e544c4e0ecd1ef868b))
    - Adapt to changes in `src-merge` ([`278dd88`](https://github.com/GitoxideLabs/gitoxide/commit/278dd8896007a7fa3d0ec2558cc2055303486259))
    - Assure that `src tree diff` doesn't slow down too much when shortening IDs ([`32d6bfb`](https://github.com/GitoxideLabs/gitoxide/commit/32d6bfbe6548fc699deee41895bcafff1423f117))
...
### New Features
 ...
 - <csr-id-0c554e096cf2bf0a2bb91397143f524219693a3b/> add first 'debug' version of `src diff tree`.
   It's primarily meant to better understand `src blame`.
 - <csr-id-2b81e6c8bd30cc95e91cc92a89f0a0e6047eec6b/> add `Repository::diff_tree_to_tree()` for greater similarity to `git2`
 - <csr-id-9c8bc03de99e6494abd9755deef7e7be5577bce2/> add new `src cat` command.
   It only prints things without fuzz.
   
   Inspired by https://youtu.be/JYH5ILv5g1g?si=bHLBPFJiZyRUTl6u&t=211.
 - <csr-id-3da2da9d7993adc16b19fc63e7524c768a6e2e7f/> add `src merge-file` with similar features as `git merge-file`
 - <csr-id-7249291016253647c920852fb37eb9e29d615775/> `src merge-base` for the CLI
 ...
 * **Uncategorized**
    ...
    - Merge pull request #1626 from cruessler/add-src-diff ([`f186c23`](https://github.com/GitoxideLabs/gitoxide/commit/f186c2381b91f350813076927bf988d253fe1ad0))
    - Some minor modifications ([`6777ecb`](https://github.com/GitoxideLabs/gitoxide/commit/6777ecb99306830a3353a0db24caaa69e348ca74))
    - Add first 'debug' version of `src diff tree`. ([`0c554e0`](https://github.com/GitoxideLabs/gitoxide/commit/0c554e096cf2bf0a2bb91397143f524219693a3b))
    ...
    - Add new `src cat` command. ([`9c8bc03`](https://github.com/GitoxideLabs/gitoxide/commit/9c8bc03de99e6494abd9755deef7e7be5577bce2))
    ...
    - Add `src merge-file` with similar features as `git merge-file` ([`3da2da9`](https://github.com/GitoxideLabs/gitoxide/commit/3da2da9d7993adc16b19fc63e7524c768a6e2e7f))
    ...
    - Adapt to changes in `src-traverse` ([`6862c27`](https://github.com/GitoxideLabs/gitoxide/commit/6862c27e671cbfd8caae549813ea01eeb753bd0b))
    ...
    - `src merge-base` for the CLI ([`7249291`](https://github.com/GitoxideLabs/gitoxide/commit/7249291016253647c920852fb37eb9e29d615775))
    ...
    - Adapt to changes in `src` ([`dbb3576`](https://github.com/GitoxideLabs/gitoxide/commit/dbb35767df8c6d8382bb06dcf9b31e2c74fcedd7))
...
### Bug Fixes
 ...
 - <csr-id-6eb4ea6cf27b2feb3edb9dbf754393b0c7d272fd/> Adjust `src clean` warning and help for worktree fix
 ...
 * **Uncategorized**
    - Release src v0.65.0, src-fsck v0.5.0, gitoxide-core v0.40.0, gitoxide v0.38.0 ([`f218578`](https://github.com/GitoxideLabs/gitoxide/commit/f21857844332f73a6c090f349aa6693684d443bb))
    ...
    - Use improved src-diff API for better buffer handling ([`f944e49`](https://github.com/GitoxideLabs/gitoxide/commit/f944e49ec97b6e9dcffab8606ca0b46e343d7e55))
    ...
    - Adjust `src clean` warning and help for worktree fix ([`6eb4ea6`](https://github.com/GitoxideLabs/gitoxide/commit/6eb4ea6cf27b2feb3edb9dbf754393b0c7d272fd))
...
### New Features
 ...
 - <csr-id-c7213bcf2cf6be4058a78dbd86bbab4c5ad4afa7/> support for listing worktrees with `src worktree list`
 ...
 * **Uncategorized**
    ...
    - Support for listing worktrees with `src worktree list` ([`c7213bc`](https://github.com/GitoxideLabs/gitoxide/commit/c7213bcf2cf6be4058a78dbd86bbab4c5ad4afa7))
</details>
...
### New Features
 ...
 - <csr-id-2a563870fc4d2f65e34c4e4a448b446fc05a43b2/> add `mailmap check` similar to `git check-mailmap`.
   ...
   in the wild.
 - <csr-id-9bf01e42b8d8964dfd1e099d645082c10bdabcdf/> `src clone` with `--ref` support.
 ...
 * **Uncategorized**
    - Release src v0.64.0, src-fsck v0.4.1, gitoxide-core v0.39.0, gitoxide v0.37.0 ([`0e8508a`](https://github.com/GitoxideLabs/gitoxide/commit/0e8508a629c74068a1e667ea4222c3e69ae0b861))
    ...
    - Adapt to changes in `src-config` ([`78e48f2`](https://github.com/GitoxideLabs/gitoxide/commit/78e48f2151c1448cd53f224938ac25416a819bcf))
    ...
    - `src clone` with `--ref` support. ([`9bf01e4`](https://github.com/GitoxideLabs/gitoxide/commit/9bf01e42b8d8964dfd1e099d645082c10bdabcdf))
    ...
    - Release src-archive v0.13.1 ([`bd32c7a`](https://github.com/GitoxideLabs/gitoxide/commit/bd32c7a40f53f4cff57e600bc350f8ca7ed624cc))
</details>
...
### Bug Fixes
 ...
 - <csr-id-addf446f052ff74edcdb083f2b2968b313daa940/> more robustness in the face of a trampling-herd of threads loading a single index.
   ...
   ```
   './target/release/src -r repo-with-one-pack -t10 --trace odb stats --extra-header-lookup'
   ```
 ...
 * **Uncategorized**
    ...
    - Adapt to changes in `src-worktree` ([`1ca6a3c`](https://github.com/GitoxideLabs/gitoxide/commit/1ca6a3ce22887c7eb42ec3e0a19f6e1202715745))
...
### New Features
 ...
 - <csr-id-84c74ffa698d35f8395c63db6acd3d0e6700d07f/> add `src status --ignored` support
 - <csr-id-66e87cd31c060c3f97ac685ee0541c408f600362/> add `src status --index-worktree-renames`
 ...
 - <csr-id-61c002bc4ca5b5345c411e561fdcb492e7ae1d97/> `src status` with submodule and rewrite support.
 ...
 - <csr-id-98b368095ec99d1bc287da7f9294a9fce424deed/> add `src is-clean|is-changed`
   It's a good way to compare the time it takes to run a full status
   compared to a quick is-dirty check.
 - <csr-id-afd20caadb40b6b793f2099b7232669f9a8f9086/> `src submodules list --dirty-suffix` for dirty-information
   ...
   in the first place.
 - <csr-id-58231b418fa39ea122ef41bb7691289f5b0be855/> add `src commit describe --dirty-suffix`
 ...
 * **Uncategorized**
    - Release src-trace v0.1.9, src-utils v0.1.12, src-packetline-blocking v0.17.4, src-filter v0.11.1, src-fs v0.10.2, src-traverse v0.39.0, src-worktree-stream v0.12.0, src-archive v0.12.0, src-config v0.36.1, src-url v0.27.3, src-index v0.32.0, src-worktree v0.33.0, src-diff v0.43.0, src-pathspec v0.7.3, src-dir v0.4.0, src-pack v0.50.0, src-odb v0.60.0, src-transport v0.42.0, src-protocol v0.45.0, src-status v0.9.0, src-worktree-state v0.10.0, src v0.62.0, src-fsck v0.4.0, gitoxide-core v0.37.0, gitoxide v0.35.0, safety bump 14 crates ([`095c673`](https://github.com/GitoxideLabs/gitoxide/commit/095c6739b2722a8b9af90776b435ef2da454c0e6))
    ...
    - Adapt to changes in `src-traverse` ([`1cfeb11`](https://github.com/GitoxideLabs/gitoxide/commit/1cfeb11f1fe9ad9c7b9084840ed7f5c5877f2f9a))
    ...
    - Adapt to changes in `src-traverse` ([`6154bf3`](https://github.com/GitoxideLabs/gitoxide/commit/6154bf3a346d69f9749271d50e4f3aacdcbad4d0))
    - Merge branch 'status' ([`45edd2e`](https://github.com/GitoxideLabs/gitoxide/commit/45edd2ea66035adf526cb2f617873dcba60a2a9a))
    - Adapt to changes in `src-index` ([`1e1fce1`](https://github.com/GitoxideLabs/gitoxide/commit/1e1fce11a968ebbcede1135ccbd0b03e749a1267))
    - Release src-packetline v0.17.5, src-transport v0.41.3, src v0.61.1 ([`57579f1`](https://github.com/GitoxideLabs/gitoxide/commit/57579f1ee4ef12c214db36325a2a0b2e8b2b14fd))
    - Release src-actor v0.31.1, src-object v0.42.1, src-index v0.31.1, src-pathspec v0.7.2, src-dir v0.3.0, src-status v0.8.0, src v0.61.0, safety bump 2 crates ([`155cc45`](https://github.com/GitoxideLabs/gitoxide/commit/155cc45730b259e662d7c4be42a469a3af3750e1))
    ...
    - Adapt to changes in `src` ([`eff82eb`](https://github.com/GitoxideLabs/gitoxide/commit/eff82eb0c67a7e7153c6119623a8aec052661b7d))
    ...
    - Add `src status --ignored` support ([`84c74ff`](https://github.com/GitoxideLabs/gitoxide/commit/84c74ffa698d35f8395c63db6acd3d0e6700d07f))
    - Add `src status --index-worktree-renames` ([`66e87cd`](https://github.com/GitoxideLabs/gitoxide/commit/66e87cd31c060c3f97ac685ee0541c408f600362))
    ...
    - `src status` with submodule and rewrite support. ([`61c002b`](https://github.com/GitoxideLabs/gitoxide/commit/61c002bc4ca5b5345c411e561fdcb492e7ae1d97))
    - Add `src is-clean|is-changed` ([`98b3680`](https://github.com/GitoxideLabs/gitoxide/commit/98b368095ec99d1bc287da7f9294a9fce424deed))
    - `src submodules list --dirty-suffix` for dirty-information ([`afd20ca`](https://github.com/GitoxideLabs/gitoxide/commit/afd20caadb40b6b793f2099b7232669f9a8f9086))
    - Add `src commit describe --dirty-suffix` ([`58231b4`](https://github.com/GitoxideLabs/gitoxide/commit/58231b418fa39ea122ef41bb7691289f5b0be855))
    - Adapt to changes in `src` ([`2d40bdf`](https://github.com/GitoxideLabs/gitoxide/commit/2d40bdf325ed5b09b0ef6fd21e8b3da47d710451))
    - Update src-config setters. ([`ba3bf65`](https://github.com/GitoxideLabs/gitoxide/commit/ba3bf65808fbde44254e55955110ad43c9baedc5))
...
### New Features
 ...
 - <csr-id-9863d75147445d3a598fe1339d88c353850a5984/> add `src clean --patterns-for-entries|-m` to help with wildcards.
 - <csr-id-e52ad782f3b16a6c39f6dba1d25808fe55d26082/> `src status` now shows untracked files as well.
 - <csr-id-a3ab5bc24ff0eedfec5aca6df80649faf7a56d5f/> `src free index info` now lists EOIE and IEOT extensions.
 - <csr-id-e8597f3559187fc8add294e72eb33403cdff0e09/> basic `src clean`
 ...
 * **Uncategorized**
    ...
    - Adapt to changes in `src-dir` ([`aa7c190`](https://github.com/GitoxideLabs/gitoxide/commit/aa7c1908b82e3e23859a4c663faa40ec54611919))
    ...
    - Further improvements to `src clean` ([`e944e74`](https://github.com/GitoxideLabs/gitoxide/commit/e944e74e17355b071373ad9baa3f91ef3da08c8f))
    - Improve `src clean` messaging ([`221bce4`](https://github.com/GitoxideLabs/gitoxide/commit/221bce46d5d282954d76ce1d02c81a326316b64f))
    - Merge branch 'status' ([`bb48c4c`](https://github.com/GitoxideLabs/gitoxide/commit/bb48c4ce22650b8c76af3b147e252ebe7cedb205))
    - Adapt to changes in `src` ([`417f99f`](https://github.com/GitoxideLabs/gitoxide/commit/417f99fc7b144245bca0fa12e3839c3b4542936c))
    - Adapt to changes in `src-dir` ([`ab0f63a`](https://github.com/GitoxideLabs/gitoxide/commit/ab0f63aa5ab90c3a18a62e72d486a889b540d804))
    - Adapt to changes in `src-status` ([`366dfb3`](https://github.com/GitoxideLabs/gitoxide/commit/366dfb375d1c4844e4b0edb934fa8c7a5c10b9b3))
    - `src status` now shows untracked files as well. ([`e52ad78`](https://github.com/GitoxideLabs/gitoxide/commit/e52ad782f3b16a6c39f6dba1d25808fe55d26082))
    - `src clean` is interruptable ([`4fd3173`](https://github.com/GitoxideLabs/gitoxide/commit/4fd31739b0f34947d6c4d68ae430a792af4c4e37))
    ...
    - Improve `src clean` reporting ([`0af2fe6`](https://github.com/GitoxideLabs/gitoxide/commit/0af2fe65e0fb9726a475fc84d949a87312e0e6fc))
    - Merge branch 'dirwalk' ([`face359`](https://github.com/GitoxideLabs/gitoxide/commit/face359443ba33e8985ec1525d5ec38b743ea7a9))
    - `src free index info` now lists EOIE and IEOT extensions. ([`a3ab5bc`](https://github.com/GitoxideLabs/gitoxide/commit/a3ab5bc24ff0eedfec5aca6df80649faf7a56d5f))
    - Basic `src clean` ([`e8597f3`](https://github.com/GitoxideLabs/gitoxide/commit/e8597f3559187fc8add294e72eb33403cdff0e09))
    ...
    - Release src-tempfile v13.1.0, src-lock v13.1.0, safety bump 12 crates ([`8430442`](https://github.com/GitoxideLabs/gitoxide/commit/84304427dfe4d170c7732161b126961719f70059))
...
### Bug Fixes
 ...
 - <csr-id-0bc95684c32a053de22c06e6e45c8de5704fd8fb/> leave extensions in place if they are not `.git` when using `src clone <url>`.
 ...
 * **[#1177](https://github.com/GitoxideLabs/gitoxide/issues/1177)**
    - Leave extensions in place if they are not `.git` when using `src clone <url>`. ([`0bc9568`](https://github.com/GitoxideLabs/gitoxide/commit/0bc95684c32a053de22c06e6e45c8de5704fd8fb))
 * **Uncategorized**
...
<csr-id-886289f98003f935d774a40f6db746ae70649936/>
 ...
 - <csr-id-cf51a4de2d06eb28435ef8e386131710003b6928/> `src rev parse --format` to provide different versions of the same content.
...
### Changed (BREAKING)
 ...
 - <csr-id-806ea473e6e3ca3bf929f7d46c6f087296fceb09/> use `src-object::Find` trait
 ...
 * **Uncategorized**
    - Release src-fsck v0.1.0, gitoxide-core v0.34.0, gitoxide v0.32.0 ([`a96956b`](https://github.com/GitoxideLabs/gitoxide/commit/a96956b0978c3618e7d3f2da049696f55a3b3c82))
    - Release src-worktree-state v0.5.0, src v0.56.0, src-fsck v0.1.0, gitoxide-core v0.34.0, gitoxide v0.32.0 ([`c8568b9`](https://github.com/GitoxideLabs/gitoxide/commit/c8568b9c9bf883f77e81a9a98b1fc2cbe726df79))
    ...
    - Merge branch 'src-status' ([`5fdc9df`](https://github.com/GitoxideLabs/gitoxide/commit/5fdc9df069f3d9a4bd88e4e0ca5d67916e2908c9))
    - `src rev parse --format` to provide different versions of the same content. ([`cf51a4d`](https://github.com/GitoxideLabs/gitoxide/commit/cf51a4de2d06eb28435ef8e386131710003b6928))
    - J fmt ([`51c7abc`](https://github.com/GitoxideLabs/gitoxide/commit/51c7abc65f368b1b2bd3d82473793d3cd4fcbad5))
    - Merge branch 'src-status' ([`dfb3f18`](https://github.com/GitoxideLabs/gitoxide/commit/dfb3f1821428f294f1832543ad0cf2fc883b03fb))
    - Adapt to changes in `src-diff` ([`1706e23`](https://github.com/GitoxideLabs/gitoxide/commit/1706e2394380c35cd98d0e106eb0985ae1912da0))
    ...
    - Merge branch 'src-status' ([`c87f2cc`](https://github.com/GitoxideLabs/gitoxide/commit/c87f2cc7a499cbd354c03c40f9923c80845fc56c))
    - Adapt to changes in `src` related rename tracking ([`a28bf90`](https://github.com/GitoxideLabs/gitoxide/commit/a28bf90aef49d1c51308884df84bb50567aeb501))
    - Merge branch 'fix-1096' ([`ff99a18`](https://github.com/GitoxideLabs/gitoxide/commit/ff99a18e9f9388542a9cbf17d61b413f34b1d533))
    - Adapt to changes in `src-object` ([`203d69c`](https://github.com/GitoxideLabs/gitoxide/commit/203d69c8890acc716bd4f7a7b1b2b91a8c828bde))
    ...
    - Use `src-object::Find` trait ([`806ea47`](https://github.com/GitoxideLabs/gitoxide/commit/806ea473e6e3ca3bf929f7d46c6f087296fceb09))
    ...
    - Add `src free discover` to inform about repository discovery. ([`886289f`](https://github.com/GitoxideLabs/gitoxide/commit/886289f98003f935d774a40f6db746ae70649936))
    - Release src-url v0.25.1 ([`47a1241`](https://github.com/GitoxideLabs/gitoxide/commit/47a1241484fdb424184ca37f85a8b287d374d2a1))
</details>
...
### Bug Fixes
 ...
 - <csr-id-8011c73ee401bfca03811a249c46a4dd468af1b8/> bump `src-transport` version to prevent it from being picked up.
   `src-transport` v0.37.1 could accidentally be picked up by older, incompatible,
   `src` versions which now fail to build.
   
   Thus v0.37.1 is now yanked and replaced with v0.38.0 along with a new
   release of `src` to go with it.
 ...
 * **Uncategorized**
    - Release src-transport v0.38.0, src-protocol v0.41.1, src v0.55.2, gitoxide-core v0.33.1, gitoxide v0.31.1 ([`1955a57`](https://github.com/GitoxideLabs/gitoxide/commit/1955a57f003f7d731d04e582e70ea86f15e8e7d9))
    ...
    - Bump `src-transport` version to prevent it from being picked up. ([`8011c73`](https://github.com/GitoxideLabs/gitoxide/commit/8011c73ee401bfca03811a249c46a4dd468af1b8))
    - Release src v0.55.1 ([`4642c0c`](https://github.com/GitoxideLabs/gitoxide/commit/4642c0c78f45b1956837bc874f6757fc302bee4a))
</details>
...
### New Features
 ...
 - <csr-id-46e591914d548bacae2656ffe14a0ea7ca2eb7ae/> `src status` auto-writes changed indices.
   This prevents expensive operations to re-occour.
 - <csr-id-7ba2fa1c7781230913b0a04ad8684fa7d0143c18/> `src status -s/--statistics` to obtain additional information on what happened.
   This is useful for understanding performance characteristics in detail.

### Bug Fixes

 - <csr-id-0f3a4b0f864645b94f91897507b4d2737ff1ae25/> `src attrs query` now allows to match directories as signalled by the trailing slash
 ...
 - <csr-id-ac1d8d4a323fc5fb27b8c458f1babb4acc56ca52/> revert 'byteyarn' addition in favor of `kstring`
   It turns out not to work on certain 32bit targets that `src` now has to support
   due to Fedora packaging.
 - <csr-id-760d451e3e2abfc13c8d11b91609dd39ccc13bc5/> `src attrs query` now shows attributes even for paths that aren't already tracked
 - <csr-id-6fb851b88d3da043e747753697097d79e2fce73a/> `src exclude query` now also displays paths that don't match existing index entries.
 ...
 * **[#1050](https://github.com/GitoxideLabs/gitoxide/issues/1050)**
    - Revert "adapt to changes in `src-attributes`" ([`aa47342`](https://github.com/GitoxideLabs/gitoxide/commit/aa47342109bf2fe2b33d7f8ac07c56aa1692936b))
 * **Uncategorized**
    ...
    - `src attrs query` now allows to match directories as signalled by the trailing slash ([`0f3a4b0`](https://github.com/GitoxideLabs/gitoxide/commit/0f3a4b0f864645b94f91897507b4d2737ff1ae25))
    ...
    - `src attrs query` now shows attributes even for paths that aren't already tracked ([`760d451`](https://github.com/GitoxideLabs/gitoxide/commit/760d451e3e2abfc13c8d11b91609dd39ccc13bc5))
    - `src exclude query` now also displays paths that don't match existing index entries. ([`6fb851b`](https://github.com/GitoxideLabs/gitoxide/commit/6fb851b88d3da043e747753697097d79e2fce73a))
    - Merge branch 'reset' ([`b842691`](https://github.com/GitoxideLabs/gitoxide/commit/b8426919a491dc3a7df01ee3f258fc0d8a3a327c))
    - `src status` auto-writes changed indices. ([`46e5919`](https://github.com/GitoxideLabs/gitoxide/commit/46e591914d548bacae2656ffe14a0ea7ca2eb7ae))
    - `src status -s/--statistics` to obtain additional information on what happened. ([`7ba2fa1`](https://github.com/GitoxideLabs/gitoxide/commit/7ba2fa1c7781230913b0a04ad8684fa7d0143c18))
    - Adapt to changes in `src-status` ([`54fb7c2`](https://github.com/GitoxideLabs/gitoxide/commit/54fb7c24a97cb2339a67ad269344ce65166a545d))
    ...
    - Release src v0.54.1 ([`f603fd7`](https://github.com/GitoxideLabs/gitoxide/commit/f603fd7a68206a6989a9f959216eba6cca0a6733))
</details>
...
### New Features
 ...
 - <csr-id-f094f71dc1a50955552509d108556c01517c6ed6/> `src status` with basic index-worktree comparison
 - <csr-id-3ff5ac0cda9e3e089dc79fdfbff5ff619ee60b1f/> `src free index from-list` and `src index from-tree` gain `--skip-hash`.
 ...
 - <csr-id-dbf778cfe5423c4769123e8b7cf5efc4dce30db7/> `src remote` and `src fetch` now fallback to the only available remote if necessary.
...
<csr-id-429682d775ba1046bc30bbd52e9d5a8dc841378f/>
 ...
 - <csr-id-7a8f79357ce99c4b86e22be166b54f7376c71469/> cargo-auditable build error
   Use `prodash` instead of `dep:prodash` in src-features and `tracing`
 ...
 * **[#1003](https://github.com/GitoxideLabs/gitoxide/issues/1003)**
    - `src remote` and `src fetch` now fallback to the only available remote if necessary. ([`dbf778c`](https://github.com/GitoxideLabs/gitoxide/commit/dbf778cfe5423c4769123e8b7cf5efc4dce30db7))
 ...
 * **Uncategorized**
    ...
    - `src status` with basic index-worktree comparison ([`f094f71`](https://github.com/GitoxideLabs/gitoxide/commit/f094f71dc1a50955552509d108556c01517c6ed6))
    ...
    - Adapt to changes in `src-attributes` ([`0fac1b9`](https://github.com/GitoxideLabs/gitoxide/commit/0fac1b9843255efbc872f1692c404b51915e0285))
    - Release src v0.53.1 ([`1b1fc25`](https://github.com/GitoxideLabs/gitoxide/commit/1b1fc257d5748c7c41e899bf2d1447ffd9f22d19))
    ...
    - Adapt to changes in `src` ([`805b8aa`](https://github.com/GitoxideLabs/gitoxide/commit/805b8aa74b064b7aa08d87094a994bb8c7aae6ed))
    ...
    - Adapt to changes in `src` ([`9df4929`](https://github.com/GitoxideLabs/gitoxide/commit/9df4929c2508184cb7ab83cc9c7922b2c6874f55))
    ...
    - Adapt to changes in `src-index` and pass skip-hash through for performance.. ([`713cd59`](https://github.com/GitoxideLabs/gitoxide/commit/713cd59f0b1eff6397b80f1e1fceec278532fd59))
    - `src free index from-list` and `src index from-tree` gain `--skip-hash`. ([`3ff5ac0`](https://github.com/GitoxideLabs/gitoxide/commit/3ff5ac0cda9e3e089dc79fdfbff5ff619ee60b1f))
    - Use new `src` method to obtain the fetch remote (instead of implementing it by hand) ([`e2c0912`](https://github.com/GitoxideLabs/gitoxide/commit/e2c0912cfede044431c17ae81ddae02746650ae4))
...
### New Features
 ...
 - <csr-id-1ccbe16117d58b68b25a8e3e66676a61a07dd49c/> `src submodule` subcommand for simple submodule listing and information retrieval
 - <csr-id-6bc69e37deb3ebd88af8b0e8ffb9661562dcc679/> `src index entries --recurse-subomdules` to also list submodules.
 - <csr-id-c30ac0c9f89fb4480c8f8c8c0c06fa046dcd4314/> `src index entries` with styles and pathspecs.
 ...
 - <csr-id-cd6cfe4049bacd8d8a691668b5501a673867f149/> add `src commit verify-signature` to do something akin to `git ... --show-signature`.
 ...
 * **Uncategorized**
    ...
    - `src index entries` with tracing ([`ec1e550`](https://github.com/GitoxideLabs/gitoxide/commit/ec1e5506ebb34ab5269b67d426ec1d57f2037d29))
    - `src submodule` subcommand for simple submodule listing and information retrieval ([`1ccbe16`](https://github.com/GitoxideLabs/gitoxide/commit/1ccbe16117d58b68b25a8e3e66676a61a07dd49c))
    - Just fmt ([`0d258f4`](https://github.com/GitoxideLabs/gitoxide/commit/0d258f40afcd848509e2b0c7c264e9f346ed1726))
    - Merge branch 'submodule-in-src' ([`36f7b78`](https://github.com/GitoxideLabs/gitoxide/commit/36f7b783c67b8a087076a130f5ee9b90b23bc3cc))
    - `src index entries --recurse-subomdules` to also list submodules. ([`6bc69e3`](https://github.com/GitoxideLabs/gitoxide/commit/6bc69e37deb3ebd88af8b0e8ffb9661562dcc679))
    - Adapt to changes in `src` ([`9fe3052`](https://github.com/GitoxideLabs/gitoxide/commit/9fe305291cf8ba908eaf38235f54abfa1d0ddeed))
    ...
    - Adapt to changes in `src-worktree` ([`e5717e1`](https://github.com/GitoxideLabs/gitoxide/commit/e5717e1d12c49285d31a90b03b7f8e9cbc6c1108))
    ...
    - Adapt to changes in `src` ([`ca972a2`](https://github.com/GitoxideLabs/gitoxide/commit/ca972a244c9b074a2dc89ff3bbf83df0c3853904))
    ...
    - `src index entries` with styles and pathspecs. ([`c30ac0c`](https://github.com/GitoxideLabs/gitoxide/commit/c30ac0c9f89fb4480c8f8c8c0c06fa046dcd4314))
    ...
    - Add `src commit verify-signature` to do something akin to `git ... --show-signature`. ([`cd6cfe4`](https://github.com/GitoxideLabs/gitoxide/commit/cd6cfe4049bacd8d8a691668b5501a673867f149))
    - Merge branch 'archive-gz' ([`c7d9129`](https://github.com/GitoxideLabs/gitoxide/commit/c7d912917a2dad5c076d0bd645cfda092c66ff79))
    - Adapt to changes in `src-archive` ([`feba76d`](https://github.com/GitoxideLabs/gitoxide/commit/feba76d636e3d177c41f120639980f8b46edfcaa))
    ...
    - Release src-actor v0.24.2, src-object v0.33.2, src-ref v0.33.3, src-config v0.26.2, src-prompt v0.5.5, src-odb v0.50.2, src-transport v0.34.2, src-protocol v0.37.0, src-worktree v0.23.1, src v0.51.0, safety bump 3 crates ([`231ac1c`](https://github.com/GitoxideLabs/gitoxide/commit/231ac1c6ad5ca9a84dbeb0dee14bfbf2fef1ae1e))
    ...
    - Adapt to changes in `src-protocol` ([`df81076`](https://github.com/GitoxideLabs/gitoxide/commit/df810766dfeaaad7474339358a3d844b2c3368cd))
    - Release src-archive v0.2.1, src-ref v0.33.2, src-pack v0.40.2, src v0.50.1 ([`13883e5`](https://github.com/GitoxideLabs/gitoxide/commit/13883e5528385f892ee402e911298121e0c297c0))
</details>
...
### New Features
 ...
 - <csr-id-32bbb8b7b1f195adf7e5f06fd2ddc19153516a2f/> add simple CLI for `src archive`
 - <csr-id-5348c442877a778ad0bf0a3852cacf955118450f/> adapt to changes in `src-worktree` and let checkout-exclusive use the filter pipeline.
 ...
 * **Uncategorized**
    ...
    - Merge branch 'src-archive' ([`1dda48b`](https://github.com/GitoxideLabs/gitoxide/commit/1dda48ba2fccb93ebac00fe3460e923af43c86ce))
    ...
    - Add compression support to `src archive`, which is where it should shine. ([`567b1a4`](https://github.com/GitoxideLabs/gitoxide/commit/567b1a4488c43c1f7099435d10cdddbc3a98a5cc))
    - Add simple CLI for `src archive` ([`32bbb8b`](https://github.com/GitoxideLabs/gitoxide/commit/32bbb8b7b1f195adf7e5f06fd2ddc19153516a2f))
    ...
    - Release src-prompt v0.5.3, src v0.49.1, cargo-smart-release v0.20.0 ([`f069852`](https://github.com/GitoxideLabs/gitoxide/commit/f0698522940c9ba4d45db5a44dce9f21ca29cb4e))
    ...
    - Adapt to changes in `src-worktree` and let checkout-exclusive use the filter pipeline. ([`5348c44`](https://github.com/GitoxideLabs/gitoxide/commit/5348c442877a778ad0bf0a3852cacf955118450f))
    - Release src-transport v0.33.1, src v0.48.0 ([`f27ca12`](https://github.com/GitoxideLabs/gitoxide/commit/f27ca128c5f109ad02e4e1a12dc14e93b07bbfcf))
    - Release src-glob v0.9.1, src-attributes v0.14.1, src-config-value v0.12.3, src-ref v0.32.1, src-sec v0.8.3, src-config v0.25.1, src-url v0.20.1, src-credentials v0.16.1, src-discover v0.21.1, src-ignore v0.4.1, src-pack v0.39.1, src-odb v0.49.1, src-worktree v0.21.1, src v0.48.0 ([`69c6a36`](https://github.com/GitoxideLabs/gitoxide/commit/69c6a36ba14cbef129deebda9fd8870005fefa17))
...
### New Features
 ...
 - <csr-id-c494cfd6f80cf273107c626d0f2cbe054db378ee/> `src --trace` to also print tree-like instrumentation
 - <csr-id-452ed6b79ed0e12ae214af3c8cd49a87dba91c73/> `src fetch --open-negotiation-graph[=limit]`
 ...
 - <csr-id-096838ffa529148b2da3a2382a2d1fdbfe5bee5b/> `src fetch --negotiation-info` to provide additional information about the negotiation phase.
...
### New Features (BREAKING)
 ...
 - <csr-id-b82edc8b965344a866039f6c99295db4f8e776e2/> list commit-graph entries by graph traversal, move commit-graph up to `src` level.
 ...
 * **Uncategorized**
    ...
    - Merge branch 'src-corpus' ([`5861afb`](https://github.com/GitoxideLabs/gitoxide/commit/5861afb45f32c16eefcd8e7b7480309bf44b6edc))
    ...
    - `src --trace` to also print tree-like instrumentation ([`c494cfd`](https://github.com/GitoxideLabs/gitoxide/commit/c494cfd6f80cf273107c626d0f2cbe054db378ee))
    ...
    - `src fetch --open-negotiation-graph[=limit]` ([`452ed6b`](https://github.com/GitoxideLabs/gitoxide/commit/452ed6b79ed0e12ae214af3c8cd49a87dba91c73))
    - `src fetch --negotiation-info` to provide additional information about the negotiation phase. ([`096838f`](https://github.com/GitoxideLabs/gitoxide/commit/096838ffa529148b2da3a2382a2d1fdbfe5bee5b))
    - Adapt to changes in `src` ([`3728e10`](https://github.com/GitoxideLabs/gitoxide/commit/3728e10cf7c252074aa141cc84fed7af33779658))
    ...
    - List commit-graph entries by graph traversal, move commit-graph up to `src` level. ([`b82edc8`](https://github.com/GitoxideLabs/gitoxide/commit/b82edc8b965344a866039f6c99295db4f8e776e2))
    - Adapt to changes in `src-date` ([`d575336`](https://github.com/GitoxideLabs/gitoxide/commit/d575336c26e6026e463cd06d88266bb2bdd3e162))
    ...
    - Adapt to changes in `src` ([`20f73c8`](https://github.com/GitoxideLabs/gitoxide/commit/20f73c8224ead1b423a1b6331c9cab65f769d46a))
    ...
    - Adapt to changes in `src-traverse` ([`1f682fd`](https://github.com/GitoxideLabs/gitoxide/commit/1f682fd991b9b76a8d37e6852567ff239c0ac0db))
    ...
    - Adapt to changes in `src` ([`2a6015b`](https://github.com/GitoxideLabs/gitoxide/commit/2a6015b482b38df18b8770ebb6741c201a304dfb))
</details>
...
### New Features
 ...
 - <csr-id-042f2e1388236e3e50b2b148afb28d59803396b5/> `src index entries` now works on bare repositories.
 ...
 - <csr-id-596ff7a348afa97171d20347fcdc5671081d80df/> `src attributes validate-baseline` works in bare repostiories.
 - <csr-id-e1fcc7f69e7b95aeac8cbbde3719a1e6b9dafeba/> `src attributes validate` to validate attributes and ignore against `git` as baseline.
 ...
 - <csr-id-450b2325909459c7061f3d02f461c3f0f20f1e86/> `--statistics` for `src excludes query`
   With it one gets some insights into the work done to fulfil the query.
 - <csr-id-bfdcb147cdc3d0338a4cd2bc915b0e0eeced1e99/> `src attribute query` as something similar to `git check-attrs`.
 ...
 * **Uncategorized**
    ...
    - Adapt to changes in `src` ([`7983f6f`](https://github.com/GitoxideLabs/gitoxide/commit/7983f6fd4ef242d494962fe35b8b8f91a6135f32))
    ...
    - Adjust to changes in `src` ([`0737d97`](https://github.com/GitoxideLabs/gitoxide/commit/0737d974ff97785dcf36cf8c5578a1e1dee0628f))
    ...
    - `src index entries` now works on bare repositories. ([`042f2e1`](https://github.com/GitoxideLabs/gitoxide/commit/042f2e1388236e3e50b2b148afb28d59803396b5))
    - `src attributes validate-baseline` works in bare repostiories. ([`596ff7a`](https://github.com/GitoxideLabs/gitoxide/commit/596ff7a348afa97171d20347fcdc5671081d80df))
    ...
    - Adapt to changes in `src-revision` ([`56f4d30`](https://github.com/GitoxideLabs/gitoxide/commit/56f4d30960de4afc8c53136af45149cf880547c5))
    - Adjust to changes in `src-commitgraph` ([`2d71d20`](https://github.com/GitoxideLabs/gitoxide/commit/2d71d20180c3426b40491c1e0bc12361627b3d68))
    ...
    - Adjust to changes in `src-pack` ([`215889c`](https://github.com/GitoxideLabs/gitoxide/commit/215889ceb976a59368c132aabfffb71a6a2ac9f8))
    - Adjust to changes in `src-features` ([`c48bbe3`](https://github.com/GitoxideLabs/gitoxide/commit/c48bbe330e5e99fa357a87a4aa210317ab7c8143))
    - Merge branch 'src-attributes-validate' ([`a849da8`](https://github.com/GitoxideLabs/gitoxide/commit/a849da8e35ca14fef9a2431fe1bb1c05b249680e))
    - Adjust to changes in `src-ignore` ([`977447f`](https://github.com/GitoxideLabs/gitoxide/commit/977447f7255ffa6a36ab1fdaaa8532b60cd6c3a5))
    - `src attributes validate` to validate attributes and ignore against `git` as baseline. ([`e1fcc7f`](https://github.com/GitoxideLabs/gitoxide/commit/e1fcc7f69e7b95aeac8cbbde3719a1e6b9dafeba))
    - Merge branch 'src-attribute-query' ([`1d70213`](https://github.com/GitoxideLabs/gitoxide/commit/1d70213b5c41611c9a6172901b78844a76dece0e))
    - `--statistics` for `src excludes query` ([`450b232`](https://github.com/GitoxideLabs/gitoxide/commit/450b2325909459c7061f3d02f461c3f0f20f1e86))
    - `src attribute query` as something similar to `git check-attrs`. ([`bfdcb14`](https://github.com/GitoxideLabs/gitoxide/commit/bfdcb147cdc3d0338a4cd2bc915b0e0eeced1e99))
 ...
 * **Uncategorized**
    ...
    - Adjust to changes in `src-attributes` ([`11c9ff0`](https://github.com/GitoxideLabs/gitoxide/commit/11c9ff07a0a8e04ca752a76a1248a5c44d3747ed))
</details>
...
### New Features
 ...
 - <csr-id-08e8fc2152794652ba1c986df493c2ac915af9e7/> `src index entries` also prints attributes.
 - <csr-id-9723e1addf52cc336d59322de039ea0537cdca36/> `src clone` and `src fetch` with controls for shallow repositories.
 - <csr-id-5903371ef3a80009eb5d5d336283b61b5966e05f/> Show the date of the commit when tracing a file.

### Bug Fixes

 - <csr-id-32cfeac2f4d7bb02f6ce5d01a62906aa64d3e487/> `src clone` now handles empty repositories.
...
### New Features (BREAKING)
 ...
 - <csr-id-ca8ebdfb9647ff15b0293823bb3bb3c6779c8dd2/> turn `src free index entries` into `src index entries`.
 ...
 * **[#792](https://github.com/GitoxideLabs/gitoxide/issues/792)**
    - `src clone` now handles empty repositories. ([`32cfeac`](https://github.com/GitoxideLabs/gitoxide/commit/32cfeac2f4d7bb02f6ce5d01a62906aa64d3e487))
 ...
 * **Uncategorized**
    - Release src-commitgraph v0.14.0, gitoxide-core v0.26.0, gitoxide v0.24.0 ([`9f2317f`](https://github.com/GitoxideLabs/gitoxide/commit/9f2317f2514872001168d2be6e33e2ee2872420e))
    ...
    - `src index entries` also prints attributes. ([`08e8fc2`](https://github.com/GitoxideLabs/gitoxide/commit/08e8fc2152794652ba1c986df493c2ac915af9e7))
    - Adjust to changes in `src-worktree` ([`27a39ca`](https://github.com/GitoxideLabs/gitoxide/commit/27a39cad498ca8b2c9cba05790284e2b68ba7636))
    - Adjust to changes in `src` ([`a09b63f`](https://github.com/GitoxideLabs/gitoxide/commit/a09b63f75cf3e947cdcf052fe668d10710fac1fb))
    ...
    - Adjust to changes in `src` ([`58398fb`](https://github.com/GitoxideLabs/gitoxide/commit/58398fb3f78b619201a7ccdc758ce81d36e32b83))
    ...
    - Create new `src-fs` crate to consolidate all filesystem utilities ([`f8cc33c`](https://github.com/GitoxideLabs/gitoxide/commit/f8cc33cb372dd2b4bbe4a09cf4f64916681ab1dd))
    ...
    - Adjust to changes in `src-attributes` ([`1755c81`](https://github.com/GitoxideLabs/gitoxide/commit/1755c81f64ce8a68807c2026eeae13dc46021db1))
    ...
    - Release src-features v0.28.1, src-tempfile v5.0.1, src-ref v0.27.1, src-pack v0.33.1, src-packetline v0.15.0, src-transport v0.29.0, src-protocol v0.30.0, src v0.42.0, safety bump 3 crates ([`c1f1bfb`](https://github.com/GitoxideLabs/gitoxide/commit/c1f1bfb8dc0e73993678353e4492d0614b642ed1))
    ...
    - `src clone` and `src fetch` with controls for shallow repositories. ([`9723e1a`](https://github.com/GitoxideLabs/gitoxide/commit/9723e1addf52cc336d59322de039ea0537cdca36))
    ...
    - Release src-tempfile v5.0.0, src-lock v5.0.0, src-ref v0.27.0, src-config v0.19.0, src-url v0.16.0, src-credentials v0.12.0, src-discover v0.16.0, src-index v0.15.0, src-pack v0.33.0, src-odb v0.43.0, src-transport v0.28.0, src-protocol v0.29.0, src-worktree v0.15.0, src v0.41.0, safety bump 12 crates ([`29a0870`](https://github.com/GitoxideLabs/gitoxide/commit/29a087043d1feb2f127b065341c8028d0bd0301e))
    - Release src v0.40.0 ([`18e72c9`](https://github.com/GitoxideLabs/gitoxide/commit/18e72c988a58415080d4555bc869ae04df8d04fa))
...
### New Features
 ...
 - <csr-id-f8cc62376bd6e940be4c41e84ccbfce111e64e39/> `ein tool query` - a git analytics engine.
   ...
   data structure.
 - <csr-id-49520d1f03ee1d011f6e9f2eb07084d327fe95ae/> `src tree entries` with rev-spec support.
 ...
 * **Uncategorized**
    - Release src-object v0.26.4, src-diff v0.26.3, src v0.37.2, src-commitgraph v0.13.1, gitoxide-core v0.25.0, gitoxide v0.23.0 ([`9982949`](https://github.com/GitoxideLabs/gitoxide/commit/9982949cab401501d5ce3cba4e2ba900bc249c53))
    ...
    - `src tree entries` with rev-spec support. ([`49520d1`](https://github.com/GitoxideLabs/gitoxide/commit/49520d1f03ee1d011f6e9f2eb07084d327fe95ae))
    - Release src-config v0.16.3, src v0.37.1 ([`a3c283f`](https://github.com/GitoxideLabs/gitoxide/commit/a3c283ff0e3f21cedb3ba7cd464fdfa0f5133af0))
    - Release src-object v0.26.3, src-diff v0.26.2, src-traverse v0.22.2, src v0.37.0, safety bump 3 crates ([`8b3e42f`](https://github.com/GitoxideLabs/gitoxide/commit/8b3e42f69fe97fe5083eb845c323f10d7ac087b2))
    ...
    - Adjust to changes in `src` ([`2e7989f`](https://github.com/GitoxideLabs/gitoxide/commit/2e7989f67d55e42d219ba0c945d222448e56b2bc))
    ...
    - Release src-transport v0.25.5 ([`f872ba8`](https://github.com/GitoxideLabs/gitoxide/commit/f872ba8271a5d632acc071e7a857ef19f7cf5610))
</details>
 ...
 * **Uncategorized**
    - Release src-commitgraph v0.13.0, gitoxide-core v0.24.0, gitoxide v0.22.0 ([`3262cde`](https://github.com/GitoxideLabs/gitoxide/commit/3262cdeee90f249fdb4b24aeb03f1bed60ed6fef))
...
### New Features
 ...
 - <csr-id-b81f650b476354c5bd030aa03b9a723d9d7a0970/> `src clone <url>` is now permitted without specifying a destination directory.
 ...
 * **[#683](https://github.com/GitoxideLabs/gitoxide/issues/683)**
    - `src clone <url>` is now permitted without specifying a destination directory. ([`b81f650`](https://github.com/GitoxideLabs/gitoxide/commit/b81f650b476354c5bd030aa03b9a723d9d7a0970))
 * **Uncategorized**
    ...
    - Merge branch 'src-clone-improvements' ([`76c99f3`](https://github.com/GitoxideLabs/gitoxide/commit/76c99f3005f1b0031921b536f5d268715e41f3c8))
...
### New Features
 ...
 - <csr-id-8c9c243fc574dc17b92a8e2025fbd8efdf2833da/> `src odb stats` to calculate statistics on the object database.
   This includes the amount of objects along with a listing of where they are
   located.
 - <csr-id-e2b8c5dce7185b5fa194b90f32e642e5c9d1227f/> `src clone --no-tags` support.
   This is the same as `git clone --no-tags`.
 - <csr-id-9dd5659c386e97900a9c2d8c28ac70cc64ed0a52/> `src remote ref-map` makes clear which specs are implicit.
 ...
 * **Uncategorized**
    ...
    - `src odb stats` to calculate statistics on the object database. ([`8c9c243`](https://github.com/GitoxideLabs/gitoxide/commit/8c9c243fc574dc17b92a8e2025fbd8efdf2833da))
    ...
    - `src remote ref-map` makes clear which specs are implicit. ([`9dd5659`](https://github.com/GitoxideLabs/gitoxide/commit/9dd5659c386e97900a9c2d8c28ac70cc64ed0a52))
...
### New Features
 ...
 - <csr-id-e973dfeaf17ca63385496202e9fdcdd912e20f42/> `src remote ref-map --show-unmapped-remote-refs`.
...
### New Features (BREAKING)
 ...
 - <csr-id-92bbe335688e4c8e96061663e71a599022f7b96f/> remove `src remote --url` in favor of determining the intention similar to `git fetch`
 ...
 * **[#450](https://github.com/GitoxideLabs/gitoxide/issues/450)**
    ...
    - `src remote ref-map --show-unmapped-remote-refs`. ([`e973dfe`](https://github.com/GitoxideLabs/gitoxide/commit/e973dfeaf17ca63385496202e9fdcdd912e20f42))
    ...
    - First rough sketch of `src clone` ([`23a5e8b`](https://github.com/GitoxideLabs/gitoxide/commit/23a5e8b658c5642c3f3060e013fd0eab06cbf027))
    ...
    - Remove `src remote --url` in favor of determining the intention similar to `git fetch` ([`92bbe33`](https://github.com/GitoxideLabs/gitoxide/commit/92bbe335688e4c8e96061663e71a599022f7b96f))
    ...
    - Frame for `src fetch` ([`5b72d27`](https://github.com/GitoxideLabs/gitoxide/commit/5b72d2708889dc388facd9cbc61e5bfa5403e003))
 ...
 * **Uncategorized**
    ...
    - Merge branch 'src-clone' ([`def53b3`](https://github.com/GitoxideLabs/gitoxide/commit/def53b36c3dec26fa78939ab0584fe4ff930909c))
    - Fix build and docs ([`971fe0c`](https://github.com/GitoxideLabs/gitoxide/commit/971fe0cb437cb1dcd470574d7b7338f0dabd09ac))
    - Merge branch 'main' into src-clone ([`fa27570`](https://github.com/GitoxideLabs/gitoxide/commit/fa27570f491388cce6137af44330d76870d07202))
    ...
    - Merge branch 'main' into src-clone ([`de4fe06`](https://github.com/GitoxideLabs/gitoxide/commit/de4fe06202906ea5c62e667826b42cf7b57b1ff0))
    - Merge branch 'fix-src-index-from-tree' ([`da5f63c`](https://github.com/GitoxideLabs/gitoxide/commit/da5f63cbc7506990f46d310f8064678decb86928))
    ...
    - Merge branch 'src-index-from-tree' ([`8c24386`](https://github.com/GitoxideLabs/gitoxide/commit/8c24386f1874cd94f78fefbe434963f772878b1f))
...
### New Features (BREAKING)
 ...
 - <csr-id-e090f843f5cffc8e8e47a8cac2e6fb98e4c47771/> `src-diff` is now included by default as part of core functionality
 ...
 * **Uncategorized**
    ...
    - Implement `src index from-tree` ([`2fbd3df`](https://github.com/GitoxideLabs/gitoxide/commit/2fbd3df89373eea5d6268fa47e046c8ebad8bba9))
...
### New Features
 ...
 - <csr-id-5d6d5ca305615568dfedbcc10ea86294c0a0472d/> `src remote refs` to list all remote references of a suitable remote.
...
### Changed (BREAKING)
 ...
 - <csr-id-dda995790c260131048484a11e66185b9c841311/> remove `src free remote ref-list` in favor of `src remote refs`
 ...
 * **[#450](https://github.com/GitoxideLabs/gitoxide/issues/450)**
    - Support for -c CLI config overrides in `src config`. ([`19c1746`](https://github.com/GitoxideLabs/gitoxide/commit/19c1746cefca9bc76537637ec99634eb4cf66a92))
    - Remove `src free remote ref-list` in favor of `src remote refs` ([`dda9957`](https://github.com/GitoxideLabs/gitoxide/commit/dda995790c260131048484a11e66185b9c841311))
    ...
    - `src remote refs` to list all remote references of a suitable remote. ([`5d6d5ca`](https://github.com/GitoxideLabs/gitoxide/commit/5d6d5ca305615568dfedbcc10ea86294c0a0472d))
    ...
    - Basic parsing of `src remote refs` without any implementation. ([`f8f1249`](https://github.com/GitoxideLabs/gitoxide/commit/f8f124943f73bacf816c6d0055f0b66659fd3906))
 * **Uncategorized**
    ...
    - Greatly improve `src commit describe` performance by adding an object cache ([`d07daaa`](https://github.com/GitoxideLabs/gitoxide/commit/d07daaae8ed33161097f3007057c9993546ceb75))
</details>
...
### New Features
 ...
 - <csr-id-b83f6bdf7f8d8f5cef2a57fa3932b6a0e0988db1/> `--cat-file` flag for `src rev parse` to cat instead of resolving.
 - <csr-id-e972aad020d3653a53b20fa6e535d5759e239a45/> `src rev previous-branches` subcommand
...
### Changed (BREAKING)
 ...
 - <csr-id-12589cc6f08e4d7aabae30bcdadaa0c2b4850229/> adapt to changes in `src-url` and use `BString` to represent URLs.
...
### New Features (BREAKING)
 ...
 - <csr-id-c5846e05aa54f0601ac7b8e2e59bcf1ffaa305f1/> `src rev resolve --explain`
 ...
 * **[#427](https://github.com/GitoxideLabs/gitoxide/issues/427)**
    - `--cat-file` flag for `src rev parse` to cat instead of resolving. ([`b83f6bd`](https://github.com/GitoxideLabs/gitoxide/commit/b83f6bdf7f8d8f5cef2a57fa3932b6a0e0988db1))
    - `src rev resolve --explain` ([`c5846e0`](https://github.com/GitoxideLabs/gitoxide/commit/c5846e05aa54f0601ac7b8e2e59bcf1ffaa305f1))
    - Make fmt ([`4b320e7`](https://github.com/GitoxideLabs/gitoxide/commit/4b320e773368ac5e8c38dd8a779ef3d6d2d024ec))
    - `src rev previous-branches` subcommand ([`e972aad`](https://github.com/GitoxideLabs/gitoxide/commit/e972aad020d3653a53b20fa6e535d5759e239a45))
    ...
    - `src rev parse` now uses `Repository::rev_parse()` ([`e191681`](https://github.com/GitoxideLabs/gitoxide/commit/e191681a9e700d8a49e2ab6ffb19cfc5f43312a5))
...
### New Features
 ...
 - <csr-id-eda39ec7d736d49af1ad9e2ad775e4aa12b264b7/> `src config` with section and sub-section filtering.
 - <csr-id-d99453ebeb970ed493be236def299d1e82b01f83/> `src config` lists all entries of all configuration files git considers.
   Filters allow to narrow down the output.
 - <csr-id-7f67b23b9462b805591b1fe5a8406f8d7404f372/> Use `src-config` to write config file on initialization, including `logallrefupdates` and `precomposeunicode`.
 ...
 * **[#301](https://github.com/GitoxideLabs/gitoxide/issues/301)**
    ...
    - Add `--show-ignore-patterns` to `src repo exclude query` ([`09f904b`](https://github.com/GitoxideLabs/gitoxide/commit/09f904b1f393f03176882d491d7fffcad4058b49))
 ...
 * **[#331](https://github.com/GitoxideLabs/gitoxide/issues/331)**
    ...
    - Update README with `src config` information ([`c19d9fd`](https://github.com/GitoxideLabs/gitoxide/commit/c19d9fdc569528972f7f6255760ae86ba99848cc))
    ...
    - `src config` with section and sub-section filtering. ([`eda39ec`](https://github.com/GitoxideLabs/gitoxide/commit/eda39ec7d736d49af1ad9e2ad775e4aa12b264b7))
    - `src config` lists all entries of all configuration files git considers. ([`d99453e`](https://github.com/GitoxideLabs/gitoxide/commit/d99453ebeb970ed493be236def299d1e82b01f83))
 ...
 * **Uncategorized**
    ...
    - Merge branch 'src-repo-config' ([`afecb63`](https://github.com/GitoxideLabs/gitoxide/commit/afecb6337dcf0fc51d5c74747c3c60fa06ae6346))
...
### New Features
 ...
 - <csr-id-7e99e6aeee9bf200a561d215c586301f5e4a8cbc/> Add `src repo commit describe`
 ...
 * **[#298](https://github.com/GitoxideLabs/gitoxide/issues/298)**
    ...
    - Add `src repo commit describe` ([`7e99e6a`](https://github.com/GitoxideLabs/gitoxide/commit/7e99e6aeee9bf200a561d215c586301f5e4a8cbc))
...
### New Features
 ...
 - <csr-id-d2388d8d80f379eccc9ee84ebe07acd67d154630/> `src repository mailmap entries`
 - <csr-id-384ed665c7423feca1b1ee1f81db10867fa813a8/> `src mailmap verify` command
...
### Changed (BREAKING)
 ...
 - <csr-id-15d429bb50602363292453606902bdce5042d9a5/> file::Store::(try_)find(…, packed) was removed
   ...
   When compiled with `src-features/parallel` the `file::Store` remains
   send and sync.
 ...
 - <csr-id-e7526b2a7b51cbac4018e1ab3b623a85987fadc2/> parallel utilities now use `Send + Clone` instead of `Send + Sync`
   ...
   work.
 - <csr-id-e8b091943f0c9a26317da0003f7fcdf5a56ef21a/> Rename src->ein and gixp->src
 ...
 * **[#247](https://github.com/GitoxideLabs/gitoxide/issues/247)**
    - Rename src->ein and gixp->src ([`e8b0919`](https://github.com/GitoxideLabs/gitoxide/commit/e8b091943f0c9a26317da0003f7fcdf5a56ef21a))
 ...
 * **[#293](https://github.com/GitoxideLabs/gitoxide/issues/293)**
    ...
    - Add 'index verify' subcommand to 'src' ([`1ac2c21`](https://github.com/GitoxideLabs/gitoxide/commit/1ac2c210c311c4b2ef835e04e2d7c477981b850f))
 ...
 * **[#366](https://github.com/GitoxideLabs/gitoxide/issues/366)**
    ...
    - `src repository mailmap entries` ([`d2388d8`](https://github.com/GitoxideLabs/gitoxide/commit/d2388d8d80f379eccc9ee84ebe07acd67d154630))
    ...
    - `src mailmap verify` command ([`384ed66`](https://github.com/GitoxideLabs/gitoxide/commit/384ed665c7423feca1b1ee1f81db10867fa813a8))
...
A maintenance release to properly dealing with previously breaking changes in `src-hash`.
 ...
 * **Uncategorized**
    ...
    - [actor] fix src hours ([`b4e95fd`](https://github.com/GitoxideLabs/gitoxide/commit/b4e95fdbb6664adcb2603d9cb6e6a69182de050f))
    ...
    - [src-organize] fast-prefilter + close look at the repository itself ([`eda440a`](https://github.com/GitoxideLabs/gitoxide/commit/eda440ab7efc81749b20a0f21a46825c945ff6db))
    ...
    - [src-organize] use git-repository a little more ([`20f76a5`](https://github.com/GitoxideLabs/gitoxide/commit/20f76a5fc93c9a59e26688dce3e82114ccaeffe3))
    - Revert 'src-organize' to normal thanks to performance regression ([`eda452e`](https://github.com/GitoxideLabs/gitoxide/commit/eda452e14564e802e9314d94993ae8c8590c5301))
    ...
    - [git-repository] used by src-hours ([`24e0258`](https://github.com/GitoxideLabs/gitoxide/commit/24e0258b9691b82df5c35a35111d19df56087cdc))
...
### Other
 ...
 - <csr-id-747a13e9a1fe5200c53055dd961507c9fef667e1/> :borrowed::Object => src-odb::data::Object
 ...
 * **Uncategorized**
    ...
    - [src] Use flate2 by default ([`f1158a1`](https://github.com/GitoxideLabs/gitoxide/commit/f1158a1a4bc8e13913461db4d4851e32d57816ff))
    - [src] Add optional zlib feature ([`f1f9665`](https://github.com/GitoxideLabs/gitoxide/commit/f1f96658a6cd6165ba9c9d7acb809fcaf2c46f9c))
