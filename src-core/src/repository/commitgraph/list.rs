pub(crate) mod function {
    ...
    use src::revision::plumbing::Spec;
    use src::{prelude::ObjectIdExt, revision::walk::Sorting};
    ...
    fn connected_commit_id(repo: &src::Repository, id: src::ObjectId) -> anyhow::Result<src::Id<'_>> {
        Ok(id
            .attach(repo)
            .object()?
