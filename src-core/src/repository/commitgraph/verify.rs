...
pub(crate) mod function {
    ...
    ) -> Result<src::commitgraph::verify::Outcome>
    where
        W1: io::Write,
        W2: io::Write,
    {
        ...
        fn noop_processor(_commit: &src::commitgraph::file::Commit<'_>) -> std::result::Result<(), std::fmt::Error> {
            Ok(())
        }
    ...
    fn print_human_output(out: &mut impl io::Write, stats: &src::commitgraph::verify::Outcome) -> io::Result<()> {
