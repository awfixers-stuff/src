...
pub fn file(
    ...
    format: OutputFormat,
    conflict: Option<src::merge::blob::builtin_driver::text::Conflict>,
    base: BString,
    ours: BString,
    theirs: BString,
) -> anyhow::Result<()> {
    ...
    let labels = src::merge::blob::builtin_driver::text::Labels {
...
fn worktree_roots(
    base: Option<src::Id<'_>>,
    ours: Option<src::Id<'_>>,
    theirs: Option<src::Id<'_>>,
    workdir: Option<&Path>,
) -> anyhow::Result<src::merge::blob::pipeline::WorktreeRoots> {
    let roots = if base.is_none() || ours.is_none() || theirs.is_none() {
        ...
        src::merge::blob::pipeline::WorktreeRoots {
