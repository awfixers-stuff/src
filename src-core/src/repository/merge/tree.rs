...
pub struct Options {
    ...
    pub file_favor: Option<src::merge::tree::FileFavor>,
    pub tree_favor: Option<src::merge::tree::TreeFavor>,
    pub in_memory: bool,
    pub debug: bool,
}
...
pub(super) mod function {
    ...
    pub fn tree(
        ...
        {
            let _span = src::trace::detail!("Writing merged tree");
            let mut written = 0;
            let tree_id = res
                .tree
                .detach()
    ...
    fn refname_and_tree(
        repo: &src::Repository,
        revspec: BString,
    ) -> anyhow::Result<(Option<BString>, src::hash::ObjectId)> {
