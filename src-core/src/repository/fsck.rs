use anyhow::Context;
use src::{objs::Kind, ObjectId};

pub fn function(mut repo: src::Repository, spec: Option<String>, mut out: impl std::io::Write) -> anyhow::Result<()> {
    ...
    let commits: src::revision::Walk<'_> = id
        .object()?
