...
pub(crate) mod function {
    ...
    use src::odb::store::RefreshMode;
    use src::{hashtable::HashMap, revision::walk::Sorting, Progress};
    use layout::{
    ...
    pub fn list(
        ...
        let commits = id
            .object()?
            .peel_to_kind(src::object::Kind::Commit)
        ...
        progress.init(None, src::progress::count("commits"));
        ...
        fn new_node(id: src::Id<'_>) -> Element {
