...
use src::{bstr::ByteSlice, prelude::ObjectIdExt, Count, Progress};
            ...
            Command::TracePath { spec } => {
                ...
                let relpath = self
                    ...
                    .pathspec(
                        ...
                        false,
                        &src::index::State::new(self.repo.object_hash()),
                ...
                progress.init(None, src::progress::count("round"));
            ...
            match self.source_file_id {
                Some(source_id) => {
                    writeln!(
                        ...
                        self.commit_time.format_or_unix(src::date::time::format::SHORT),
                        id.shorten_or_id(),
                        self.mode.as_str(),
