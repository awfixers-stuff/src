...
fn raise_chain() {
    ...
    E5, at src-error/tests/error/exn.rs:27
    |
    └─ E4, at src-error/tests/error/exn.rs:26
    |
    └─ E3, at src-error/tests/error/exn.rs:25
    |
    └─ E2, at src-error/tests/error/exn.rs:24
    |
    └─ E1, at src-error/tests/error/exn.rs:23
    ");
...
fn raise_all() {
    ...
    ");
    insta::assert_snapshot!(debug_string(&e), @"
    Top, at src-error/tests/error/exn.rs:138
    |
    └─ E1, at src-error/tests/error/exn.rs:139
    |   |
    |   └─ E1-0, at src-error/tests/error/exn.rs:139
    |
    └─ E2, at src-error/tests/error/exn.rs:139
    |   |
    |   └─ E2-0, at src-error/tests/error/exn.rs:139
    |   |
    |   └─ E2-1, at src-error/tests/error/exn.rs:139
    |
    └─ E3, at src-error/tests/error/exn.rs:139
    |   |
    |   └─ E3-0, at src-error/tests/error/exn.rs:139
    |   |
    |   └─ E3-1, at src-error/tests/error/exn.rs:139
    |   |
    |   └─ E3-2, at src-error/tests/error/exn.rs:139
    |
    └─ E4, at src-error/tests/error/exn.rs:139
        |
        └─ E4-0, at src-error/tests/error/exn.rs:139
        |
        └─ E4-1, at src-error/tests/error/exn.rs:139
        |
        └─ E4-2, at src-error/tests/error/exn.rs:139
        |
        └─ E4-3, at src-error/tests/error/exn.rs:139
    ");
...
fn inverse_error_call_chain() {
    ...
    ");
    insta::assert_snapshot!(debug_string(&e5), @"
    E1, at src-error/tests/error/exn.rs:287
    |
    └─ E2, at src-error/tests/error/exn.rs:288
    |
    └─ E3, at src-error/tests/error/exn.rs:289
    |
    └─ E4, at src-error/tests/error/exn.rs:290
    |
    └─ E5, at src-error/tests/error/exn.rs:291
    ");
...
fn error_tree() {
    ...
    E6, at src-error/tests/error/main.rs:25
    |
    └─ E5, at src-error/tests/error/main.rs:17
    |   |
    |   └─ E3, at src-error/tests/error/main.rs:9
    |   |   |
    |   |   └─ E1, at src-error/tests/error/main.rs:8
    |   |
    |   └─ E10, at src-error/tests/error/main.rs:12
    |   |   |
    |   |   └─ E9, at src-error/tests/error/main.rs:11
    |   |
    |   └─ E12, at src-error/tests/error/main.rs:15
    |       |
    |       └─ E11, at src-error/tests/error/main.rs:14
    |
    └─ E4, at src-error/tests/error/main.rs:20
    |   |
    |   └─ E2, at src-error/tests/error/main.rs:19
    |
    └─ E8, at src-error/tests/error/main.rs:23
        |
        └─ E7, at src-error/tests/error/main.rs:22
    ");
...
fn result_ext() {
    ...
    Another error, at src-error/tests/error/exn.rs:432
    |
    └─ An error, at src-error/tests/error/exn.rs:432
    ");
}
...
fn option_ext() {
    ...
    insta::assert_snapshot!(debug_string(result.unwrap_err()), @"An error, at src-error/tests/error/exn.rs:443");
}
...
fn from_message() {
    ...
    let result = foo();
    insta::assert_snapshot!(debug_string(result.unwrap_err()),@"An error, at src-error/tests/error/exn.rs:450");
}
...
fn bail() {
    ...
    let result = foo();
    insta::assert_snapshot!(debug_string(result.unwrap_err()), @"An error, at src-error/tests/error/exn.rs:471");
}
...
fn ensure_fail() {
    ...
    let result = foo();
    insta::assert_snapshot!(debug_string(result.unwrap_err()), @"An error, at src-error/tests/error/exn.rs:491");
}
...
fn raise_chain_anyhow() {
    ...
    root, at src-error/tests/error/exn.rs:530

    Caused by:
        0: E2, at src-error/tests/error/exn.rs:529
        1: E1, at src-error/tests/error/exn.rs:526
        2: E1-2, at src-error/tests/error/exn.rs:527
        3: E1-3, at src-error/tests/error/exn.rs:528
        4: E1c1-1, at src-error/tests/error/exn.rs:527
        5: E1c1-2, at src-error/tests/error/exn.rs:527
        6: E1c2-1, at src-error/tests/error/exn.rs:528
        7: E1c2-2, at src-error/tests/error/exn.rs:528
    ");
}
...
fn inverse_error_call_chain_anyhow() {
    ...
    E1, at src-error/tests/error/exn.rs:571

    Caused by:
        0: E2, at src-error/tests/error/exn.rs:572
        1: E3, at src-error/tests/error/exn.rs:573
        2: E4, at src-error/tests/error/exn.rs:574
        3: E5, at src-error/tests/error/exn.rs:575
    ");
}
...
fn into_chain() {
    ...
    [
        "root, at src-error/tests/error/exn.rs:610",
        "E2, at src-error/tests/error/exn.rs:609",
        "E1, at src-error/tests/error/exn.rs:606",
        "E1-2, at src-error/tests/error/exn.rs:607",
        "E1-3, at src-error/tests/error/exn.rs:608",
        "E1c1-1, at src-error/tests/error/exn.rs:607",
        "E1c1-2, at src-error/tests/error/exn.rs:607",
        "E1c2-1, at src-error/tests/error/exn.rs:608",
        "E1c2-2, at src-error/tests/error/exn.rs:608",
    ]
    "#);
    ...
    Caused by:
        0: E2, at src-error/tests/error/exn.rs:609
        1: E1, at src-error/tests/error/exn.rs:606
        2: E1-2, at src-error/tests/error/exn.rs:607
        3: E1-3, at src-error/tests/error/exn.rs:608
        4: E1c1-1, at src-error/tests/error/exn.rs:607
        5: E1c1-2, at src-error/tests/error/exn.rs:607
        6: E1c2-1, at src-error/tests/error/exn.rs:608
        7: E1c2-2, at src-error/tests/error/exn.rs:608
    ");
}
