 ...
 * **Uncategorized**
    ...
    - More docs to better explain `src-error` ([`f46ca99`](https://github.com/GitoxideLabs/gitoxide/commit/f46ca9925930e4b2a660d2896ccbfb8edd3aa4e9))
    ...
    - Create a basic `src-error` crate to forward `exn` ([`35cf1ff`](https://github.com/GitoxideLabs/gitoxide/commit/35cf1ff837ea30a1366b20bde0d59baf9ab699be))
</details>
