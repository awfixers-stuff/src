 ...
 * **Uncategorized**
    ...
    - Conform `src-path` to same version and allow publish to continue. ([`933a801`](https://github.com/GitoxideLabs/gitoxide/commit/933a80120d35665cd403ab2aad4c5b0e71542537))
</details>
 ...
 * **Uncategorized**
    ...
    - Merge branch 'fuzz-src-pathspec' ([`62e1072`](https://github.com/GitoxideLabs/gitoxide/commit/62e1072b28b965cfaa4d25831d9b8a12bb7c67c2))
...
### New Features
 ...
 - <csr-id-07a3e93d22462ed0221ee90bda17559425305528/> export `src-attributes` as `attributes` to make `src-glob` and `src-attribute` types available.
 ...
 * **Uncategorized**
    ...
    - Export `src-attributes` as `attributes` to make `src-glob` and `src-attribute` types available. ([`07a3e93`](https://github.com/GitoxideLabs/gitoxide/commit/07a3e93d22462ed0221ee90bda17559425305528))
    ...
    - Renmae `git-pathspec` to `src-pathspec` ([`a49ba33`](https://github.com/GitoxideLabs/gitoxide/commit/a49ba33f7aa22e39b4177320224ee99353b7540b))
