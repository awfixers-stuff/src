...
1. Gitoxide is primarily a library project. Used as a library, it contains a the `src` crate (which most users declare as their dependency) and numerous more special-purpose `src-*` crates.
