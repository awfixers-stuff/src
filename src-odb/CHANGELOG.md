 ...
 * **Uncategorized**
    ...
    - Adapt to changes in `src-hash` ([`201e853`](https://github.com/GitoxideLabs/gitoxide/commit/201e853b151983502377b1f04d821c07d159014f))
...
### New Features (BREAKING)
 ...
 - <csr-id-7325c584c3f0973975935b307630e29bc36ef5c7/> move `src-odb::Write` trait to `src-object::Write`.
   There it's far more useful and plumbing crates are enabled to write
   objects without pulling in `src-odb` as dependency.
 ...
 * **Uncategorized**
    ...
    - Move `src-odb::Write` trait to `src-object::Write`. ([`7325c58`](https://github.com/GitoxideLabs/gitoxide/commit/7325c584c3f0973975935b307630e29bc36ef5c7))
 ...
 * **Uncategorized**
    ...
    - Adapt to changes in `src-object` ([`528f549`](https://github.com/GitoxideLabs/gitoxide/commit/528f549a3572eabb2ad137707a2ef5051d6414a4))
...
### Changed (BREAKING)
 ...
 - <csr-id-fad298228ca91298abe42af41defb8f6c89c3cc9/> Remove `Find` trait (as it's now living in `src-odb`)
   This makes it easier to access objects via trait from other crates
   without having to pull in all of `src-odb`.
 ...
 * **Uncategorized**
    ...
    - Adapt to changes in `src-object` (Find::try_header()) ([`336d161`](https://github.com/GitoxideLabs/gitoxide/commit/336d161a4a291b5cb03c08e637c6f47a05731996))
    ...
    - Adapt to changes in `src-pack` ([`40e7440`](https://github.com/GitoxideLabs/gitoxide/commit/40e74404e87e44b0b2a5fe3d294f3ddc5ed2ba88))
    - Remove `Find` trait (as it's now living in `src-odb`) ([`fad2982`](https://github.com/GitoxideLabs/gitoxide/commit/fad298228ca91298abe42af41defb8f6c89c3cc9))
 ...
 * **Uncategorized**
    ...
    - Adapt to changes in `src-object` ([`ffcb110`](https://github.com/GitoxideLabs/gitoxide/commit/ffcb110135e4597d8953b97da3db9ecc3cf12e34))
</details>
 ...
 * **Uncategorized**
    ...
    - Adapt to changes in `src-pack` ([`46a4d4d`](https://github.com/GitoxideLabs/gitoxide/commit/46a4d4d873610ba88d51bce865404b904b2b7cb3))
 ...
 * **Uncategorized**
    ...
    - Rename `git-odb` to `src-odb` ([`93047bb`](https://github.com/GitoxideLabs/gitoxide/commit/93047bb8bbb09982cd23ae6d78a0a90a9ec5c2a9))
...
- move loose header manipulation from src-pack to src-object
