 ...
 * **Uncategorized**
    ...
    - Let `src-testtools` use `src-*` workspace crates ([`7e057f2`](https://github.com/GitoxideLabs/gitoxide/commit/7e057f2c73a70a2cd56bbc5484e6141feef2f014))
    ...
    - Merge pull request #1972 from GitoxideLabs/src-testtools ([`d2f2333`](https://github.com/GitoxideLabs/gitoxide/commit/d2f2333271c4c7eac538203f43c41cb45df337df))
</details>
...
### Bug Fixes
 ...
 - <csr-id-9b12d5007ca3ec98d061b6d2b94c7cdda4fcd3e4/> unify the dependency graph by choosing the right versions, upgrading to `src-features 0.42`
 ...
 * **Uncategorized**
    - Release src-testtools v0.16.1 ([`48079a5`](https://github.com/GitoxideLabs/gitoxide/commit/48079a5f64703881d0939b5c5f3066596794ba8d))
    - Unify the dependency graph by choosing the right versions, upgrading to `src-features 0.42` ([`9b12d50`](https://github.com/GitoxideLabs/gitoxide/commit/9b12d5007ca3ec98d061b6d2b94c7cdda4fcd3e4))
</details>
...
### Changed
 ...
 - <csr-id-f7f24e537246a47498d41f06816c14f17ea4ee48/> In src-testtools use `ignore` and `index` via `gix_worktree`
   This removes the `src-ignore` and `src-index` direct dependencies
   of `src-testtools`, by having `gix_testtools` use them through
   `src-worktree`, accessing `gix_worktree::ignore` for `gix_ignore`
   and `gix_worktree::index` for `gix_index`.
   
   The rationale is that various other src-* dependencies were used
...
### New Features
 ...
 - <csr-id-720a23f873508fc574c0f0e9b212dbd0dd76b8bb/> Add `jtt bash-program` (`jtt bp`) to show `bash_program()`
   ...
   `src-testools` program (`jtt`) to check what the `bash_program()`
 ...
 - <csr-id-47234b66c5de20b6ea701c3f215d832c86d770c1/> Document `gix_testtools::bash_program()` and make it public
   To make it easier for users of `src-testtools` to diagnose problems
   ...
   `src-testtools` is also now documented explicitly. Broad details of
 ...
 - <csr-id-ba76201f619d32a3606609d14e3bb0f1dfb100b7/> Prefer `/` over `\` in `bash.exe` path (for fixtures)
   Starting in #1712, `src-testtools` looks for `bash.exe` on Windows
 ...
 - <csr-id-03d5a6873e1b6d44227f709e91ac447e29abfac3/> Recognize `GIX_TEST_CREATE_ARCHIVES_EVEN_ON_CI`
   When `src-testtools` runs fixtures, it now recognizes a new
...
1. This only modifies how test fixture scripts are run. It only
      affects the behavior of `src-testtools`, and not of any other
      gitoxide crates such as `src-command`. This is because:
      ...
      - We know our test fixture scripts are all (at least currently)
        ...
        currently uses this functionality of `src-testtools`. But
      ...
      - Although a `bash.exe` located at the usual place relative to
        ...
        way is not safe. Limiting it to `src-testtools` pending
...
- Although a `bash.exe` located at the usual place relative to
        ...
        way is not safe. Limiting it to `src-testtools` pending
        further research may help mitigate this risk.
- It would add `src-path` as a dependency of `src-testtools`.
- Finding `git` in a `std::process::Command` path search is an
        established (though not promised) approach in `src-testtools`,
        including to run `git --exec-path` (to find `git-daemon`).
- It is not immediately obvious that `exe_invocation` behavior
        is semantically correct for `src-testtools`, though it most
 ...
 * **Uncategorized**
    - Release src-testtools v0.16.0 ([`c5c726e`](https://github.com/GitoxideLabs/gitoxide/commit/c5c726e64f01b3a927ec5dc0e9917a4470d9cc5c))
    ...
    - Comment forthcoming dependency changes for src-testtools ([`6990f76`](https://github.com/GitoxideLabs/gitoxide/commit/6990f76a88b0a629a1bd578979218f5e791a862e))
    ...
    - Use consistent `git` command name in src-testtools ([`e30c070`](https://github.com/GitoxideLabs/gitoxide/commit/e30c0700c3e64b87c20b4695ccfb41f05f961129))
    ...
    - In src-testtools use `ignore` and `index` via `gix_worktree` ([`f7f24e5`](https://github.com/GitoxideLabs/gitoxide/commit/f7f24e537246a47498d41f06816c14f17ea4ee48))
    ...
    - Fix src-archive tests for when symlinks are allowed ([`93e088a`](https://github.com/GitoxideLabs/gitoxide/commit/93e088a619db0d4b81e444922f375de65c94a317))
 ...
 * **Uncategorized**
    - Release src-testtools v0.15.0 ([`78b8e41`](https://github.com/GitoxideLabs/gitoxide/commit/78b8e4110abd303511bad3fab469e7458f31f75a))
    - Update changelog prior to `src-testtools` release ([`88eb841`](https://github.com/GitoxideLabs/gitoxide/commit/88eb841b7e3991b6f228390433f58333c6d4b85f))
 ...
 * **Uncategorized**
    - Release src-testtools v0.14.0 ([`f6eaba3`](https://github.com/GitoxideLabs/gitoxide/commit/f6eaba3a465720819f2ef7844648699195dd8341))
    - Prepare changelog prior to release of `src-testtools` ([`ae012ba`](https://github.com/GitoxideLabs/gitoxide/commit/ae012ba8627a8ea2f0145c53c42972db1d875662))
    ...
    - Update `src-testtools` dependencies to the latest version. ([`ddaacda`](https://github.com/GitoxideLabs/gitoxide/commit/ddaacda6667092ccea100180f70d2ccb9bb79dbc))
    ...
    - Fix missing license files in the released src-testtools crate ([`ef73ed4`](https://github.com/GitoxideLabs/gitoxide/commit/ef73ed4644855ba53cc2b73674ee8df51ae7c053))
    ...
    - Fixup `src-testtools` manifest to allow releasing all other crates. ([`9587972`](https://github.com/GitoxideLabs/gitoxide/commit/95879729c411337cb5f6f5fd699b8a6d61e83a78))
</details>
 ...
 * **Uncategorized**
    - Release src-testtools v0.13.0 ([`edb12ff`](https://github.com/GitoxideLabs/gitoxide/commit/edb12ff7216fdc9b0cf9960949b5794e6fa3cd08))
    - Set `src-testtools` package versions so that it can be released ([`793c2af`](https://github.com/GitoxideLabs/gitoxide/commit/793c2afbb5e4a5c817b06c15103310781769abfd))
    - Release src-testtools v0.13.0 ([`7fe620d`](https://github.com/GitoxideLabs/gitoxide/commit/7fe620d6135e7619c5484aeca7ca8823bee585e1))
    ...
    - Allow src-testtools to refer to the local crates that don't cause cycles. ([`082a6fc`](https://github.com/GitoxideLabs/gitoxide/commit/082a6fc65ae08ea0fda11a3340941d58ead4036a))
...
### Bug Fixes
 ...
 - <csr-id-00286c9cf63b5eba9534ef7639805545ec40eb03/> `src-testtools` use the latest dependencies
 ...
 * **Uncategorized**
    - Release src-testtools v0.11.0 ([`dfe2402`](https://github.com/GitoxideLabs/gitoxide/commit/dfe24026f9b1d85b8ab01e69dfec6a4188091850))
    - `src-testtools` use the latest dependencies ([`00286c9`](https://github.com/GitoxideLabs/gitoxide/commit/00286c9cf63b5eba9534ef7639805545ec40eb03))
    ...
    - Note that crates have been renamed from `git-*` to `src-*`. ([`e14dc7d`](https://github.com/GitoxideLabs/gitoxide/commit/e14dc7d475373d2c266e84ff8f1826c68a34ab92))
...
### Bug Fixes
 ...
 - <csr-id-761b7d71977a5aa4876010faa61ab88f0dba6eab/> don't overwrite unexpanded `src-lfs` pointer files.
   It's possible for those with incomplete `src-lfs` installations
   (and many more situations) to end up in a spot where pointer files
   aren't expanded. If we overwrite the with archives, files look
   changed which can be confusing and lead to even bigger messes
   to happen.
