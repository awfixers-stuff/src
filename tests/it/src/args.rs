...
pub enum Subcommands {
    ...
    CopyRoyal {
        ...
        patterns: Vec<src::pathspec::Pattern>,
    },
    ...
    /// [slider-rs]: src-diff/tests/diff/blob/slider.rs
    /// [make-diff-for-sliders-repo]: src-diff/tests/fixtures/make_diff_for_sliders_repo.sh
    CreateDiffCases {
        /// Don't really copy anything.
        #[clap(long, short = 'n')]
        dry_run: bool,
