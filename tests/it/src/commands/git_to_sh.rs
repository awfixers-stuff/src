pub struct Options {
    pub patterns: Vec<src::pathspec::Pattern>,
    pub verbatim: bool,
    pub max_count: usize,
}
...
pub(super) mod function {
    ...
    use src::{object::tree::EntryKind, objs::FindExt};
                ...
                Some(mode) => match mode.kind() {
                    ...
                    EntryKind::Blob | EntryKind::BlobExecutable => {
                        ...
                        if verbatim {
                            ...
                            (
                                src::objs::compute_hash(
                                    repo.object_hash(),
                                    src::object::Kind::Blob,
                                    mapped.as_bytes(),
                                )?,
