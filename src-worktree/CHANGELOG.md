 ...
 * **Uncategorized**
    ...
    - Merge branch 'src-testtools-license-file' ([`c50af65`](https://github.com/GitoxideLabs/gitoxide/commit/c50af65bf84963cb430538915f8eca9bd4481012))
    ...
    - Adapt to changes in `src-glob` ([`5fbbaaa`](https://github.com/GitoxideLabs/gitoxide/commit/5fbbaaa10d919dd216badb05b2fae32d5dd955c9))
</details>
 ...
 * **Uncategorized**
    ...
    - Prepare changelog prior to `src-dir` patch release ([`6ca6fa6`](https://github.com/GitoxideLabs/gitoxide/commit/6ca6fa69b5c21c8d8e9e07e21558e98201504cda))
 ...
 * **Uncategorized**
    ...
    - Merge branch 'src-status' ([`c3983c6`](https://github.com/GitoxideLabs/gitoxide/commit/c3983c6b8d63d85ec713ae8d661723f9cf0bd55b))
...
### Changed (BREAKING)
 ...
 - <csr-id-bf1e688a64c2a71582f433c29c9d80897bb6ce7a/> Use the `src-object::Find` trait
 ...
 * **Uncategorized**
    ...
    - Use the `src-object::Find` trait ([`bf1e688`](https://github.com/GitoxideLabs/gitoxide/commit/bf1e688a64c2a71582f433c29c9d80897bb6ce7a))
...
- <csr-id-1958dffc164e7b60ddc2eb308ed6da74a80559df/> remove `checkout` and `status` functionality so only `Cache` remains.
  `src-worktree` is now a base-crate for use by derived crates that provide additional
 ...
 * **Uncategorized**
    ...
    - Create new `src-status` crate to capture `git-status` like functionality ([`be9af32`](https://github.com/GitoxideLabs/gitoxide/commit/be9af327c75d693658a2427ee9a711e631a8da7d))
...
### New Features (BREAKING)
 ...
 - <csr-id-9c936755833b10989124f2cce1b675ae7e78af64/> add `cache::State::Attributes` to only load attributes.
   ...
   files without a worktree, which can be happening whith `src-archive` for example.
 ...
 * **Uncategorized**
    ...
    - Prepare changelogs prior to release of src-testtools ([`fc45f1b`](https://github.com/GitoxideLabs/gitoxide/commit/fc45f1b417bf545d4a0a105c40b37f92c24decad))
 ...
 * **Uncategorized**
    ...
    - Adjust to improvements in `src-object` ([`efeb29d`](https://github.com/GitoxideLabs/gitoxide/commit/efeb29daaf4199748702f42966470a41ded3c6de))
    ...
    - Adjust to changes in `src-index` ([`cae539b`](https://github.com/GitoxideLabs/gitoxide/commit/cae539b87164fabd258255a5d217decf3182d81f))
 ...
 * **Uncategorized**
    ...
    - Rename `git-worktree` to `src-worktree` ([`2b59ff2`](https://github.com/GitoxideLabs/gitoxide/commit/2b59ff25fd095cac93f7d607594f68a5e329861e))
