...
<csr-read-only-do-not-edit/>
 ...
 - 2 unique issues were worked on: [#382](https://github.com/Byron/gitoxide/issues/382), [#691](https://github.com/Byron/gitoxide/issues/691)
 ...
 * **Uncategorized**
    ...
    - Adjust to renaming of `git-lfs` to `src-lfs` ([`b9225c8`](https://github.com/Byron/gitoxide/commit/b9225c830daf1388484ee7e05f727990fdeff43c))
    - Adjust to renaming of `git-rebase` to `src-rebase` ([`f00e531`](https://github.com/Byron/gitoxide/commit/f00e53108f8a2de01f84fef35f9278b9114cf9dc))
    - Rename `git-rebase` to `src-rebase` ([`0842cfd`](https://github.com/Byron/gitoxide/commit/0842cfdebac16b244053dc44f66f38c5b729676a))
    ...
    - Release git-lfs v0.0.0, git-rebase v0.0.0 ([`498e44f`](https://github.com/Byron/gitoxide/commit/498e44f3153d5bcb8d07e80ce8fc0168f07af433))
</details>
