 ...
 * **Uncategorized**
    ...
    - Prepare `src-index` end-of-index extension parsing for SHA256. ([`f879654`](https://github.com/GitoxideLabs/gitoxide/commit/f8796547213c5fe15efa35ee947223ee0ebe6c12))
 ...
 * **Uncategorized**
    ...
    - Regenerate src-index fixture archive ([`eab6735`](https://github.com/GitoxideLabs/gitoxide/commit/eab67358c135597936448f6b9faf85cd52bb3400))
 ...
 * **Uncategorized**
    ...
    - Prepare changelogs prior to `src-index` release ([`17d1aac`](https://github.com/GitoxideLabs/gitoxide/commit/17d1aac91ad22291ad6d72f6e8798ebb741a8d7d))
 ...
 * **Uncategorized**
    ...
    - Adapt to changes in `src-hash` ([`859a092`](https://github.com/GitoxideLabs/gitoxide/commit/859a092bb6ad04ee9bab424cf5b56f299a9645d3))
 ...
 * **Uncategorized**
    ...
    - Prepare changelog for `src-index` release ([`b3ecbb7`](https://github.com/GitoxideLabs/gitoxide/commit/b3ecbb7e27bbd088733c70a319a57a9e963f8bd0))
...
### Changed (BREAKING)
 ...
 - <csr-id-1165de0d00b99a85387868d1ebb6423fd0e89b6b/> Use new `src-object::Find` trait
...
### New Features (BREAKING)
 ...
 - <csr-id-3c8421f003bc3a5f2f51cee1b5cb6a526d5e0f38/> Add git-style metadata support.
   ...
   That way, the index file written by `src` will not continuously
 ...
 * **Uncategorized**
    ...
    - Use new `src-object::Find` trait ([`1165de0`](https://github.com/GitoxideLabs/gitoxide/commit/1165de0d00b99a85387868d1ebb6423fd0e89b6b))
 ...
 * **Uncategorized**
    ...
    - Adapt to `src-features` ([`9e7c3e1`](https://github.com/GitoxideLabs/gitoxide/commit/9e7c3e12528833023bf37ada4e2e90989d848e99))
</details>
...
### Bug Fixes
 ...
 - <csr-id-616932516d122a24e29fb42c60147fe43c5cead9/> `src-index` prefix matching should now work correctly with conflicting files.
 ...
 * **Uncategorized**
    ...
    - Prepare `src-index` release ([`6fdbc66`](https://github.com/GitoxideLabs/gitoxide/commit/6fdbc667c20f10734390341b435c15c73b7cd227))
    ...
    - `src-index` prefix matching should now work correctly with conflicting files. ([`6169325`](https://github.com/GitoxideLabs/gitoxide/commit/616932516d122a24e29fb42c60147fe43c5cead9))
 ...
 * **Uncategorized**
    ...
    - Use new `src-fs` capabilities ([`1c1d19b`](https://github.com/GitoxideLabs/gitoxide/commit/1c1d19b715b4c3e716ebcde643cad9a75912e5fc))
...
### Refactor
 ...
 - <csr-id-dc3fd48327a16bf8599eaf70b55ab6c1d754e4bb/> inline bounds checks
   ...
   The `src-bitmap` crate was kept simple to encourage using it this way.
 ...
 * **Uncategorized**
    ...
    - Rename `git-index` to `src-index` ([`ecd3541`](https://github.com/GitoxideLabs/gitoxide/commit/ecd354119c3a8b150a06df7205ddf022a825d6cd))
